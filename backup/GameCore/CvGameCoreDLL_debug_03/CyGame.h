...
public:
	...
	bool isRequireStateReligionForReligionRemoval() const;
	void setRequireStateReligionForReligionRemoval(bool bNewValue);
	bool isRequireCityOwnerStateReligionMatchForReligionRemoval() const;
	void setRequireCityOwnerStateReligionMatchForReligionRemoval(bool bNewValue);
	bool isRequireOpenBordersForReligionRemoval() const;
	void setRequireOpenBordersForReligionRemoval(bool bNewValue);
	// MOD - END - Inquisition
