...
enum WidgetTypes					// Exposed to Python
{
	...
	WIDGET_HELP_EPIDEMIC_PROBABILITY,
	WIDGET_HELP_EPIDEMIC_PROBABILITY_GLOBAL_MODIFIER,
	// MOD - END - Epidemics
	WIDGET_HELP_AHEAD,
	// MOD - START - Advanced Yield and Commerce Effects
	WIDGET_HELP_IRRIGATED_YIELD_CHANGE,
	// MOD - END - Advanced Yield and Commerce Effects
	// MOD - START - Congestion
	WIDGET_CONGESTION_CONTEXT,
	WIDGET_CONGESTION_PREVIOUS_LEVEL,
	WIDGET_CONGESTION_CURRENT_LEVEL,
	WIDGET_CONGESTION_NEXT_LEVEL,
	WIDGET_CONGESTION_BAR,
	WIDGET_CONGESTION_INSIDE_CITY_THRESHOLD_CHANGE,
	WIDGET_CONGESTION_OUTSIDE_CITY_THRESHOLD_CHANGE,
	// MOD - END - Congestion
	// MOD - START - Population Metrics
	WIDGET_HELP_CITY_STABILITY,
	// MOD - END - Population Metrics
	// MOD - START - Population Advisor
	WIDGET_POPULATION_ADVISOR,
	// MOD - END - Population Advisor
	// MOD - START - Improved Civilopedia
	WIDGET_PEDIA_CLEAR_SEARCH_FILTER,
	WIDGET_PEDIA_TOGGLE_PLAYABLE_FILTER,
	WIDGET_PEDIA_SECTION,
	WIDGET_PEDIA_VIEW,
	WIDGET_PEDIA_JUMP_TO_UNIT_COMPARISON,
	WIDGET_PEDIA_JUMP_TO_UNIT_UPGRADE_CHART,
	WIDGET_PEDIA_JUMP_TO_PROMOTION_TREE,
	WIDGET_PEDIA_JUMP_TO_BUILDING_COMPARISON,
	WIDGET_PEDIA_JUMP_TO_BUILDING_CLASS,
	WIDGET_PEDIA_JUMP_TO_BUILDING_UPGRADE_CHART,
	WIDGET_PEDIA_JUMP_TO_TRAIT,
	WIDGET_PEDIA_JUMP_TO_ERA,
	WIDGET_PEDIA_JUMP_TO_WORLD,
	WIDGET_PEDIA_JUMP_TO_ROUTE,
	WIDGET_PEDIA_JUMP_TO_HANDICAP,
	WIDGET_PEDIA_JUMP_TO_INTRODUCTION,
	WIDGET_PEDIA_JUMP_TO_CONCEPT,
	WIDGET_PEDIA_JUMP_TO_HINTS,
	WIDGET_PEDIA_JUMP_TO_HOTKEY_CLASS,
	// MOD - END - Improved Civilopedia
	// MOD - START - Aid
	WIDGET_PEDIA_JUMP_TO_AID,
	// MOD - END - Aid
	// MOD - START - Detriments
	WIDGET_PEDIA_JUMP_TO_DETRIMENT,
	// MOD - END - Detriments
...
/*                                                                                              */
/************************************************************************************************/
	BUTTONPOPUP_SELECT_SHADOW_UNIT,
...
enum PlayerOptionTypes			// Exposed to Python
{
	...
	PLAYEROPTION_ADVANCED_AUTOMATIONS,
...
enum FontSymbols					// Exposed to Python
{
	...
	EPIDEMIC_END_CHAR,
	// MOD - END - Epidemics
	// MOD - START - Advanced Civilopedia
	CANCEL_CHAR,
	// MOD - END - Advanced Civilopedia
	SEPARATISM_CHAR,
	SEPARATISM_POS_CHAR,
	SEPARATISM_NEG_CHAR,
	SEPARATISM_GREEN_CHAR,
...
enum UnitRoleTypes		// Exposed to Python
{
	NO_UNITROLE = -1,
};
// MOD - END - Unit Roles
...
// MOD - START - Aid
enum AidStyleTypes				// Exposed to Python
{
	NO_AIDSTYLE = -1,
...
enum AidTypes				// Exposed to Python
{
	NO_AID = -1,
};
// MOD - END - Aid
...
// MOD - START - Detriments
enum DetrimentStyleTypes				// Exposed to Python
{
	NO_DETRIMENTSTYLE = -1,
...
enum DetrimentTypes				// Exposed to Python
{
	NO_DETRIMENT = -1,
};
// MOD - END - Detriments
...
// MOD - START - Congestion
enum CongestionTypes				// Exposed to Python
{
	NO_CONGESTION = -1,
};
// MOD - END - Congestion
...
enum MemoryTypes							// Exposed to Python 
{
	...
	// MOD - START - Inquisition
	MEMORY_REMOVED_RELIGION_FROM_CITY,
	MEMORY_REMOVED_STATE_RELIGION,
	// MOD - END - Inquisition
...
// MOD - START - Improved Civilopedia
enum HotKeyClassTypes // Exposed to Python
{
	NO_HOTKEYCLASS = -1,
};

// TODO: Consider implementation of these types
/*
enum TextContextTypes // Exposed to Python
{
	TEXT_CONTEXT_PLAYER						= 0x10000000,
	TEXT_CONTEXT_HELP						= 0x00000001,
	TEXT_CONTEXT_TECH_CHOOSER				= 0x00000002,
	TEXT_CONTEXT_WORLD_BUILDER				= 0x00000004,
	TEXT_CONTEXT_ADVANCED_START				= 0x00000008,
	TEXT_CONTEXT_DAWN_OF_MAN				= 0x00000010,
	TEXT_CONTEXT_CIVILOPEDIA_EFFECTS		= 0x00001000,
	TEXT_CONTEXT_CIVILOPEDIA_STRATEGY		= 0x00002000,
	TEXT_CONTEXT_CIVILOPEDIA_IMPROVEMENTS	= 0x00004000,
	TEXT_CONTEXT_CIVILOPEDIA				= TEXT_CONTEXT_CIVILOPEDIA_EFFECTS | TEXT_CONTEXT_CIVILOPEDIA_STRATEGY | TEXT_CONTEXT_CIVILOPEDIA_IMPROVEMENTS
};

enum TextMaskTypes // Exposed to Python
{
	TEXT_MASK_DESCRIPTION	= 0x00000001,
	TEXT_MASK_EFFECTS		= 0x00000002,
	TEXT_MASK_IMPROVEMENTS	= 0x00000004,
	TEXT_MASK_ALL			= TEXT_MASK_DESCRIPTION | TEXT_MASK_EFFECTS | TEXT_MASK_IMPROVEMENTS,

	NUM_GAME_TEXT_INCLUDE_TYPES
};
*/
// MOD - END - Improved Civilopedia
...
// MOD - START - Improved Civilopedia
enum CivilopediaSectionTypes		// Exposed to Python
{
	NO_CIVILOPEDIA_SECTION = -1,

	CIVILOPEDIA_SECTION_TECHNOLOGIES,
	CIVILOPEDIA_SECTION_UNITS,
	CIVILOPEDIA_SECTION_MILITARY,
	CIVILOPEDIA_SECTION_BUILDINGS,
	CIVILOPEDIA_SECTION_SOCIETY,
	CIVILOPEDIA_SECTION_WORLD,
	CIVILOPEDIA_SECTION_HELP,

	NUM_CIVILOPEDIA_SECTION_TYPES
};

enum CivilopediaViewTypes		// Exposed to Python
{
	NO_CIVILOPEDIA_VIEW = -1,

	CIVILOPEDIA_VIEW_TECHNOLOGIES,
	CIVILOPEDIA_VIEW_TECHNOLOGIES_GRAPH,
	CIVILOPEDIA_VIEW_TECHNOLOGIES_ALL,
	CIVILOPEDIA_VIEW_TECHNOLOGIES_ERA,
	CIVILOPEDIA_VIEW_UNITS,
	CIVILOPEDIA_VIEW_UNITS_ALL,
	CIVILOPEDIA_VIEW_UNITS_COMPARISON,
	CIVILOPEDIA_VIEW_UNITS_CATEGORIES,
	CIVILOPEDIA_VIEW_UNITS_UPGRADE_CHART,
	CIVILOPEDIA_VIEW_MILITARY,
	CIVILOPEDIA_VIEW_MILITARY_CONVENTIONAL_PROMOTIONS,
	CIVILOPEDIA_VIEW_MILITARY_SPECIAL_PROMOTIONS,
	CIVILOPEDIA_VIEW_MILITARY_PROMOTION_TREE,
	CIVILOPEDIA_VIEW_MILITARY_DOCTRINES,
	CIVILOPEDIA_VIEW_MILITARY_TRADITIONS,
	CIVILOPEDIA_VIEW_MILITARY_AID,
	CIVILOPEDIA_VIEW_MILITARY_DETRIMENTS,
	CIVILOPEDIA_VIEW_BUILDINGS,
	CIVILOPEDIA_VIEW_BUILDINGS_ALL,
	CIVILOPEDIA_VIEW_BUILDINGS_CIVILIZATION,
	CIVILOPEDIA_VIEW_BUILDINGS_COMPARISON,
	CIVILOPEDIA_VIEW_BUILDINGS_CLASSES,
	CIVILOPEDIA_VIEW_BUILDINGS_NATIONAL_WONDERS,
	CIVILOPEDIA_VIEW_BUILDINGS_GREAT_WONDERS,
	CIVILOPEDIA_VIEW_BUILDINGS_GREAT_WORKS,
	CIVILOPEDIA_VIEW_BUILDINGS_PROJECTS,
	CIVILOPEDIA_VIEW_BUILDINGS_RELIGIOUS,
	CIVILOPEDIA_VIEW_BUILDINGS_UPGRADE_CHART,
	CIVILOPEDIA_VIEW_SOCIETY,
	CIVILOPEDIA_VIEW_SOCIETY_CIVILIZATIONS,
	CIVILOPEDIA_VIEW_SOCIETY_LEADERS,
	CIVILOPEDIA_VIEW_SOCIETY_TRAITS,
	CIVILOPEDIA_VIEW_SOCIETY_CIVICS,
	CIVILOPEDIA_VIEW_SOCIETY_RELIGIONS,
	CIVILOPEDIA_VIEW_SOCIETY_SPECIALISTS,
	CIVILOPEDIA_VIEW_SOCIETY_ERAS,
	CIVILOPEDIA_VIEW_WORLD,
	CIVILOPEDIA_VIEW_WORLD_BASE_TERRAIN,
	CIVILOPEDIA_VIEW_WORLD_TERRAIN_FEATURES,
	CIVILOPEDIA_VIEW_WORLD_RESOURCES,
	CIVILOPEDIA_VIEW_WORLD_IMPROVEMENTS,
	CIVILOPEDIA_VIEW_WORLD_MAP_SIZES,
	CIVILOPEDIA_VIEW_WORLD_ROUTES,
	CIVILOPEDIA_VIEW_WORLD_DIFFICULTY_LEVELS,
	CIVILOPEDIA_VIEW_HELP,
	CIVILOPEDIA_VIEW_HELP_INTRODUCTION,
	CIVILOPEDIA_VIEW_HELP_CONCEPTS,
	CIVILOPEDIA_VIEW_HELP_HINTS,
	CIVILOPEDIA_VIEW_HELP_HOTKEY_CLASSES,

	NUM_CIVILOPEDIA_VIEW_TYPES
};
...
enum CivilopediaPageTypes		// Exposed to Python
{
	...
	CIVILOPEDIA_PAGE_TECHNOLOGY_GRAPH,
	CIVILOPEDIA_PAGE_TECHNOLOGY,
	CIVILOPEDIA_PAGE_UNIT,
	CIVILOPEDIA_PAGE_UNIT_COMPARISON,
	CIVILOPEDIA_PAGE_UNIT_CLASS,
	CIVILOPEDIA_PAGE_UNIT_COMBAT,
	CIVILOPEDIA_PAGE_UNIT_UPGRADE_CHART,
	CIVILOPEDIA_PAGE_PROMOTION,
	CIVILOPEDIA_PAGE_PROMOTION_TREE,
	CIVILOPEDIA_PAGE_AID,
	CIVILOPEDIA_PAGE_DETRIMENT,
	CIVILOPEDIA_PAGE_BUILDING,
	CIVILOPEDIA_PAGE_BUILDING_COMPARISON,
	CIVILOPEDIA_PAGE_BUILDING_CLASS,
	CIVILOPEDIA_PAGE_BUILDING_UPGRADE_CHART,
	CIVILOPEDIA_PAGE_WONDER,
	CIVILOPEDIA_PAGE_PROJECT,
	CIVILOPEDIA_PAGE_CIVILIZATION,
	...
	CIVILOPEDIA_PAGE_ERA,
	CIVILOPEDIA_PAGE_TERRAIN,
	CIVILOPEDIA_PAGE_FEATURE,
	CIVILOPEDIA_PAGE_BONUS,
	CIVILOPEDIA_PAGE_IMPROVEMENT,
	CIVILOPEDIA_PAGE_WORLD,
	CIVILOPEDIA_PAGE_ROUTE,
	CIVILOPEDIA_PAGE_HANDICAP,
	CIVILOPEDIA_PAGE_INTRODUCTION,
	CIVILOPEDIA_PAGE_CONCEPT,
	CIVILOPEDIA_PAGE_HINTS,
	CIVILOPEDIA_PAGE_HOTKEY_CLASS,

	NUM_CIVILOPEDIA_PAGE_TYPES
};

enum CivilopediaModeTypes		// Exposed to Python
{
	NO_CIVILOPEDIA_MODE = -1,

	CIVILOPEDIA_MODE_ALL,
	CIVILOPEDIA_MODE_GROUPED,
	CIVILOPEDIA_MODE_CIVILIZATION,
	CIVILOPEDIA_MODE_PLAYABLE,
	CIVILOPEDIA_MODE_NONPLAYABLE,
	CIVILOPEDIA_MODE_ACTIVE_GAME,
	CIVILOPEDIA_MODE_ACTIVE_PLAYER,

	NUM_CIVILOPEDIA_MODE_TYPES
};

enum CivilopediaSortTypes		// Exposed to Python
{
	NO_CIVILOPEDIA_SORT = -1,

	CIVILOPEDIA_SORT_LEXICAL,
	CIVILOPEDIA_SORT_LOGICAL,

	NUM_CIVILOPEDIA_SORT_TYPES
};
// MOD - END - Improved Civilopedia
...
enum GameEventTypes // Exposed to Python
{
	NO_GAMEEVENT = -1,

	GAMEEVENT_TURN,
	GAMEEVENT_STARVATION,
	GAMEEVENT_EPIDEMIC,
	GAMEEVENT_HURRY,
	GAMEEVENT_CONSCRIPTION,
	//GAMEEVENT_UNHEALTH,
...
// MOD - START - Population Metrics
enum ContributionTypes // Exposed to Python
{
	NO_CONTRIBUTION = -1,

	CONTRIBUTION_FIXED,
	CONTRIBUTION_PERCENT_CHANGE,
	CONTRIBUTION_PERCENT_CHANGE_TIMES_100,
	CONTRIBUTION_POPULATION,
	CONTRIBUTION_ANGRY_POPULATION,
	CONTRIBUTION_UNHEALTHY_POPULATION,
	CONTRIBUTION_RELIGION,
	CONTRIBUTION_STATE_RELIGION,
	CONTRIBUTION_NONSTATE_RELIGION,
	CONTRIBUTION_MILITARY_PRESENCE,
	CONTRIBUTION_SUPERIOR_MILITARY_POWER_RATIO,
	CONTRIBUTION_INFERIOR_MILITARY_POWER_RATIO,
...
/*
enum DecayTypes // Exposed to Python
{
	NO_DECAY = -1,
...
enum SocialStabilityTypes // Exposed to Python
{
	NO_SOCIALSTABILITY = -1,
};

enum MetricClassTypes // Exposed to Python
{
	NO_METRICCLASS = -1,
};

enum MetricTypes // Exposed to Python
{
	NO_METRIC = -1,
};

enum MetricFactorTypes // Exposed to Python
{
	NO_METRICCONTRIBUTION = -1,
};
// MOD - END - Population Metrics
