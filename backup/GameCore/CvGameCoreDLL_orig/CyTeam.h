...
public:
	...
	int getUnitRoleMaking(int /*UnitRoleTypes*/ eUnitRole);
	int getUnitRoleCountPlusMaking(int /*UnitRoleTypes*/ eUnitRole);
	// MOD - END - Unit Roles
	...
	int getTechTransferCount(int /*TechTypes*/ eIndex);
	bool isTechTransfer(int /*TechTypes*/ eIndex);
	...
	int getImprovementIrrigatedYieldChange(int /*ImprovementTypes*/ eIndex, int /*YieldTypes*/ eIndex2);
	void changeImprovementIrrigatedYieldChange(int /*ImprovementTypes*/ eIndex1, int /*YieldTypes*/ eIndex2, int iChange);
	...
	int getLivingTeamMember(int iMember) const;
