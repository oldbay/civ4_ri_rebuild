...
public:
	...
	bool canHaveFeature(int /*FeatureTypes*/ eFeature, bool bIgnoreLatitude = false);
	...
	bool isCityRadius(); // K-Mod changed return to bool
	...
	// MOD - START - Congestion
	int getCombatUnitDomainCount(int /*TeamTypes*/ eTeam, int /*DomainTypes*/ eDomain) const;
	// MOD - END - Congestion

	std::string getScriptData() const;
	void setScriptData(std::string szNewValue);

	// MOD - START - Aid, Detriments, & Congestion
	// TODO: Write Python Interface
	// MOD - END - Aid, Detriments, & Congestion
