...
void CyGamePythonInterface()
{
	...
	python::class_<CyGame>("CyGame")
		...
		.def("isRequireStateReligionForReligionRemoval", &CyGame::isRequireStateReligionForReligionRemoval, "bool ()")
		.def("setRequireStateReligionForReligionRemoval", &CyGame::setRequireStateReligionForReligionRemoval, "void (bool)")

		.def("isRequireCityOwnerStateReligionMatchForReligionRemoval", &CyGame::isRequireCityOwnerStateReligionMatchForReligionRemoval, "bool ()")
		.def("setRequireCityOwnerStateReligionMatchForReligionRemoval", &CyGame::setRequireCityOwnerStateReligionMatchForReligionRemoval, "void (bool)")

		.def("isRequireOpenBordersForReligionRemoval", &CyGame::isRequireOpenBordersForReligionRemoval, "bool ()")
		.def("setRequireOpenBordersForReligionRemoval", &CyGame::setRequireOpenBordersForReligionRemoval, "void (bool)")
		// MOD - END - Inquisition
...
/********************************************************************************/
		...
		.def("getResolutionX", &CyGame::getResolutionX, "int ()")
		.def("getResolutionY", &CyGame::getResolutionY, "int ()")
		.def("setResolution", &CyGame::setResolution, "void (int iX, int iY)")
		// MOD - END - Graphical Paging
		.def("getInitialNumPlayers", &CyGame::getInitialNumPlayers, "int ()")
		.def("setInitialNumPlayers", &CyGame::setInitialNumPlayers, "void (int iNewValue)")
		.def("getAheadOfTimeEra", &CyGame::getAheadOfTimeEra, "int ()")
		.def("setAheadOfTimeEra", &CyGame::setAheadOfTimeEra, "void (int newAheadOfTimeEra)" )	
		.def("getForcedStyle", &CyGame::getForcedStyle, "int ()")
		.def("setForcedStyle", &CyGame::setForcedStyle, "void (int iNewValue)" )
		// MOD - START - Better Nukes
		.def("getNuclearWinterLevel", &CyGame::getNuclearWinterLevel, "int ()")
