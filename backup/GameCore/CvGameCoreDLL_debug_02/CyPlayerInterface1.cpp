...
{
    #if defined(__GNUC__)
    std::clog << "Python Extension Module - CyPlayerPythonInterface1\n";
    #else
...
/********************************************************************************/
		...
		.def("setFlagDecal", &CyPlayer::setFlagDecal, "void (str), bool bUpdate" )
		...
		.def("setWhiteFlag", &CyPlayer::setWhiteFlag, "bool () - Whether or not this player is using a custom texture flag (set in WBS)")
		...
		.def("getCurrentResearchTechTransferCount", &CyPlayer::getCurrentResearchTechTransferCount, "int ()")
		.def("isCurrentResearchTechTransfer", &CyPlayer::isCurrentResearchTechTransfer, "bool ()")
		...
		.def("getAcceptableEpidemicPercent", &CyPlayer::getAcceptableEpidemicPercent, "int () - Return acceptable epidemic probability for player")
		.def("setAcceptableEpidemicPercent", &CyPlayer::setAcceptableEpidemicPercent, "void (int iNewValue) - Set acceptable epidemic probability for player")
		.def("changeAcceptableEpidemicPercent", &CyPlayer::changeAcceptableEpidemicPercent, "void (int iChange) - Change acceptable epidemic probability for player")
		.def("getGlobalEpidemicModifier", &CyPlayer::getGlobalEpidemicModifier, "int () - Return Global Epidemic modifier for player")
		.def("setGlobalEpidemicModifier", &CyPlayer::setGlobalEpidemicModifier, "void (int iNewValue) - Set Global Epidemic modifier for player")
		.def("changeGlobalEpidemicModifier", &CyPlayer::changeGlobalEpidemicModifier, "void (int iChange) - Change Global Epidemic modifier for player")
		// MOD - END - Epidemics
		...
		.def("isUnlimitedConscript", &CyPlayer::isUnlimitedConscript, "bool ()")
		// MOD - END - Unlimited Conscription
		// MOD - START - Wartime Conscription
		.def("getWarConscript", &CyPlayer::getWarConscript, "int ()")
		...
		.def("getHandicapScoreModifier", &CyPlayer::getHandicapScoreModifier, "int ()")
		.def("setHandicapScoreModifier", &CyPlayer::setHandicapScoreModifier, "void (int iModifier)")
		...
		.def("getAllSpecialistCommerceChange", &CyPlayer::getAllSpecialistCommerceChange, "int (CommerceTypes eIndex)")
		...
		.def("getUnitRoleCostModifier", &CyPlayer::getUnitRoleCostModifier, "int (int (UnitRoleTypes) eIndex)")
		.def("getUnitRoleCount", &CyPlayer::getUnitRoleCount, "int (int (UnitRoleTypes) eIndex)")
		.def("getUnitRoleMaking", &CyPlayer::getUnitRoleMaking, "int (int (UnitRoleTypes) eIndex)")
		.def("getUnitRoleCountPlusMaking", &CyPlayer::getUnitRoleCountPlusMaking, "int (int (UnitRoleTypes) eIndex)")
		// MOD - END - Unit Roles
		...
		.def("canAcquireHolyCity", &CyPlayer::canAcquireHolyCity, "bool (int (ReligionTypes) eIndex)")
		.def("canMaintainHolyCity", &CyPlayer::canMaintainHolyCity, "bool (int (ReligionTypes) eIndex)")
		...
		.def("getSpecialistYieldChange", &CyPlayer::getSpecialistYieldChange, "int (int /*SpecialistTypes*/ eIndex1, int /*YieldTypes*/ eIndex2)")
		// MOD - END - Advanced Yield and Commerce Effects

		// MOD - START - Advanced Yield and Commerce Effects
		.def("getBuildingYieldChange", &CyPlayer::getBuildingYieldChange, "int (int /*BuildingClassTypes*/ eBuildingClass, int /*YieldTypes*/ eYield)")
		.def("getBuildingCommerceChange", &CyPlayer::getBuildingCommerceChange, "int (int /*BuildingClassTypes*/ eBuildingClass, int /*CommerceTypes*/ eYield)")
		// MOD - END - Advanced Yield and Commerce Effects

		// MOD - START - Tech Path Caching
		//.def("findPathLength", &CyPlayer::findPathLength, "int (int (TechTypes) eTech, bool bCost)")
		.def("getTechPathLength", &CyPlayer::getTechPathLength, "int (int (TechTypes) eTech, bool bCost)")
		.def("getTechPathCost", &CyPlayer::getTechPathCost, "int (int (TechTypes) eTech, bool bCost)")
		...
		.def("getRevModifier", &CyPlayer::getRevModifier, "int")
		.def("changeRevModifier", &CyPlayer::changeRevModifier, "void (int)")
		.def("calculateRevModifier", &CyPlayer::calculateRevModifier, "void")
		.def("getRevModifierScore", &CyPlayer::getRevModifierScore, "int")
		.def("changeRevModifierScore", &CyPlayer::changeRevModifierScore, "void (int)")
		.def("calculateRevModifierScore", &CyPlayer::calculateRevModifierScore, "void")
		.def("getRevModifierPower", &CyPlayer::getRevModifierPower, "int")
		.def("changeRevModifierPower", &CyPlayer::changeRevModifierPower, "void (int)")
		.def("calculateRevModifierPower", &CyPlayer::calculateRevModifierPower, "void")
		.def("getRevModifierEndOfHistory", &CyPlayer::getRevModifierEndOfHistory, "int")
		.def("changeRevModifierEndOfHistory", &CyPlayer::changeRevModifierEndOfHistory, "void (int)")
		.def("calculateRevModifierEndOfHistory", &CyPlayer::calculateRevModifierEndOfHistory, "void")
		.def("getRevModifierWarExhaustion", &CyPlayer::getRevModifierWarExhaustion, "int")
		.def("changeRevModifierWarExhaustion", &CyPlayer::changeRevModifierWarExhaustion, "void (int)")
		.def("calculateRevModifierWarExhaustion", &CyPlayer::calculateRevModifierWarExhaustion, "void")
		
		.def("getSlaveAfrican", &CyPlayer::getSlaveAfrican, "int")
		.def("incrementSlaveAfrican", &CyPlayer::incrementSlaveAfrican, "void")
		.def("getSlaveAsian", &CyPlayer::getSlaveAsian, "int")
		.def("incrementSlaveAsian", &CyPlayer::incrementSlaveAsian, "void")		
		.def("getSlaveEuropean", &CyPlayer::getSlaveEuropean, "int")
		.def("incrementSlaveEuropean", &CyPlayer::incrementSlaveEuropean, "void")		
		.def("getSlaveIndian", &CyPlayer::getSlaveIndian, "int")
		.def("incrementSlaveIndian", &CyPlayer::incrementSlaveIndian, "void")		
		.def("getSlaveMid", &CyPlayer::getSlaveMid, "int")
		.def("incrementSlaveMid", &CyPlayer::incrementSlaveMid, "void")		
		.def("getSlaveNewworld", &CyPlayer::getSlaveNewworld, "int")
		.def("incrementSlaveNewworld", &CyPlayer::incrementSlaveNewworld, "void")		
		.def("getSlaveSlavic", &CyPlayer::getSlaveSlavic, "int")
		.def("incrementSlaveSlavic", &CyPlayer::incrementSlaveSlavic, "void")				
		;
}
