...
//#ifdef _USRDLL
	...
	struct CvFoundSettings
	{
		...
		bool bSeafaringImpr; // special affection for coast cities due to unique improvement.
...
/************************************************************************************************/
	...
	// AllTheLand AI
	int AI_getOpenBorderTechNumber() const;
	bool AI_teamBoostsTech(int teamID, int techID) const;
	bool AI_teamCouldBoostTech(int teamID, int techID) const;
	// AllTheLand AI END
	...
	bool isIdeologicalEnemy(PlayerTypes ePlayer) const;	
	int AI_getCommunistAttitude(PlayerTypes ePlayer) const;	
	// MOD - END - Favorite Religion
	int AI_getFavoriteReligionAttitude(PlayerTypes ePlayer) const;
	// MOD - END - Favorite Religion
	...
	int AI_improvementVal(ImprovementTypes eImprovement, const CvCity* pCity = NULL, TechTypes eTech = NO_TECH, CivicTypes eCivic = NO_CIVIC) const;
	int AI_improvementWeight(ImprovementTypes eImprovement, const CvCity* pCity = NULL, TechTypes eTech = NO_TECH, CivicTypes eCivic = NO_CIVIC) const;
	// MOD - EMD - Improvement Classes
	...
	int AI_totalWaterAreaUnitAIs(CvArea* pArea, UnitAITypes eUnitAI, CvCity* pIgnoreCity = NULL) const;
	...
	int AI_neededSeaWorkers(CvArea* pArea, CvPlot* pFromPlot = NULL, CvCity* pIgnoreCity = NULL) const;
	// MOD - END - Sea Improvements
	int AI_neededMissionaries(CvArea* pArea, ReligionTypes eReligion) const;
	// MOD - START - Inquisition
	int AI_neededInquisitors(CvArea* pArea, ReligionTypes eReligion) const;
	// MOD - END - Inquisition
...
// BBAI end
	...
	int AI_civicBuildingValue(CivicTypes eCivic, int iChange, bool bConstCache) const;
	...
	int AI_getDifferentIdeologyCounter(PlayerTypes eIndex) const;
	void AI_changeDifferentIdeologyCounter(PlayerTypes eIndex, int iChange);	
	...
	int AI_getFavoriteReligionCounter(PlayerTypes eIndex) const;
	void AI_changeFavoriteReligionCounter(PlayerTypes eIndex, int iChange);
	// MOD - END - Favorite Religion
	...
	// MOD - START - Border Statistics Cache
	int AI_getStolenCityRadiusPlots(PlayerTypes eIndex) const;
	void AI_setStolenCityRadiusPlots(PlayerTypes eIndex, int iNewValue);
	void AI_changeStolenCityRadiusPlots(PlayerTypes eIndex, int iChange);
	// MOD - END - Border Statistics Cache
...
/************************************************************************************************/		
	...
	int AI_getMaxBonusConverters(BuildingTypes eBuilding) const;
...
protected:
	...
	int* m_aiDifferentIdeologyCounter;	
	int* m_aiFavoriteCivicCounter;
	// MOD - START - Favorite Religion
	int* m_aiFavoriteReligionCounter;
	// MOD - END - Favorite Religion
	...
	// MOD - START - Border Statistics Cache
	int* m_aiStolenCityRadiusPlotsCache;
	// MOD - END - Border Statistics Cache
