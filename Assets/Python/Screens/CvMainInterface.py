...
## UltraPack Initialisation ##
	...
	def calculateLayout(self):
		...
		if (self.SCREEN_W > 1440 and (MainOpt.isShowGGProgressBar() or MainOpt.isShowGPProgressBar())):
			# Widescreen
		...
		if not gc.getGame().isOption(GameOptionTypes.GAMEOPTION_NO_AHEAD):	
			...
			if (gc.getGame().getGameTurnYear() > 1940):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA11").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > 1910):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA10").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > 1750):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA9").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > 1600):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA8").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > 1400):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA7").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > 1100):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA6").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > 400):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA5").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > 0):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA4").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > -1201):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA3").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() > -2001):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA2").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
			elif (gc.getGame().getGameTurnYear() < -2000):
				screen.addDDSGFC( self.MAIN_AHEAD_ID, ArtFileMgr.getInterfaceArtInfo("AHEAD_ERA1").getPath(), self.MAIN_RESEARCH_BAR_X, self.MAIN_RESEARCH_BAR_Y, 24, 24, WidgetTypes.WIDGET_HELP_AHEAD, -1, -1 )
		...
		iMinimapWidth = self.MINI_MAP_PANEL_H / iMap_H * iMap_W
		...
		if self.SCREEN_W > 1440:
			...
			self.MINI_MAP_DISPLAY_TOP = self.MINI_MAP_PANEL_Y + 3
