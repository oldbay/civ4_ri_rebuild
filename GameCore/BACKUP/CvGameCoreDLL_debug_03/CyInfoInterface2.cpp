...
void CyInfoPythonInterface2()
{
	...
	python::class_<CvBuildingClassInfo, python::bases<CvInfoBase> >("CvBuildingClassInfo")
		...
		.def("getRepresentativeBuilding", &CvBuildingClassInfo::getRepresentativeBuilding, "int ()")
		.def("getNumBuildingTypes", &CvBuildingClassInfo::getNumBuildingTypes, "int ()")
		...
		// MOD - START - Relation Caching
		.def("getBuildingTypes", &CvBuildingClassInfo::getBuildingTypes, "int (int i)")
		// MOD - END - Relation Caching
	...
	python::class_<CvCivilizationInfo, python::bases<CvInfoBase> >("CvCivilizationInfo")
		...
		.def("isDerivative", &CvCivilizationInfo::isDerivative, "bool ()")		
		...
		.def("getNumDerivativeCivs", &CvCivilizationInfo::getNumDerivativeCivs, "int ()")
		.def("getFirstDerivative", &CvCivilizationInfo::getFirstDerivative, "int ()")
		.def("getNDerivative", &CvCivilizationInfo::getNDerivative, "int (int i)")
		.def("getDerivativeCiv", &CvCivilizationInfo::getDerivativeCiv, "int (int i)")
		...
		.def("canBuild", &CvCivilizationInfo::canBuild, "bool (int i)")
		.def("canProduceImprovement", &CvCivilizationInfo::canProduceImprovement, "bool (int i)")
	...
	python::class_<CvHandicapInfo, python::bases<CvInfoBase> >("CvHandicapInfo")
		...
		.def("getPerCityResearchCostModifier", &CvHandicapInfo::getPerCityResearchCostModifier, "int ()")
		...
		// MOD - START - Epidemics
		.def("getEpidemicBaseRate", &CvHandicapInfo::getEpidemicBaseRate, "int ()")
		.def("getEpidemicPopulationRate", &CvHandicapInfo::getEpidemicPopulationRate, "int ()")
		.def("getEpidemicUnhealthRate", &CvHandicapInfo::getEpidemicUnhealthRate, "int ()")
		.def("getEpidemicTradeRouteRate", &CvHandicapInfo::getEpidemicTradeRouteRate, "int ()")
		// MOD - END - Epidemics
	...
	python::class_<CvRouteInfo, python::bases<CvInfoBase> >("CvRouteInfo")
		...
		// MOD - START - Relation Caching
		.def("getNumBuilds", &CvRouteInfo::getNumBuilds, "int ()")
		// MOD - END - Relation Caching
		...
		// MOD - START - Relation Caching
		.def("getBuilds", &CvRouteInfo::getBuilds, "int (int i)")
		// MOD - END - Relation Caching
		;
	...
	python::class_<CvImprovementClassInfo, python::bases<CvInfoBase> >("CvImprovementClassInfo")
		.def("getNumImprovementTypes", &CvImprovementClassInfo::getNumImprovementTypes, "int ()")

		// Arrays

		.def("getImprovementTypes", &CvImprovementClassInfo::getImprovementTypes, "int (int i)")
		;
...
/************************************************************************************************/
		...
		.def("getEpidemicModifier", &CvImprovementInfo::getEpidemicModifier, "int ()")
		// MOD - END - Epidemics
		...
		// MOD - START - Aid
		.def("getNumAidTypes", &CvImprovementInfo::getNumAidTypes, "int ()")
		// MOD - END - Aid
		// MOD - START - Detriments
		.def("getNumDetrimentTypes", &CvImprovementInfo::getNumDetrimentTypes, "int ()")
		// MOD - END - Detriments
		// MOD - START - Relation Caching
		.def("getNumBuilds", &CvImprovementInfo::getNumBuilds, "int ()")
		.def("getNumRelatedTechs", &CvImprovementInfo::getNumRelatedTechs, "int ()")
		.def("getNumRelatedCivics", &CvImprovementInfo::getNumRelatedCivics, "int ()")
		.def("getNumRelatedBuildingClasses", &CvImprovementInfo::getNumRelatedBuildingClasses, "int ()")
		// MOD - END - Relation Caching

		// MOD - START - Unique Improvements
		.def("isUniqueImprovement", &CvImprovementInfo::isUniqueImprovement, "bool ()")
		// MOD - END - Unique Improvements
		// MOD - START - Improvement Civic prerequisite
		.def("getImpPrereqCivic", &CvImprovementInfo::getImpPrereqCivic, "int ()")
		...
		// MOD - START - Aid
		.def("getAidTypes", &CvImprovementInfo::getAidTypes, "int (int i)")
		// MOD - END - Aid
		// MOD - START - Detriments
		.def("getDetrimentTypes", &CvImprovementInfo::getDetrimentTypes, "int (int i)")
		// MOD - END - Detriments
		// MOD - START - Relation Caching
		.def("getBuilds", &CvImprovementInfo::getBuilds, "int (int i)")
		.def("getRelatedTechs", &CvImprovementInfo::getRelatedTechs, "int (int i)")
		.def("getRelatedCivics", &CvImprovementInfo::getRelatedCivics, "int (int i)")
		.def("getRelatedBuildingClasses", &CvImprovementInfo::getRelatedBuildingClasses, "int (int i)")
		// MOD - END - Relation Caching
		...
		.def("getTechIrrigatedYieldChanges", &CvImprovementInfo::getTechIrrigatedYieldChanges, "int (int i, int j)")		
	...
	python::class_<CvBonusInfo, python::bases<CvInfoBase> >("CvBonusInfo")
		...
		// MOD - START - Epidemics
		// Epidemic system by Mexico
		.def("getEpidemicModifier", &CvBonusInfo::getEpidemicModifier, "int ()")
		// MOD - END - Epidemics
		...
		// MOD - START - Relation Caching
		.def("getNumRelatedBuilds", &CvBonusInfo::getNumRelatedBuilds, "int ()")
		.def("getNumRelatedUnitClasses", &CvBonusInfo::getNumRelatedUnitClasses, "int ()")
		.def("getNumRelatedBuildingClasses", &CvBonusInfo::getNumRelatedBuildingClasses, "int ()")
		// MOD - END - Relation Caching
		.def("getBonusClassType", &CvBonusInfo::getBonusClassType, "int ()")
		// MOD - START - Bonus Category for Globe View
		.def("getBonusCategory", &CvBonusInfo::getBonusCategory, "int ()")
		...
		// MOD - START - Relation Caching
		.def("getRelatedBuilds", &CvBonusInfo::getRelatedBuilds, "int (int i)")
		.def("getRelatedUnitClasses", &CvBonusInfo::getRelatedUnitClasses, "int (int i)")
		.def("getRelatedBuildingClasses", &CvBonusInfo::getRelatedBuildingClasses, "int (int i)")
		// MOD - END - Relation Caching
		...
		.def("isNoReligionHealthiness", &CvBonusInfo::isNoReligionHealthiness, "bool (int i)")
		.def("isNoReligionHappiness", &CvBonusInfo::isNoReligionHappiness, "bool (int i)")
	...
	python::class_<CvFeatureInfo, python::bases<CvInfoBase> >("CvFeatureInfo")
		...
		// MOD - START - Epidemics
		// Epidemic system by Mexico
		.def("getEpidemicModifier", &CvFeatureInfo::getEpidemicModifier, "int ()")
		// MOD - END - Epidemics
