...
CvPlayer::CvPlayer()
{
	...
	m_aiBaseOpenBordersFreeCityCommerce = new int[NUM_COMMERCE_TYPES];
	m_aiAdditionalOpenBordersFreeCityCommerce = new int[NUM_COMMERCE_TYPES];
	m_aiTotalOpenBordersFreeCityCommerce = new int[NUM_COMMERCE_TYPES];
	// MOD - END - Open Borders Commerce
	// MOD - START - Tech Transfer Commerce
	/*
	m_aiBaseTechTransferFreeCityCommerce = new int[NUM_COMMERCE_TYPES];
	m_aiAdditionalTechTransferFreeCityCommerce = new int[NUM_COMMERCE_TYPES];
	m_aiTotalTechTransferFreeCityCommerce = new int[NUM_COMMERCE_TYPES];
	*/
	...
	// MOD - START - Open Borders Commerce
	m_aiBaseOpenBordersCommerceRateModifier = new int[NUM_COMMERCE_TYPES];
	m_aiAdditionalOpenBordersCommerceRateModifier = new int[NUM_COMMERCE_TYPES];
	m_aiTotalOpenBordersCommerceRateModifier = new int[NUM_COMMERCE_TYPES];
	// MOD - END - Open Borders Commerce
	// MOD - START - Tech Transfer Commerce
	m_aiBaseTechTransferCommerceRateModifier = new int[NUM_COMMERCE_TYPES];
	m_aiAdditionalTechTransferCommerceRateModifier = new int[NUM_COMMERCE_TYPES];
	//m_aiTotalTechTransferCommerceRateModifier = new int[NUM_COMMERCE_TYPES];
	// MOD - END - Tech Transfer Commerce
	...
	m_aiAllSpecialistCommerceChanges = new int[NUM_COMMERCE_TYPES];
	...
	m_paiUnitRoleCostModifier = NULL;
	m_paiUnitRoleCount = NULL;
	m_paiUnitRoleMaking = NULL;
	// MOD - END - Unit Roles
	m_paiUnitClassCount = NULL;
	m_paiUnitClassMaking = NULL;
	// MOD - START - Player Build Caching
	m_paiBuilderCount = NULL;
	...
	m_paiHolyCityInfluence = NULL;
	m_paiHolyCityCandidate = NULL;
	...
	m_pabReligionNoBonusHealthiness = NULL;
	m_pabReligionNoBonusHappiness = NULL;
	// MOD - END - Religion Affected Bonuses
	m_pabResearchingTech = NULL;
	m_pabLoyalMember = NULL;
	// MOD - START - Player Build Caching
	m_pabBuildCache = NULL;
	// MOD - END - Player Build Caching
...
/*************************************************************************************************/
	...
	int m_iRevModifier = 0;
	int m_iRevModifierScore = 0;
	int m_iRevModifierPower = 0;
	int m_iRevModifierEoH = 0;
	int m_iRevModifierWE = 0;
	
/*************************************************************************************************/
/** REVOLUTION_MOD                          END                                                  */
/*************************************************************************************************/

	int m_iSlaveAfrican = 0; // Slavery tracker
	int m_iSlaveAsian = 0; // Slavery tracker	
	int m_iSlaveEuropean = 0; // Slavery tracker
	int m_iSlaveIndian = 0; // Slavery tracker
	int m_iSlaveMid = 0; // Slavery tracker	
	int m_iSlaveNewworld = 0; // Slavery tracker	
	int m_iSlaveSlavic = 0; // Slavery tracker	
...
CvPlayer::~CvPlayer()
{
	...
	// MOD - START - Open Borders Commerce
	SAFE_DELETE_ARRAY(m_aiBaseOpenBordersFreeCityCommerce);
	SAFE_DELETE_ARRAY(m_aiAdditionalOpenBordersFreeCityCommerce);
	SAFE_DELETE_ARRAY(m_aiTotalOpenBordersFreeCityCommerce);
	// MOD - END - Open Borders Commerce
	// MOD - START - Tech Transfer Commerce
	/*
	SAFE_DELETE_ARRAY(m_aiBaseTechTransferFreeCityCommerce);
	SAFE_DELETE_ARRAY(m_aiAdditionalTechTransferFreeCityCommerce);
	SAFE_DELETE_ARRAY(m_aiTotalTechTransferFreeCityCommerce);
	*/
	// MOD - END - Tech Transfer Commerce
	...
	// MOD - START - Open Borders Commerce
	SAFE_DELETE_ARRAY(m_aiBaseOpenBordersCommerceRateModifier);
	SAFE_DELETE_ARRAY(m_aiAdditionalOpenBordersCommerceRateModifier);
	SAFE_DELETE_ARRAY(m_aiTotalOpenBordersCommerceRateModifier);
	// MOD - END - Open Borders Commerce
	// MOD - START - Tech Transfer Commerce
	SAFE_DELETE_ARRAY(m_aiBaseTechTransferCommerceRateModifier);
	SAFE_DELETE_ARRAY(m_aiAdditionalTechTransferCommerceRateModifier);
	//SAFE_DELETE_ARRAY(m_aiTotalTechTransferCommerceRateModifier);
	// MOD - END - Tech Transfer Commerce
	SAFE_DELETE_ARRAY(m_aiStateReligionBuildingCommerce);
	// MOD - START - Advanced Yield and Commerce Effects
	//SAFE_DELETE_ARRAY(m_aiSpecialistExtraCommerce);
	SAFE_DELETE_ARRAY(m_aiAllSpecialistCommerceChanges);
	// MOD - END - Advanced Yield and Commerce Effects
...
void CvPlayer::init(PlayerTypes eID)
{
	...
	if ((GC.getInitCore().getSlotStatus(getID()) == SS_TAKEN) || (GC.getInitCore().getSlotStatus(getID()) == SS_COMPUTER))
	{
		...
		{
			setCommercePercent((CommerceTypes)iI, GC.getCommerceInfo((CommerceTypes)iI).getInitialPercent(), true); // K-Mod
			// MOD - START - Open Borders Commerce
			changeBaseOpenBordersFreeCityCommerce(((CommerceTypes)iI), GC.getCommerceInfo((CommerceTypes)iI).getBaseOpenBordersFreeCityCommerce());
			changeBaseOpenBordersCommerceRateModifier(((CommerceTypes)iI), GC.getCommerceInfo((CommerceTypes)iI).getBaseOpenBordersCommerceRateModifier());
			changeAdditionalOpenBordersFreeCityCommerce(((CommerceTypes)iI), GC.getCommerceInfo((CommerceTypes)iI).getAdditionalOpenBordersFreeCityCommerce());
			changeAdditionalOpenBordersCommerceRateModifier(((CommerceTypes)iI), GC.getCommerceInfo((CommerceTypes)iI).getAdditionalOpenBordersCommerceRateModifier());
			// MOD - END - Open Borders Commerce
			// MOD - START - Tech Transfer Commerce
			//changeBaseTechTransferFreeCityCommerce(((CommerceTypes)iI), GC.getCommerceInfo((CommerceTypes)iI).getBaseTechTransferFreeCityCommerce());
			changeBaseTechTransferCommerceRateModifier(((CommerceTypes)iI), GC.getCommerceInfo((CommerceTypes)iI).getBaseTechTransferCommerceRateModifier());
			//changeAdditionalTechTransferFreeCityCommerce(((CommerceTypes)iI), GC.getCommerceInfo((CommerceTypes)iI).getAdditionalTechTransferFreeCityCommerce());
			changeAdditionalTechTransferCommerceRateModifier(((CommerceTypes)iI), GC.getCommerceInfo((CommerceTypes)iI).getAdditionalTechTransferCommerceRateModifier());
			// MOD - END - Tech Transfer Commerce
		}
		...
		for (iI = 0; iI < GC.getNumTraitInfos(); iI++)
		{
			if (hasTrait((TraitTypes)iI))
			{
				...
				changeGlobalEpidemicModifier(kTrait.getGlobalEpidemicModifier());
				// MOD - END - Epidemics

				for (iJ = 0; iJ < NUM_YIELD_TYPES; iJ++)
				{
					changeTradeYieldModifier(((YieldTypes)iJ), kTrait.getTradeYieldModifier(iJ));
				}

				for (iJ = 0; iJ < NUM_COMMERCE_TYPES; iJ++)
				{
					changeFreeCityCommerce(((CommerceTypes)iJ), kTrait.getCommerceChange(iJ));
					changeCommerceRateModifier(((CommerceTypes)iJ), kTrait.getCommerceModifier(iJ));
				}

				// MOD - START - Trait UnitCombat Free Experience
				for (iJ = 0; iJ < GC.getNumUnitCombatInfos(); iJ++)
				{
					changeUnitCombatFreeExperience(((UnitCombatTypes)iJ), kTrait.getUnitCombatFreeExperience(iJ));
				}
				...
				changeCoastalTradeRoutes(kTrait.getCoastalTradeRoutes());
				// MOD - END - Trait Coastal Trade Routes
				
				// MOD - START - Trait Golden Age Modifier
				changeGoldenAgeModifier(kTrait.getGoldenAgeModifier());
				// MOD - END - Trait Golden Age Modifier

				// MOD - START - Trait Upgrade Modifier
				changeUpgradeDiscount(kTrait.getUpgradeDiscount());
				// MOD - END - Trait Upgrade Modifier

				// MOD - START - Trait Trade Modifier
				changeTradeRouteIncomeModifier(kTrait.getTradeRouteIncomeModifier());
				changeForeignTradeRouteIncomeModifier(kTrait.getForeignTradeRouteIncomeModifier());
				// MOD - END - Trait Trade Modifier

				// MOD - START - Trait Worker Speed Modifier
				changeWorkerSpeedModifier(kTrait.getWorkerSpeedModifier());
				// MOD - END - Trait Worker Speed Modifier

				// MOD - START - Congestion
				changeInsideCityCongestionThreshold(kTrait.getInsideCityCongestionThresholdChange());
				changeOutsideCityCongestionThreshold(kTrait.getOutsideCityCongestionThresholdChange());
				// MOD - END - Congestion

				// MOD - START - Advanced Yield and Commerce Effects
				for (int iI = 0; iI < kTrait.getNumImprovementYieldChanges(); iI++)
				{
					ImprovementTypes eLoopImprovement = (ImprovementTypes)kTrait.getImprovementYieldChangeImprovement(iI);
					YieldTypes eLoopYield = (YieldTypes)kTrait.getImprovementYieldChangeYield(iI);
					changeImprovementYieldChange(eLoopImprovement, eLoopYield, kTrait.getImprovementYieldChangeValue(iI));
				}

				for (int iI = 0; iI < kTrait.getNumSpecialistYieldChanges(); iI++)
				{
					SpecialistTypes eLoopSpecialist = (SpecialistTypes)kTrait.getSpecialistYieldChangeSpecialist(iI);
					YieldTypes eLoopYield = (YieldTypes)kTrait.getSpecialistYieldChangeYield(iI);
					changeSpecialistYieldChange(eLoopSpecialist, eLoopYield, kTrait.getSpecialistYieldChangeValue(iI));
				}

				for (int iI = 0; iI < kTrait.getNumSpecialistCommerceChanges(); iI++)
				{
					SpecialistTypes eLoopSpecialist = (SpecialistTypes)kTrait.getSpecialistCommerceChangeSpecialist(iI);
					CommerceTypes eLoopCommerce = (CommerceTypes)kTrait.getSpecialistCommerceChangeCommerce(iI);
					changeSpecialistCommerceChange(eLoopSpecialist, eLoopCommerce, kTrait.getSpecialistCommerceChangeValue(iI));
				}
				// MOD - END - Advanced Yield and Commerce Effects
			}
		}
...
void CvPlayer::uninit()
{
	...
	// MOD - START - Unit Roles
	SAFE_DELETE_ARRAY(m_paiUnitRoleCostModifier);
	SAFE_DELETE_ARRAY(m_paiUnitRoleCount);
	SAFE_DELETE_ARRAY(m_paiUnitRoleMaking);
	// MOD - END - Unit Roles
	SAFE_DELETE_ARRAY(m_paiUnitClassCount);
	SAFE_DELETE_ARRAY(m_paiUnitClassMaking);
	// MOD - START - Player Build Caching
	SAFE_DELETE_ARRAY(m_paiBuilderCount);
	// MOD - END - Player Build Caching
	...
	// MOD - START - Holy City Migration
	SAFE_DELETE_ARRAY(m_paiHolyCityInfluence);
	SAFE_DELETE_ARRAY(m_paiHolyCityCandidate);
	// MOD - END - Holy City Migration
	...
	// MOD - START - Religion Affected Bonuses
	SAFE_DELETE_ARRAY(m_pabReligionNoBonusHealthiness);
	SAFE_DELETE_ARRAY(m_pabReligionNoBonusHappiness);
	// MOD - END - Religion Affected Bonuses
	SAFE_DELETE_ARRAY(m_pabResearchingTech);
	SAFE_DELETE_ARRAY(m_pabLoyalMember);
	// MOD - START - Player Build Caching
	SAFE_DELETE_ARRAY(m_pabBuildCache);
	// MOD - END - Player Build Caching
...
void CvPlayer::reset(PlayerTypes eID, bool bConstructorCall)
{
	...
	// MOD - START - Holy City Migration
	m_iCanAcquireHolyCityWithoutStateReligionCount = 0;
	m_iCanMaintainHolyCityWithoutStateReligionCount = 0;
	// MOD - END - Holy City Migration
	...
	// MOD - END - Trait Upgrade Modifier
	// MOD - START - Congestion
	m_iInsideCityCongestionThreshold = 0;
	m_iOutsideCityCongestionThreshold = 0;
	// MOD - END - Congestion
...
/*************************************************************************************************/
	...
	// Used for DynamicCivNames (old style)
//	clear(m_szName);
//	clear(m_szCivDesc);
//	clear(m_szCivShort);
//	clear(m_szCivAdj);
	...
	m_iRevModifier = 0;
	m_iRevModifierScore = 0;
	m_iRevModifierPower = 0;
	m_iRevModifierEoH = 0;
	m_iRevModifierWE = 0;
...
/*************************************************************************************************/
	...
	if (m_eID != NO_PLAYER)
	{
		...
		// MOD - START - Epidemics
		if (m_ePersonalityType != NO_LEADER)
		{
			m_iAcceptableEpidemicPercent = GC.getLeaderHeadInfo(m_ePersonalityType).getAcceptableEpidemicPercent();
		}
		// MOD - END - Epidemics
	}
	else
	...
	for (iI = 0; iI < NUM_COMMERCE_TYPES; iI++)
	{
		...
		// MOD - START - Open Borders Commerce
		m_aiBaseOpenBordersFreeCityCommerce[iI] = 0;
		m_aiAdditionalOpenBordersFreeCityCommerce[iI] = 0;
		m_aiTotalOpenBordersFreeCityCommerce[iI] = 0;
		// MOD - END - Open Borders Commerce
		// MOD - START - Tech Transfer Commerce
		/*
		m_aiBaseTechTransferFreeCityCommerce[iI] = 0;
		m_aiAdditionalTechTransferFreeCityCommerce[iI] = 0;
		m_aiTotalTechTransferFreeCityCommerce[iI] = 0;
		*/
		// MOD - END - Tech Transfer Commerce
		...
		// MOD - START - Open Borders Commerce
		m_aiBaseOpenBordersCommerceRateModifier[iI] = 0;
		m_aiAdditionalOpenBordersCommerceRateModifier[iI] = 0;
		m_aiTotalOpenBordersCommerceRateModifier[iI] = 0;
		// MOD - END - Open Borders Commerce
		// MOD - START - Tech Transfer Commerce
		m_aiBaseTechTransferCommerceRateModifier[iI] = 0;
		m_aiAdditionalTechTransferCommerceRateModifier[iI] = 0;
		//m_aiTotalTechTransferCommerceRateModifier[iI] = 0;
		// MOD - END - Tech Transfer Commerce
		m_aiStateReligionBuildingCommerce[iI] = 0;
		// MOD - START - Advanced Yield and Commerce Effects
		//m_aiSpecialistExtraCommerce[iI] = 0;
		m_aiAllSpecialistCommerceChanges[iI] = 0;
		// MOD - END - Advanced Yield and Commerce Effects
	...
	{
		m_aiEspionageSpendingWeightAgainstTeam[iI] = 1; // K-Mod (was 0)
		...
		if (!bConstructorCall && getTeam() != NO_TEAM)
		{
			for (iJ = 0; iJ < MAX_PLAYERS; iJ++)
			{
				...
				{
					GET_PLAYER((PlayerTypes) iJ).setEspionageSpendingWeightAgainstTeam(getTeam(), 1); // K-Mod (was 0)
				}
			}
		}
	}
	...
	if (!bConstructorCall)
	{
		...
		// MOD - START - Unit Roles
		FAssertMsg(m_paiUnitRoleCostModifier==NULL, "about to leak memory, CvPlayer::m_paiUnitRoleCostModifier");
		m_paiUnitRoleCostModifier = new int [GC.getNumUnitRoleInfos()];
		FAssertMsg(m_paiUnitRoleCount==NULL, "about to leak memory, CvPlayer::m_paiUnitRoleCount");
		m_paiUnitRoleCount = new int [GC.getNumUnitRoleInfos()];
		FAssertMsg(m_paiUnitRoleMaking==NULL, "about to leak memory, CvPlayer::m_paiUnitRoleMaking");
		m_paiUnitRoleMaking = new int [GC.getNumUnitRoleInfos()];
		for (iI = 0; iI < GC.getNumUnitRoleInfos(); iI++)
		{
			m_paiUnitRoleCostModifier[iI] = 0;
			m_paiUnitRoleCount[iI] = 0;
			m_paiUnitRoleMaking[iI] = 0;
		}
		// MOD - END - Unit Roles
		...
		// MOD - START - Player Build Caching
		FAssertMsg(m_paiBuilderCount==NULL, "about to leak memory, CvPlayer::m_paiBuilderCount");
		m_paiBuilderCount = new int[GC.getNumBuildInfos()];
		for (iI = 0; iI < GC.getNumBuildInfos(); iI++)
		{
			m_paiBuilderCount[iI] = 0;
		}
		// MOD - END - Player Build Caching
		...
		// MOD - START - Holy City Migration
		FAssertMsg(m_paiHolyCityInfluence==NULL, "about to leak memory, CvPlayer::m_paiHolyCityInfluence");
		m_paiHolyCityInfluence = new int[GC.getNumReligionInfos()];
		FAssertMsg(m_paiHolyCityCandidate==NULL, "about to leak memory, CvPlayer::m_paiHolyCityCandidate");
		m_paiHolyCityCandidate = new int[GC.getNumReligionInfos()];
		// MOD - END - Holy City Migration
		for (iI = 0;iI < GC.getNumReligionInfos();iI++)
		{
			m_paiHasReligionCount[iI] = 0;
			// MOD - START - Holy City Migration
			m_paiHolyCityInfluence[iI] = 0;
			m_paiHolyCityCandidate[iI] = FFreeList::INVALID_INDEX;
			// MOD - END - Holy City Migration
		}
		...
		// MOD - START - Religion Affected Bonuses
		FAssertMsg(m_pabReligionNoBonusHealthiness==NULL, "about to leak memory, CvPlayer::m_pabReligionNoBonusHealthiness");
		m_pabReligionNoBonusHealthiness = new bool[GC.getNumBonusInfos()];
		for (iI = 0; iI < GC.getNumBonusInfos(); iI++)
		{
			m_pabReligionNoBonusHealthiness[iI] = false;
		}

		FAssertMsg(m_pabReligionNoBonusHappiness==NULL, "about to leak memory, CvPlayer::m_pabReligionNoBonusHappiness");
		m_pabReligionNoBonusHappiness = new bool[GC.getNumBonusInfos()];
		for (iI = 0; iI < GC.getNumBonusInfos(); iI++)
		{
			m_pabReligionNoBonusHappiness[iI] = false;
		}
		// MOD - END - Religion Affected Bonuses
		...
		// MOD - START - Player Build Caching
		FAssertMsg(m_pabBuildCache==NULL, "about to leak memory, CvPlayer::m_pabBuildCache");
		m_pabBuildCache = new bool[GC.getNumBuildInfos()];
		for (iI = 0; iI < GC.getNumBuildInfos(); iI++)
		{
			m_pabBuildCache[iI] = false;
		}
		// MOD - END - Player Build Caching
		...
		// MOD - START - Player UnitCombat Free Experience
		FAssertMsg(0 < GC.getNumUnitCombatInfos(), "GC.getNumUnitCombatInfos() is not greater than zero but it is used to allocate memory in CvPlayer::reset");
...
void CvPlayer::changeCiv( CivilizationTypes eNewCiv )
{
	...
	if( isAlive() )
	{
		...
		setFlagDecal((CvWString)GC.getCivilizationInfo(eNewCiv).getFlagTexture(), true);
		...
		if (eLoopUnit != NO_UNIT)
		{
			if (canTrain(eLoopUnit))
			{
				...
				*/
				...
				if (kLoopUnit.getNumPrereqAndBonuses() > 0)
				{
					bValid = false;
				}

				if (kLoopUnit.getNumPrereqOrBonuses() > 0)
				{
					bValid = false;
				}
...
*/
CvCity* CvPlayer::initCity(int iX, int iY, bool bBumpUnits, bool bUpdatePlotGroups, PlayerTypes eHighestCulturePlayer)
// MOD - END - Captured City Highest Culture Art (DPII 2008-07-28)
{
	...
	*/
	pCity->init(pCity->getID(), getID(), eHighestCulturePlayer, iX, iY, bBumpUnits, bUpdatePlotGroups);
	// MOD - END - Captured City Highest Culture Art (DPII 2008-07-28)
...
void CvPlayer::acquireCity(CvCity* pOldCity, bool bConquest, bool bTrade, bool bUpdatePlotGroups)
{
	...
	szName = getPlotCityName(pCityPlot);
	if (szName.empty())
	{
		szName = pOldCity->getNameKey();
	}
	...
	*/
	pNewCity = initCity(pCityPlot->getX_INLINE(), pCityPlot->getY_INLINE(), !bConquest, false, eHighestCulturePlayer);
	// MOD - END - Captured City Highest Culture Art (DPII 2008-07-28)
	...
	for (iI = 0; iI < GC.getNumReligionInfos(); iI++)
	{
		...
		if (GC.getGameINLINE().isOption(GAMEOPTION_HOLY_CITY_MIGRATION))
		{
			if (pabHasReligion[iI])
			{
				updateHolyCityCandidate((ReligionTypes)iI);
			}
		}
		// MOD - END - Holy City Migration
	}
...
CvWString CvPlayer::getNewCityName() const
{
	...
	// MOD - START - Dynamic City Naming
	CyArgsList argsList;
	argsList.add(getID());      // pass the player's ID
	CvWString szResult;
	gDLL->getPythonIFace()->callFunction(PYGameModule, "ChooseLeaderSpecificCityName", argsList.makeFunctionArgs(), &szResult);
	szName = szResult;
	//delete pyPlayer;  // python fxn must not hold on to this pointer
	// MOD - END - Dynamic City Naming
...
void CvPlayer::disbandUnit(bool bAnnounce)
{
	...
	{
        #if defined(__GNUC__)
        wprintf(szBuffer, gDLL->getText("TXT_KEY_MISC_UNIT_DISBANDED_NO_MONEY", pBestUnit->getNameKey()).GetCString());
        #else
...
void CvPlayer::setWhiteFlag(bool bNewValue) 
{
	return GC.getInitCore().setWhiteFlag(getID(),bNewValue);
}
...
void CvPlayer::doTurn()
{
	...
	if (GC.getGameINLINE().isOption(GAMEOPTION_HOLY_CITY_MIGRATION))
	{
		updateHolyCityCandidate();
		updateHolyCityInfluence();
	}
	// MOD - END - Holy City Migration
...
void CvPlayer::updatePowerBuildings()
{
	CvCity* pLoopCity;
	int iLoop;
	...
	for (pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
	{
		pLoopCity->updatePowerBuildings();
	}
}
...
void CvPlayer::updateReligionAffectedBuildings()
{
	if (GC.getNumBuildingClassesInactiveWithoutPrereqStateReligion() > 0)
	{
		CvCity* pLoopCity;
		int iLoop;
		...
		for (pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
		{
			...
			for (int iMem = 0; iMem < GC.getNumBuildingClassesInactiveWithoutPrereqStateReligion(); iMem++)
			{
				...
				{
					pLoopCity->updateNumActiveBuilding(eLoopBuilding);
				}
			}
...
// MOD - START - Religion Affected Bonuses
void CvPlayer::updateReligionAffectedBonuses()
{
	...
	if (eReligion != NO_RELIGION)
	{
		...
		{
			setReligionNoBonusHealthiness((BonusTypes)iI, GC.getBonusInfo((BonusTypes)iI).isNoReligionHealthiness(eReligion));
			setReligionNoBonusHappiness((BonusTypes)iI, GC.getBonusInfo((BonusTypes)iI).isNoReligionHappiness(eReligion));
		}
	}
	else
	{
		for (int iI = 0; iI < GC.getNumBonusInfos(); iI++)
		{
			setReligionNoBonusHealthiness((BonusTypes)iI, false);
			setReligionNoBonusHappiness((BonusTypes)iI, false);
		}
	}
}
// MOD - END - Religion Affected Bonuses
...
void CvPlayer::updateSpecialistYield()
{
	int iLoop;

	for (CvCity* pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
	{
		pLoopCity->updateSpecialistYield();
	}
}

void CvPlayer::applyBuildingYieldChange(BuildingClassTypes eBuildingClass, YieldTypes eYield, int iChange)
{
	int iLoop;

	for (CvCity* pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
	{
		pLoopCity->applyBuildingYieldChange(eBuildingClass, eYield, iChange);
	}
}
// MOD - END - Advanced Yield and Commerce Effects
...
// MOD - START - Open Borders Commerce
void CvPlayer::updateOpenBordersCommerce()
{
	updateTotalOpenBordersFreeCityCommerce();
	updateTotalOpenBordersCommerceRateModifiers();
}
// MOD - END - Open Borders Commerce
...
// MOD - START - Tech Transfer Commerce
/*
void CvPlayer::updateTechTransferCommerce()
{
	updateTotalTechTransferFreeCityCommerce();
	updateTotalTechTransferCommerceRateModifiers();
}
*/
// MOD - END - Tech Transfer Commerce
...
void CvPlayer::applyDetriments(TeamTypes eAffectedTeam)
{
	// This is called at the start of a war to switch on the unit aid maluses
	CvUnit* pLoopUnit;
	int iLoop;

	// Loop through units and have each one apply its detriments against the opposing team
	for (pLoopUnit = firstUnit(&iLoop); pLoopUnit != NULL; pLoopUnit = nextUnit(&iLoop))
	{
		pLoopUnit->applyDetrimentsSuppliedByUnit(pLoopUnit->plot(), eAffectedTeam);
	}
}

void CvPlayer::removeDetriments(TeamTypes eAffectedTeam)
{
	// This is called after a war has ended to switch off the unit aid maluses
	CvUnit* pLoopUnit;
	int iLoop;

	// Loop through units and have each one remove its detriments from the opposing team
	for (pLoopUnit = firstUnit(&iLoop); pLoopUnit != NULL; pLoopUnit = nextUnit(&iLoop))
	{
		pLoopUnit->removeDetrimentsSuppliedByUnit(pLoopUnit->plot(), eAffectedTeam);
	}
}
// MOD - END - Detriments
...
int CvPlayer::calculateScore(bool bFinal, bool bVictory) const
{
	...
	*/
	...
	int iPopulationScore = getScoreComponent(getPopScore(), GC.getGameINLINE().getInitPopulation(), GC.getGameINLINE().getMaxPopulation(), GC.getDefineINT("SCORE_POPULATION_FACTOR"), true, bFinal, bVictory);
	int iLandScore = getScoreComponent(getLandScore(), GC.getGameINLINE().getInitLand(), GC.getGameINLINE().getMaxLand(), GC.getDefineINT("SCORE_LAND_FACTOR"), true, bFinal, bVictory);
	int iTechScore = getScoreComponent(getTechScore(), GC.getGameINLINE().getInitTech(), GC.getGameINLINE().getMaxTech(), GC.getDefineINT("SCORE_TECH_FACTOR"), true, bFinal, bVictory);
	int iWondersScore = getScoreComponent(getWondersScore(), GC.getGameINLINE().getInitWonders(), GC.getGameINLINE().getMaxWonders(), GC.getDefineINT("SCORE_WONDER_FACTOR"), false, bFinal, bVictory);

	// MOD - START - Handicap Score Modifier
	//return iPopulationScore + iLandScore + iWondersScore + iTechScore;

	int iModifier = getHandicapScoreModifier();

	int iTotalScore = iPopulationScore + iLandScore + iWondersScore + iTechScore;
	iTotalScore *= std::max(0, 100 + iModifier);
	iTotalScore /= 100;
...
// MOD - START - Inquisition
int CvPlayer::countRemoveNonStateReligionUnits(CvArea* pArea, ReligionTypes eReligion, bool bIncludeTraining) const
{
	PROFILE_FUNC();
	...
	if ( bIncludeTraining )
	{
		...
		for ( pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop) )
		{
			...
			if ( eUnit != NO_UNIT )
			{
				if (getStateReligion() == GC.getUnitInfo(eUnit).getPrereqReligion() && GC.getUnitInfo(eUnit).isRemoveNonStateReligion())
				{
					iCount++;
				}
			}
...
int CvPlayer::countUnimprovedBonuses(CvArea* pArea, CvPlot* pFromPlot, bool bIncludeCityRadius) const
// MOD - END - Sea Improvements
{
	...
	for (int iI = 0; iI < GC.getMapINLINE().numPlotsINLINE(); iI++)
	{
		...
		{
			// MOD - START - Sea Improvements
			if (bIncludeCityRadius || !pLoopPlot->isCityRadius())
			{
			// MOD - END - Sea Improvements
...
// K-Mod
bool CvPlayer::doesImprovementConnectBonus(ImprovementTypes eImprovement, BonusTypes eBonus, bool bCheckTechnology) const
{
	return GET_TEAM(getTeam()).doesImprovementConnectBonus(eImprovement, eBonus, bCheckTechnology);
}
// K-Mod end
...
bool CvPlayer::hasBonusKnowledge(BonusTypes eBonus) const
{
	const CvBonusInfo& kBonusInfo = GC.getBonusInfo(eBonus);
	const CvTeam& kTeam = GET_TEAM(getTeam());
	TechTypes eReveal = (TechTypes)kBonusInfo.getTechReveal();

	if (eReveal == NO_TECH && kBonusInfo.getPlacementOrder() >= 0)
	{
		// The resource exists in the natural world and is visible from the
		// beginning of the game
		return true;
	}

	if (eReveal != NO_TECH && kTeam.isBonusRevealed(eBonus))
	{
		// The resource has a tech to reveal it and our team has that tech
		return true;
	}

	if (getNumAvailableBonuses(eBonus) > 0)
	{
		// We have the bonus on hand in our capital city.
		return true;
	}
	...
	{
		if (pLoopCity->getNumBonuses(eBonus) > 0)
		{
			// At least one of our cities has the bonus.
			return true;
		}
	}

	// Does a trading partner have it?
	for (int iPlayer = 0; iPlayer < MAX_CIV_PLAYERS; iPlayer++)
	{
		PlayerTypes eLoopPlayer = (PlayerTypes)iPlayer;
		if (canContactAndTalk(eLoopPlayer))
		{
			CvPlayer& kLoopPlayer = GET_PLAYER(eLoopPlayer);
			bool bCanTradeAll = (kLoopPlayer.isHuman() || getTeam() == kLoopPlayer.getTeam() || GET_TEAM(kLoopPlayer.getTeam()).isVassal(getTeam()));
			if (kLoopPlayer.getNumTradeableBonuses(eBonus) > (bCanTradeAll ? 0 : 1) && canTradeNetworkWith(eLoopPlayer))
			{
				return true;
			}
		}
	...
	if (eReveal == NO_TECH && kBonusInfo.getPlacementOrder() < 0)
	{
		// It's probably a manufactured good of some kind. See if we can produce it.
		const CvCivilizationInfo& kCivilization = GC.getCivilizationInfo(getCivilizationType());

		for (int iRel = 0; iRel < kBonusInfo.getNumRelatedBuildingClasses(); iRel++)
		{
			BuildingClassTypes eLoopBuildingClass = (BuildingClassTypes)kBonusInfo.getRelatedBuildingClasses(iRel);
			...
			if (!kLoopBuilding.isBonusConverter())
			{
				continue;
			}

			int iProducedBonusIndex = kLoopBuilding.getProducedBonusIndex(eBonus);
			if (iProducedBonusIndex < 0)
			{
				continue;
			}

			// This production building is a bonus source.

			// Do we have one already?
			if (countNumBuildings(eLoopBuilding) > 0)
			{
				return true;
			}
			
			// Can we build it?
			if (canConstruct(eLoopBuilding, false, true, false, false, false))
			{
				return true;
			}
		}
...
// MOD - START - Religion Affected Bonuses
bool CvPlayer::isReligionNoBonusHealthiness(BonusTypes eBonus) const
{
	...
	return m_pabReligionNoBonusHealthiness[eBonus];
}

void CvPlayer::setReligionNoBonusHealthiness(BonusTypes eBonus, bool bNewValue)
{
	if (isReligionNoBonusHealthiness(eBonus) != bNewValue)
	{
		CvCity* pLoopCity;
		int iLoop;

		m_pabReligionNoBonusHealthiness[eBonus] = bNewValue;

		for (pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
		{
			if (pLoopCity->hasBonus(eBonus))
			{
				pLoopCity->processBonusHealthiness(eBonus, bNewValue ? -1 : 1);
			}
		}
	}
}

bool CvPlayer::isReligionNoBonusHappiness(BonusTypes eBonus) const
{
	FAssertMsg(eBonus >= 0, "eBonus expected to be >= 0");
	FAssertMsg(eBonus < GC.getNumBonusInfos(), "eBonus expected to be < GC.getNumBonusInfos()");
	return m_pabReligionNoBonusHappiness[eBonus];
}

void CvPlayer::setReligionNoBonusHappiness(BonusTypes eBonus, bool bNewValue)
{
	if (isReligionNoBonusHappiness(eBonus) != bNewValue)
	{
		CvCity* pLoopCity;
		int iLoop;

		m_pabReligionNoBonusHappiness[eBonus] = bNewValue;

		for (pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
		{
			if (pLoopCity->hasBonus(eBonus))
			{
				pLoopCity->processBonusHappiness(eBonus, bNewValue ? -1 : 1);
			}
		}
	}
}
...
void CvPlayer::findNewCapital()
{
	...
	if (pBestCity != NULL)
	{
		if (pOldCapital != NULL)
		{
			...
			const CvCivilizationInfo& kCivilization = GC.getCivilizationInfo(getCivilizationType());
			const CvBuildingInfo& kCapitalBuilding = GC.getBuildingInfo(eCapitalBuilding);
			...
			for (int iRel = 0; iRel < kCapitalBuilding.getNumRelatedBuildingClasses(); iRel++)
			{
				...
				{
					if (pOldCapital->getNumBuilding(eRelatedBuilding) > 0)
					{
					...
					// MOD - START - Advanced Building Prerequisites
						...
						for (int iPre = 0; iPre < kRelatedBuilding.getNumPrereqAndBuildingClasses(); iPre++)
						{
							...
							if (ePrereqBuilding == eCapitalBuilding)
							{
								pOldCapital->setNumRealBuilding(eRelatedBuilding, 0);
							}
						}
...
void CvPlayer::raze(CvCity* pCity)
{
    ...
    #if defined(__GNUC__)
    wprintf(szBuffer, gDLL->getText("TXT_KEY_MISC_DESTROYED_CITY", pCity->getNameKey()).GetCString());
    #else
	...
	for (iI = 0; iI < MAX_PLAYERS; iI++)
	{
		if (GET_PLAYER((PlayerTypes)iI).isAlive())
		{
			if (iI != getID())
			{
				...
				{
                    #if defined(__GNUC__)
                    wprintf(szBuffer, gDLL->getText("TXT_KEY_MISC_CITY_HAS_BEEN_RAZED_BY", pCity->getNameKey(), getCivilizationDescriptionKey()).GetCString());
                    #else
    ...
    #if defined(__GNUC__)
    wprintf(szBuffer, gDLL->getText("TXT_KEY_MISC_CITY_RAZED_BY", pCity->getNameKey(), getCivilizationDescriptionKey()).GetCString());
    #else
...
void CvPlayer::found(int iX, int iY)
{
	...
	*/
	CvCity* pCity = initCity(iX, iY, true, true, NO_PLAYER);
	// MOD - END - Captured City Highest Culture Art (DPII 2008-07-28)
	FAssertMsg(pCity != NULL, "City is not assigned a valid value");

	if (isBarbarian())
	{
		// MOD - START - Barbarian City Flavor
		...
		*/
		...
		{
			UnitTypes eDefenderUnit = pCity->AI_bestUnitAI(UNITAI_CITY_DEFENSE, false, NO_ADVISOR, true);
			...
			if (eDefenderUnit != NO_UNIT)
			{
				// MOD - START - Debugging
				/*
				CvUnitInfo& kUnitInfo = GC.getUnitInfo(eDefenderUnit);
				CvWString szBuffer;
				szBuffer.Format(L"Barbarian city of %s spawning unit %d of %d: %s", pCity->getNameKey(), iI, GC.getHandicapInfo(GC.getGameINLINE().getHandicapType()).getBarbarianInitialDefenders(), kUnitInfo.getTextKeyWide());
				gDLL->getInterfaceIFace()->addMessage(GC.getGameINLINE().getActivePlayer(), false, GC.getEVENT_MESSAGE_TIME(), szBuffer, "AS2D_NEWTURN", MESSAGE_TYPE_MAJOR_EVENT, NULL, (ColorTypes)GC.getInfoTypeForString("COLOR_WHITE"));
				*/
				// MOD - END - Debugging
				initUnit(eDefenderUnit, iX, iY, UNITAI_CITY_DEFENSE);
			}
			...
			{
				CvWString szBuffer;
				szBuffer.Format(L"Barbarian city of %s unable to spawn defending unit %d of %d", pCity->getNameKey(), iI, GC.getHandicapInfo(GC.getGameINLINE().getHandicapType()).getBarbarianInitialDefenders());
				gDLL->getInterfaceIFace()->addMessage(GC.getGameINLINE().getActivePlayer(), false, GC.getEVENT_MESSAGE_TIME(), szBuffer, "AS2D_NEWTURN", MESSAGE_TYPE_MAJOR_EVENT, NULL, (ColorTypes)GC.getInfoTypeForString("COLOR_RED"));
			}
			*/
			// MOD - END - Debugging
		}
		// MOD - END - Free Units May Consume Food
		// MOD - END - Barbarian City Flavor
	}
...
bool CvPlayer::canTrain(UnitTypes eUnit, bool bContinue, bool bTestVisible, bool bIgnoreCost) const
{
	...
	*/
	...
	if (kUnit.getNumPrereqAndTechs() > 0)
	{
		for (iI = 0; iI < kUnit.getNumPrereqAndTechs(); iI++)
		{
			if (!(GET_TEAM(getTeam()).isHasTech((TechTypes)(kUnit.getPrereqAndTechs(iI)))))
			{
				return false;
	...
	else if (bTestVisible)
	{
		...
		// When testing visibility, if the unit has no prerequisite techs but has
		// prerequisite bonuses, we test the player's knowledge of those bonuses
		// and use it as a proxy for visibility.

		for (iI = 0; iI < kUnit.getNumPrereqAndBonuses(); iI++)
		{
			BonusTypes eBonus = (BonusTypes)kUnit.getPrereqAndBonuses(iI);
			if (!hasBonusKnowledge(eBonus))
			{
				return false;
			}
		}
		...
		if (kUnit.getNumPrereqOrBonuses() > 0)
		{
			...
			{
				BonusTypes eBonus = (BonusTypes)kUnit.getPrereqOrBonuses(iI);
				if (hasBonusKnowledge(eBonus))
				{
					bFound = true;
					break;
	...
	{
		if (GET_TEAM(getTeam()).isHasTech((TechTypes)(kUnit.getObsoleteTech())))
		{
			return false;
		}
	}
	...
	{
		if (!(isCivic((CivicTypes)(kUnit.getPrereqCivic()))))
		{
			// MOD - START - Trait UnitClass enabled (no prereq Civic)
			bool bPrereqRemains = true;
			for (iI = 0; iI < GC.getNumTraitInfos(); iI++)
			{
				if (hasTrait((TraitTypes)iI))
				{
					if (GC.getTraitInfo((TraitTypes)iI).isNoPrereqCivicUnitClass(eUnitClass))
					{
						bPrereqRemains = false;
					}
				}
			}
			if (bPrereqRemains)
	...
	// MOD - START - Unit Global Tech - units with the GlobalTech xml tag cannot be trained until at least one known civ knows the tech set to it
	// note that this is currently inactive because of another implementation, but doesn't cost anything in performance if no units has a GlobalTech set to them
	else
	{
		if (kUnit.getGlobalTech() != NO_TECH)
		{
			bool bFound = false;
			// if the owner civ has the tech, it already has access to the normal unit, so no point in adding the foreign version
			if (!(GET_TEAM(getTeam()).isHasTech((TechTypes)(kUnit.getGlobalTech()))))
			{
				for (int i = 0; i < MAX_CIV_PLAYERS; i++)
				{
					PlayerTypes eLoopPlayer = (PlayerTypes)i;
					CvPlayer& kLoopPlayer = GET_PLAYER(eLoopPlayer);
					// if a civ we have contact with has the tech, we are good to go
					if (canContactAndTalk(eLoopPlayer) && GET_TEAM(kLoopPlayer.getTeam()).isHasTech((TechTypes)(kUnit.getGlobalTech())))
					{
						bFound = true;
						break;
					}
...
// MOD - END - Advanced Building Prerequisites (Civic)
{
	...
	CvTeamAI& kCurrentTeam = GET_TEAM(getTeam());
	...
	if (!bIgnoreTech) // K-Mod
	{
		...
		// Old code deleted
		for (int iPre = 0; iPre < kBuilding.getNumPrereqAndTechs(); iPre++)
		{
			if (!kCurrentTeam.isHasTech((TechTypes)kBuilding.getPrereqAndTechs(iPre)))
			{
				return false;
			}
		}
	...
	if (kCurrentTeam.isObsoleteBuilding(eBuilding))
	{
		return false;
	}

	// MOD - START - Building Discontinuation
	if (kCurrentTeam.isDiscontinuedBuilding(eBuilding))
	{
		return false;
	}
	...
	{
		if (!(kCurrentTeam.isHasTech((TechTypes)(GC.getSpecialBuildingInfo((SpecialBuildingTypes) kBuilding.getSpecialBuildingType()).getTechPrereq()))))
		{
			return false;
		}
	}
	...
	if (kBuilding.getVictoryPrereq() != NO_VICTORY)
	{
		...
		if (kCurrentTeam.getVictoryCountdown((VictoryTypes)kBuilding.getVictoryPrereq()) >= 0)
		{
			return false;
		}
	}
	...
	if (kCurrentTeam.isBuildingClassMaxedOut(eBuildingClass))
	{
		return false;
	}
	...
	for (int iRel = 0; iRel < kBuilding.getNumRelatedBuildingClasses(); iRel++)
	{
		...
		if (eLoopBuilding != NO_BUILDING)
		{
			if (kCurrentTeam.isObsoleteBuilding(eLoopBuilding))
			{
	...
	if (!bTestVisible)
	{
		if (GC.getGameINLINE().isBuildingClassMaxedOut(eBuildingClass, (kCurrentTeam.getBuildingClassMaking(eBuildingClass) + ((bContinue) ? -1 : 0))))
		{
			return false;
		}

		if (kCurrentTeam.isBuildingClassMaxedOut(eBuildingClass, (kCurrentTeam.getBuildingClassMaking(eBuildingClass) + ((bContinue) ? -1 : 0))))
		{
			return false;
		}
		...
		{
			BuildingClassTypes eLoopBuildingClass = (BuildingClassTypes)kBuilding.getRelatedBuildingClasses(iRel);
			if (getBuildingClassCount(eLoopBuildingClass) < getBuildingClassPrereqBuilding(eBuilding, eLoopBuildingClass, ((bContinue) ? 0 : getBuildingClassMaking(eBuildingClass))))
			{
				return false;
			}
		}
...
int CvPlayer::getProductionNeeded(UnitTypes eUnit) const
{
	...
	long iProductionNeeded = kUnitInfo.getProductionCost();

	// MOD - START - Unit Roles
	iProductionNeeded *= 10000 + getProductionCostScalingModifier(eUnit);
	iProductionNeeded /= 10000;
	// MOD - END - Unit Roles
...
int CvPlayer::getProductionNeeded(BuildingTypes eBuilding) const
{
	...
	for (int iI = 0; iI < GC.getNumCivicOptionInfos(); iI++)
	{
		...
		if (GC.getCivicInfo(eCivic).getWonderCostModifier() != 0)
		{
			if (isWorldWonderClass((BuildingClassTypes)(GC.getBuildingInfo(eBuilding).getBuildingClassType())))
			{
				iProductionNeeded *= std::max(0, (100 + GC.getCivicInfo(eCivic).getWonderCostModifier()));
				iProductionNeeded /= 100;
			}
		}
	}
...
// MOD - START - Unit Roles
long CvPlayer::getProductionCostScalingModifier(UnitTypes eUnit) const
{
	...
	long iProductionModifier = getUnitClassCount(eUnitClass) * kUnitClass.getInstanceCostModifier() * 100; // 10000 == 100%

	if (kUnitClass.getNumRoles() > 0)
	{
		long iAvgRoleCostModifier = 0;
		for (int iMem = 0; iMem < kUnitClass.getNumRoles(); iMem++)
		{
			UnitRoleTypes eUnitRole = (UnitRoleTypes)kUnitClass.getRoles(iMem);
			iAvgRoleCostModifier += getUnitRoleCostModifier(eUnitRole);
		}
		iAvgRoleCostModifier /= kUnitClass.getNumRoles();

		iProductionModifier += iAvgRoleCostModifier;
	}

	return iProductionModifier; // 10000 == 100%
}
// MOD - END - Unit Roles
...
void CvPlayer::processBuilding(BuildingTypes eBuilding, int iChange, CvArea* pArea)
{
	...
	// MOD - START - Unlimited Conscription
	changeUnlimitedConscriptCount(GC.getBuildingInfo(eBuilding).isGlobalUnlimitedConscript() ? iChange : 0);
	// MOD - END - Unlimited Conscription
	// MOD - START - Wartime Conscription
	changeWarConscript(GC.getBuildingInfo(eBuilding).getGlobalWarConscript() * iChange);
	// MOD - END - Wartime Conscription
	...
	// MOD - START - Epidemics
	// Epidemic system by Mexico
	changeGlobalEpidemicModifier(GC.getBuildingInfo(eBuilding).getGlobalEpidemicModifier() * iChange);
	// MOD - END - Epidemics
	...
	// MOD - START - Congestion
	changeInsideCityCongestionThreshold(GC.getBuildingInfo(eBuilding).getInsideCityCongestionThresholdChange());
	changeOutsideCityCongestionThreshold(GC.getBuildingInfo(eBuilding).getOutsideCityCongestionThresholdChange());
	// MOD - END - Congestion
	...
	for (int iI = 0; iI < NUM_COMMERCE_TYPES; iI++)
	{
		...
		changeAllSpecialistCommerceChange(((CommerceTypes)iI), (GC.getBuildingInfo(eBuilding).getAllSpecialistCommerce(iI) * iChange));
		// MOD - END - Advanced Yield and Commerce Effects
	...
	*/
	...
	/*
	for (int iMem = 0; iMem < kBuilding.getNumGlobalBonusYieldChanges(); iMem++)
	{
		changeBonusYieldChange((BonusTypes)kBuilding.getGlobalBonusYieldChangeBonus(iMem), (YieldTypes)kBuilding.getGlobalBonusYieldChangeYield(iMem), kBuilding.getGlobalBonusYieldChangeValue(iMem) * iChange);
	}
	*/

	for (int iMem = 0; iMem < kBuilding.getNumGlobalImprovementYieldChanges(); iMem++)
	{
		changeImprovementYieldChange((ImprovementTypes)kBuilding.getGlobalImprovementYieldChangeImprovement(iMem), (YieldTypes)kBuilding.getGlobalImprovementYieldChangeYield(iMem), kBuilding.getGlobalImprovementYieldChangeValue(iMem) * iChange);
	}

	for (int iMem = 0; iMem < kBuilding.getNumGlobalSpecialistYieldChanges(); iMem++)
	{
		changeSpecialistYieldChange((SpecialistTypes)kBuilding.getGlobalSpecialistYieldChangeSpecialist(iMem), (YieldTypes)kBuilding.getGlobalSpecialistYieldChangeYield(iMem), kBuilding.getGlobalSpecialistYieldChangeValue(iMem) * iChange);
	}

	for (int iMem = 0; iMem < kBuilding.getNumGlobalSpecialistCommerceChanges(); iMem++)
	{
		changeSpecialistCommerceChange((SpecialistTypes)kBuilding.getGlobalSpecialistCommerceChangeSpecialist(iMem), (CommerceTypes)kBuilding.getGlobalSpecialistCommerceChangeCommerce(iMem), kBuilding.getGlobalSpecialistCommerceChangeValue(iMem) * iChange);
	}

	for (int iMem = 0; iMem < kBuilding.getNumGlobalBuildingYieldChanges(); iMem++)
	{
		changeBuildingYieldChange((BuildingClassTypes)kBuilding.getGlobalBuildingYieldChangeBuildingClass(iMem), (YieldTypes)kBuilding.getGlobalBuildingYieldChangeYield(iMem), kBuilding.getGlobalBuildingYieldChangeValue(iMem) * iChange);
	}

	for (int iMem = 0; iMem < kBuilding.getNumGlobalBuildingCommerceChanges(); iMem++)
	{
		changeBuildingCommerceChange((BuildingClassTypes)kBuilding.getGlobalBuildingCommerceChangeBuildingClass(iMem), (CommerceTypes)kBuilding.getGlobalBuildingCommerceChangeCommerce(iMem), kBuilding.getGlobalBuildingCommerceChangeValue(iMem) * iChange);
	}
	// MOD - END - Advanced Yield and Commerce Effects
}
...
// MOD - START - Player Build Caching
void CvPlayer::updateBuildCache()
{
	for (int iBuild = 0; iBuild < GC.getNumBuildInfos(); iBuild++)
	{
		updateBuildCache((BuildTypes)iBuild);
	}
}


void CvPlayer::updateBuildCache(BuildTypes eBuild)
{
	FASSERT_BOUNDS(0, GC.getNumBuildInfos(), eBuild, "CvPlayer::updateBuildCache");

	if (getBuilderCount(eBuild) == 0)
	{
		if (getCivilizationType() == NO_CIVILIZATION || !GC.getCivilizationInfo(getCivilizationType()).canBuild(eBuild))
		{
			m_pabBuildCache[eBuild] = false;
			return;
		}
	}
	...
	m_pabBuildCache[eBuild] = true;
}


bool CvPlayer::canBuild(BuildTypes eBuild) const
{
	FASSERT_BOUNDS(0, GC.getNumBuildInfos(), eBuild, "CvPlayer::canBuild");
	return m_pabBuildCache[eBuild];
}
// MOD - END - Player Build Caching
...
bool CvPlayer::canBuild(const CvPlot* pPlot, BuildTypes eBuild, bool bTestEra, bool bTestVisible) const
{
	...
	else
	{
		...
		if (!kCiv.canBuild(eBuild) && getBuilderCount(eBuild) == 0)
		{
			return false;
		}
		...
		if (ePrereqTech != NO_TECH)
		{
			...
			{
				if ((!bTestEra && !bTestVisible) || ((getCurrentEra() + 1) < GC.getTechInfo(ePrereqTech).getEra()))
				{
					return false;
				}
			}
...
// MOD - START - Unique Improvements
bool CvPlayer::canProduceImprovement(ImprovementTypes eImprovement) const
{
	const CvCivilizationInfo& kCivilization = GC.getCivilizationInfo(getCivilizationType());
	const CvTeam& kTeam = GET_TEAM(getTeam());

	// TODO: Cache all of this in an improvement cache?
	...
	for (int iBuild = 0; iBuild < GC.getNumBuildInfos(); iBuild++)
	{
		...
		{
			bool bBuildsImprovement = false;
			int iDepth = 0;
			while (eLoopImprovement != NO_IMPROVEMENT && iDepth < 10)
			{
				eLoopImprovement = (ImprovementTypes)GC.getImprovementInfo(eLoopImprovement).getImprovementUpgrade();
				if (eLoopImprovement == eImprovement)
				{
					bBuildsImprovement = true;
					break;
				}
				iDepth++;
			}
			if (!bBuildsImprovement)
			{
				continue;
			}
		}
...
int CvPlayer::getBuildCost(const CvPlot* pPlot, BuildTypes eBuild) const
{
	...
	return std::max(0, GC.getBuildInfo(eBuild).getCost() * (100 + getInflationRate())) / 100; // K-Mod
}
	...
	for (int iRoute = GC.getNumRouteInfos() - 1; iRoute >= 0; iRoute--)
	{
		...
		if (iValue > iBestValue)
		{
			...
			if (pPlot != NULL)
			{
				...
				{
					for (int iRel = 0; iRel < kRoute.getNumBuilds(); iRel++)
					{
						BuildTypes eBuild = (BuildTypes)kRoute.getBuilds(iRel);
						if (GC.getRouteInfo(eRoute).isUniqueRoute()) 
							{
								const CivilizationTypes kCivilization = getCivilizationType();
								const CivilizationTypes expCivilization = ((CivilizationTypes)14); // Hardcoded Germany
								if (kCivilization == expCivilization)
								{
			...
			else
			{
				...
				{
					BuildTypes eBuild = (BuildTypes)kRoute.getBuilds(iRel);
					if (kTeam.isHasTech((TechTypes)GC.getBuildInfo(eBuild).getTechPrereq()))
					{
						...
						if (GC.getRouteInfo(eRoute).isUniqueRoute())
						{
							...
							const CivilizationTypes expCivilization = ((CivilizationTypes)14); // Hardcoded Germany
							CvString szMessage;
							szMessage = "Route debug";
							gDLL->logMsg("debug.log", szMessage,true,true);
							szMessage = GC.getCivilizationInfo(kCivilization).getType();
							gDLL->logMsg("debug.log", szMessage,true,true);
							szMessage = GC.getCivilizationInfo(expCivilization).getType();
							gDLL->logMsg("debug.log", szMessage,true,true);
							if (kCivilization == expCivilization)
							{						
							bValid = true;
...
void CvPlayer::updateInflationRate() // K-Mod
{
...
/* 	{
		...
		for (TechTypes eTech = (TechTypes)0; eTech < GC.getNumTechInfos(); eTech=(TechTypes)(eTech+1))
		{
			for (PlayerTypes j = (PlayerTypes)0; j < MAX_CIV_PLAYERS; j=(PlayerTypes)(j+1))
			{
				...
				{
					int iWeight = kLoopPlayer.getTotalPopulation() * (kLoopPlayer.getTeam() == getTeam() ? 2 : 1) / 25;
					iPotentialTech+=(1+iWeight);
					if (GET_TEAM(kLoopPlayer.getTeam()).isHasTech(eTech))
						iCurrentTech+=(1+iWeight);
				}
			}
		}
		iTurns += (std::max(1L,iCurrentTech))*GC.getGameINLINE().getEstimateEndTurn()*4/(3*std::max(1L, iPotentialTech)); // based on full tech at 3/4 of max time.
		iTurns /= 2;
	} */
	// K-Mod end
	...
	long int iRatePercent = (iTurns * iInflationPerTurnTimes10000) / 100;
...
int CvPlayer::calculateInflatedCosts() const
{
	...
	iCosts *= std::max(0, (getInflationRate() + 100)); // K-Mod
	iCosts /= 100;
...
/************************************************************************************************/
			...
			if (GET_TEAM((TeamTypes)iI).isAlive())
			{
				if (GET_TEAM((TeamTypes)iI).isHasTech(eTech))
				{
					if (GET_TEAM(getTeam()).isHasMet((TeamTypes)iI))
					{
						...
						else if( GET_TEAM(getTeam()).isAtWar((TeamTypes)iI) || GET_TEAM((TeamTypes)iI).isVassal(getTeam())) // they are our vassal
						{
							knownExp += 0.5;
						}
						if (GET_TEAM(getTeam()).isVassal((TeamTypes)iI)) // we are vassal -> more tech!
						{
							knownExp += 1.0;
						}
					}
	...
	// MOD - START - Tech Transfer Commerce
	iModifier += calculateTotalTechTransferCommerceRateModifier(COMMERCE_RESEARCH, eTech);
	// MOD - END - Tech Transfer Commerce
...
//	iModifier += GC.getTechInfo(eTech).getAheadOfTime();
...
int CvPlayer::getCurrentResearchTechTransferCount()
{
	TechTypes eCurrentResearch;
	...
	return GET_TEAM(getTeam()).getTechTransferCount(eCurrentResearch);
}

bool CvPlayer::isCurrentResearchTechTransfer()
{
	TechTypes eCurrentResearch;
	...
	return GET_TEAM(getTeam()).isTechTransfer(eCurrentResearch);
}
...
// MOD - START - Holy City Migration
bool CvPlayer::hasBestHolyCityCandidate(ReligionTypes eReligion) const
{
	FAssertMsg(eReligion != NO_RELIGION, "Religion is not assigned a valid value");

	CvCity* pBestHolyCityCandidate = GC.getGameINLINE().getBestHolyCityCandidate(eReligion);

	if (pBestHolyCityCandidate != NULL)
	{
		return (pBestHolyCityCandidate->getOwnerINLINE() == getID());
	}
...
int CvPlayer::getCivicAnarchyLength(CivicTypes* paeNewCivics) const
{
	...
	// MOD - START - Standard Maximum Anarchy Length: 3 is set as the default cap for maximum anarchy turns for each trait, unless specifically set otherwise
	//return range(iAnarchyLength, 1, getMaxAnarchyTurns());
	if (getMaxAnarchyTurns() == -1)
	{
		return range(iAnarchyLength, 1, 3);
	}
	else
	{
		return range(iAnarchyLength, 1, getMaxAnarchyTurns());
...
// TODO: Determine whether this is really more efficient (typically a hash table would not be faster than simply accessing an array)
...
int CvPlayer::specialistYield(SpecialistTypes eSpecialist, YieldTypes eYield) const
{
	...
	return (GC.getSpecialistInfo(eSpecialist).getYieldChange(eYield) + getSpecialistYieldChange(eSpecialist, eYield));
	// MOD - END - Advanced Yield and Commerce Effects
}
...
int CvPlayer::specialistCommerce(SpecialistTypes eSpecialist, CommerceTypes eCommerce) const
{
	...
	return (GC.getSpecialistInfo(eSpecialist).getCommerceChange(eCommerce) + getSpecialistCommerceChange(eSpecialist, eCommerce) + getAllSpecialistCommerceChange(eCommerce));
	// MOD - END - Advanced Yield and Commerce Effects
}
...
// MOD - START - Epidemics
// Epidemic system by Mexico
int CvPlayer::getAcceptableEpidemicPercent() const
{
	return m_iAcceptableEpidemicPercent;
}

void CvPlayer::setAcceptableEpidemicPercent(int iNewValue)
{
	m_iAcceptableEpidemicPercent = iNewValue;
}

void CvPlayer::changeAcceptableEpidemicPercent(int iChange)
{
	setAcceptableEpidemicPercent(getAcceptableEpidemicPercent() + iChange);
}


int CvPlayer::getGlobalEpidemicModifier() const
{
	return m_iGlobalEpidemicModifier;
}


void CvPlayer::setGlobalEpidemicModifier(int iNewValue)
{
	m_iGlobalEpidemicModifier = iNewValue;
}


void CvPlayer::changeGlobalEpidemicModifier(int iChange)
{
	setGlobalEpidemicModifier(getGlobalEpidemicModifier() + iChange);
}
// MOD - END - Epidemics
...
// MOD - START - Unlimited Conscription
int CvPlayer::getUnlimitedConscriptCount() const
{
	return m_iUnlimitedConscriptCount;
}


bool CvPlayer::isUnlimitedConscript() const
{
	return (getUnlimitedConscriptCount() > 0);
}


void CvPlayer::changeUnlimitedConscriptCount(int iChange)
{
	if (iChange != 0)
	{
		m_iUnlimitedConscriptCount = (m_iUnlimitedConscriptCount + iChange);
		FAssert(getUnlimitedConscriptCount() >= 0);
	}
}
// MOD - END - Unlimited Conscription
...
// MOD - START - Wartime Conscription
int CvPlayer::getWarConscript() const			
{
	return m_iWarConscript;
}


void CvPlayer::changeWarConscript(int iChange)
{
	if (iChange != 0)
	{
...
void CvPlayer::changeStateReligionCount(int iChange)
{
	if (iChange != 0)
	{
		...
		// MOD - START - Advanced Building Prerequisites (Religion)
		updateReligionAffectedBuildings();
		// MOD - END - Advanced Building Prerequisites (Religion)
		// MOD - START - Religion Affected Bonuses
		updateReligionAffectedBonuses();
		// MOD - END - Religion Affected Bonuses
...
// MOD - START - Holy City Migration
int CvPlayer::getCanAcquireHolyCityWithoutStateReligionCount() const
{
	return m_iCanAcquireHolyCityWithoutStateReligionCount;
}


bool CvPlayer::canAcquireHolyCityWithoutStateReligion() const
{
	return (getCanAcquireHolyCityWithoutStateReligionCount() > 0);
}


void CvPlayer::changeCanAcquireHolyCityWithoutStateReligionCount(int iChange)
{
	m_iCanAcquireHolyCityWithoutStateReligionCount = (m_iCanAcquireHolyCityWithoutStateReligionCount + iChange);
	FAssert(getCanAcquireHolyCityWithoutStateReligionCount() >= 0);
}


int CvPlayer::getCanMaintainHolyCityWithoutStateReligionCount() const
{
	return m_iCanMaintainHolyCityWithoutStateReligionCount;
}


bool CvPlayer::canMaintainHolyCityWithoutStateReligion() const
{
	return (getCanMaintainHolyCityWithoutStateReligionCount() > 0);
}


void CvPlayer::changeCanMaintainHolyCityWithoutStateReligionCount(int iChange)
{
	m_iCanMaintainHolyCityWithoutStateReligionCount = (m_iCanMaintainHolyCityWithoutStateReligionCount + iChange);
	FAssert(getCanMaintainHolyCityWithoutStateReligionCount() >= 0);
}
// MOD - END - Holy City Migration
...
// MOD - START - Handicap Score Modifier
int CvPlayer::getHandicapScoreModifier() const
{
	return m_iHandicapScoreModifier;
}


void CvPlayer::setHandicapScoreModifier(int iModifier)
{
	if (iModifier != m_iHandicapScoreModifier)
	{
		m_iHandicapScoreModifier = iModifier;
		FAssert(getHandicapScoreModifier() >= -100);
...
void CvPlayer::setCombatExperience(int iExperience)
{
	...
	if (iExperience != getCombatExperience())
	{
		...
		// MOD - START - Barbarian Great Generals
		//if (!isBarbarian())
		//{
		// MOD - END - Barbarian Great Generals
...
bool CvPlayer::isCommunist() const
{
	int iI;
	
	for (iI = 0; iI < GC.getNumCivicInfos(); iI++)
		{
			if (GC.getCivicInfo((CivicTypes)iI).isCommunist())
			{
...
void CvPlayer::setAlive(bool bNewValue)
{
	...
	if (isAlive() != bNewValue)
	{
		...
		GET_TEAM(getTeam()).setLivingTeamMember(getID(), isAlive());
...
void CvPlayer::setEndTurn(bool bNewValue)
{
	if (isEndTurn() != bNewValue)
	{
		...
		if (isEndTurn())
		{
			...
			// TODO: Make sure this still makes sense after the merge
/************************************************************************************************/
...
// MOD - START - City Messages
bool CvPlayer::isCityMessagesDirty() const
{
	return m_bCityMessagesDirty;
}


void CvPlayer::setCityMessagesDirty(bool bNewValue)
{
	m_bCityMessagesDirty = bNewValue;
}


void CvPlayer::updateCityMessages()
{
	int iLoop;
	CvCity* pLoopCity;

	if (!isCityMessagesDirty())
	{
		return;
	}

	setCityMessagesDirty(false);

	for (pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
	{
		pLoopCity->updateMessages();
	}
}
// MOD - END - City Messages
...
void CvPlayer::setPersonalityType(LeaderHeadTypes eNewValue)
{
	...
	// MOD - START - Epidemics
	if (eNewValue != NO_LEADER)
	{
		m_iAcceptableEpidemicPercent = GC.getLeaderHeadInfo(eNewValue).getAcceptableEpidemicPercent();
	}
	// MOD - END - Epidemics
}
...
int CvPlayer::getEraHappiness() const
{
	int iCount = 0;

	for (int iI = 0; iI < GC.getNumEraInfos(); iI++)
    {
		if (iI >= GC.getGameINLINE().getStartEra() && iI <= getCurrentEra())
		{
			iCount += std::max(0, GC.getEraInfo((EraTypes)iI).getDiscoverHappiness());
		}
	}
...
int CvPlayer::getEraUnhappiness() const
{
	int iCount = 0;
	...
	for (int iI = 0; iI < GC.getNumEraInfos(); iI++)
    {
		if (iI >= GC.getGameINLINE().getStartEra() && iI <= getCurrentEra())
		{
			iCount += std::min(0, GC.getEraInfo((EraTypes)iI).getDiscoverHappiness());
		}
	}
...
int CvPlayer::getEraHealthiness() const
{
	int iCount = 0;
	...
	for (int iI = 0; iI < GC.getNumEraInfos(); iI++)
    {
		if (iI >= GC.getGameINLINE().getStartEra() && iI <= getCurrentEra())
		{
			iCount += std::max(0, GC.getEraInfo((EraTypes)iI).getDiscoverHealth());
		}
	}
...
int CvPlayer::getEraUnhealthiness() const
{
	int iCount = 0;
	...
	for (int iI = 0; iI < GC.getNumEraInfos(); iI++)
    {
		if (iI >= GC.getGameINLINE().getStartEra() && iI <= getCurrentEra())
		{
			iCount += std::min(0, GC.getEraInfo((EraTypes)iI).getDiscoverHealth());
		}
	}
...
void CvPlayer::setTeam(TeamTypes eTeam)
{
	...
	if (isAlive())
	{
		...
		// MOD - START - Cached Team Members (poyuzhe)
		GET_TEAM(getTeam()).setLivingTeamMember(getID(), false);
		// MOD - END - Cached Team Members (poyuzhe)
	}
	if (isEverAlive())
	{
	...
	if (isAlive())
	{
		GET_TEAM(getTeam()).changeAliveCount(1);
		// MOD - START - Cached Team Members (poyuzhe)
		GET_TEAM(getTeam()).setLivingTeamMember(getID(), true);
		// MOD - END - Cached Team Members (poyuzhe)
	}
	if (isEverAlive())
	{
...
// MOD - START - Open Borders Commerce
int CvPlayer::getOpenBordersCommerceBorderCount(CommerceTypes eIndex) const
{
	TeamTypes ePlayerTeam;
	TeamTypes eOtherTeam;
	AttitudeTypes eAttitude;
	int iQualifiedOpenBordersCount;
	int iI;

	CvCommerceInfo& kCommerceInfo = GC.getCommerceInfo(eIndex);
	ePlayerTeam = getTeam();
	CvTeamAI& kPlayerTeam = GET_TEAM(ePlayerTeam);
	iQualifiedOpenBordersCount = 0;

	// Count the number of teams with a good attitude that we have open borders with
	for (iI = 0; iI < MAX_TEAMS; iI++)
	{
		eOtherTeam = (TeamTypes)iI;
		if (eOtherTeam != ePlayerTeam)
		{
			CvTeamAI& kOtherTeam = GET_TEAM(eOtherTeam);
			if (kOtherTeam.isAlive())
			{
				if (kPlayerTeam.isOpenBorders(eOtherTeam))
				{
					eAttitude = kOtherTeam.AI_getAttitude(ePlayerTeam, false);
					if (kCommerceInfo.getOpenBordersCommerceAttitudeTypes(eAttitude))
					{
						iQualifiedOpenBordersCount++;
					}
				}
			}
		}
	...
	return iQualifiedOpenBordersCount;
}


int CvPlayer::getBaseOpenBordersFreeCityCommerce(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiBaseOpenBordersFreeCityCommerce[eIndex];
}

void CvPlayer::changeBaseOpenBordersFreeCityCommerce(CommerceTypes eIndex, int iChange)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	...
	if (iChange != 0)
	{
		m_aiBaseOpenBordersFreeCityCommerce[eIndex] = (m_aiBaseOpenBordersFreeCityCommerce[eIndex] + iChange);
		FAssert(getBaseOpenBordersFreeCityCommerce(eIndex) >= 0);

		updateTotalOpenBordersFreeCityCommerce(eIndex);
	}
}


int CvPlayer::getAdditionalOpenBordersFreeCityCommerce(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiAdditionalOpenBordersFreeCityCommerce[eIndex];
}

void CvPlayer::changeAdditionalOpenBordersFreeCityCommerce(CommerceTypes eIndex, int iChange)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	...
	if (iChange != 0)
	{
		m_aiAdditionalOpenBordersFreeCityCommerce[eIndex] = (m_aiAdditionalOpenBordersFreeCityCommerce[eIndex] + iChange);
		FAssert(getAdditionalOpenBordersFreeCityCommerce(eIndex) >= 0);
...
int CvPlayer::getTotalOpenBordersFreeCityCommerce(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiTotalOpenBordersFreeCityCommerce[eIndex];
}

void CvPlayer::setTotalOpenBordersFreeCityCommerce(CommerceTypes eIndex, int iValue)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");

	int iOldValue = getTotalOpenBordersFreeCityCommerce(eIndex);

	if (iOldValue != iValue)
	{
		m_aiTotalOpenBordersFreeCityCommerce[eIndex] = iValue;
		FAssert(getTotalOpenBordersFreeCityCommerce(eIndex) >= 0);
...
void CvPlayer::updateTotalOpenBordersFreeCityCommerce(CommerceTypes eIndex)
{
	TeamTypes ePlayerTeam;
	int iQualifiedOpenBordersCount;
	int iValue;
	...
	ePlayerTeam = getTeam();
	CvTeam& kPlayerTeam = GET_TEAM(ePlayerTeam);
	iQualifiedOpenBordersCount = getOpenBordersCommerceBorderCount(eIndex);
	iValue = 0;

	if (iQualifiedOpenBordersCount > 0)
	{
		iValue += getBaseOpenBordersFreeCityCommerce(eIndex);
	}

	if (iQualifiedOpenBordersCount > 1)
	{
		iValue += (iQualifiedOpenBordersCount - 1) * getAdditionalOpenBordersFreeCityCommerce(eIndex);
	}

	setTotalOpenBordersFreeCityCommerce(eIndex, iValue);
}

void CvPlayer::updateTotalOpenBordersFreeCityCommerce()
{
	for (int iI = 0; iI < NUM_COMMERCE_TYPES; iI++)
	{
		updateTotalOpenBordersFreeCityCommerce((CommerceTypes) iI);
	}
}
// MOD - END - Open Borders Commerce
...
// MOD - START - Tech Transfer Commerce
/*
int CvPlayer::getBaseTechTransferFreeCityCommerce(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiBaseTechTransferFreeCityCommerce[eIndex];
}

void CvPlayer::changeBaseTechTransferFreeCityCommerce(CommerceTypes eIndex, int iChange)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	...
	if (iChange != 0)
	{
		m_aiBaseTechTransferFreeCityCommerce[eIndex] = (m_aiBaseTechTransferFreeCityCommerce[eIndex] + iChange);
		FAssert(getBaseTechTransferFreeCityCommerce(eIndex) >= 0);

		updateTotalTechTransferFreeCityCommerce(eIndex);
	}
}


int CvPlayer::getAdditionalTechTransferFreeCityCommerce(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiAdditionalTechTransferFreeCityCommerce[eIndex];
}

void CvPlayer::changeAdditionalTechTransferFreeCityCommerce(CommerceTypes eIndex, int iChange)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	...
	if (iChange != 0)
	{
		m_aiAdditionalTechTransferFreeCityCommerce[eIndex] = (m_aiAdditionalTechTransferFreeCityCommerce[eIndex] + iChange);
		FAssert(getAdditionalTechTransferFreeCityCommerce(eIndex) >= 0);
...
int CvPlayer::getTotalTechTransferFreeCityCommerce(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiTotalTechTransferFreeCityCommerce[eIndex];
}

void CvPlayer::setTotalTechTransferFreeCityCommerce(CommerceTypes eIndex, int iValue)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");

	int iOldValue = getTotalTechTransferFreeCityCommerce(eIndex);

	if (iOldValue != iValue)
	{
		m_aiTotalTechTransferFreeCityCommerce[eIndex] = iValue;
		FAssert(getTotalTechTransferFreeCityCommerce(eIndex) >= 0);
...
void CvPlayer::updateTotalTechTransferFreeCityCommerce(CommerceTypes eIndex)
{
	TechTypes eCurrentResearch;
	int iTechTransferCount;
	int iValue;
	...
	if (eCurrentResearch != NO_TECH)
	{
		iTechTransferCount = GET_TEAM(getTeam()).getTechTransferCount(eCurrentResearch);

		if (iTechTransferCount > 0)
		{
			iValue += getBaseTechTransferFreeCityCommerce(eIndex);
		}

		if (iTechTransferCount > 1)
		{
			iValue += (iTechTransferCount - 1) * getAdditionalTechTransferFreeCityCommerce(eIndex);
		}
	}

	setTotalTechTransferCommerceRateModifier(eIndex, iValue);
}

void CvPlayer::updateTotalTechTransferFreeCityCommerce()
{
	for (int iI = 0; iI < NUM_COMMERCE_TYPES; iI++)
	{
		updateTotalTechTransferFreeCityCommerce((CommerceTypes) iI);
	}
}
*/
// MOD - END - Tech Transfer Commerce
...
// MOD - START - Open Borders Commerce
int CvPlayer::getBaseOpenBordersCommerceRateModifier(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiBaseOpenBordersCommerceRateModifier[eIndex];
}

void CvPlayer::changeBaseOpenBordersCommerceRateModifier(CommerceTypes eIndex, int iChange)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	...
	if (iChange != 0)
	{
		m_aiBaseOpenBordersCommerceRateModifier[eIndex] = (m_aiBaseOpenBordersCommerceRateModifier[eIndex] + iChange);
		FAssert(getBaseOpenBordersCommerceRateModifier(eIndex) >= 0);

		updateTotalOpenBordersCommerceRateModifier(eIndex);
	}
}


int CvPlayer::getAdditionalOpenBordersCommerceRateModifier(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiAdditionalOpenBordersCommerceRateModifier[eIndex];
}

void CvPlayer::changeAdditionalOpenBordersCommerceRateModifier(CommerceTypes eIndex, int iChange)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	...
	if (iChange != 0)
	{
		m_aiAdditionalOpenBordersCommerceRateModifier[eIndex] = (m_aiAdditionalOpenBordersCommerceRateModifier[eIndex] + iChange);
		FAssert(getAdditionalOpenBordersCommerceRateModifier(eIndex) >= 0);
...
int CvPlayer::getTotalOpenBordersCommerceRateModifier(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiTotalOpenBordersCommerceRateModifier[eIndex];
}

void CvPlayer::setTotalOpenBordersCommerceRateModifier(CommerceTypes eIndex, int iValue)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");

	int iOldValue = getTotalOpenBordersCommerceRateModifier(eIndex);

	if (iOldValue != iValue)
	{
		m_aiTotalOpenBordersCommerceRateModifier[eIndex] = iValue;
		FAssert(getTotalOpenBordersCommerceRateModifier(eIndex) >= 0);
...
void CvPlayer::updateTotalOpenBordersCommerceRateModifier(CommerceTypes eIndex)
{
	TeamTypes ePlayerTeam;
	int iQualifiedOpenBordersCount;
	int iValue;
	...
	if (iQualifiedOpenBordersCount > 0)
	{
		iValue += getBaseOpenBordersCommerceRateModifier(eIndex);
	}

	if (iQualifiedOpenBordersCount > 1)
	{
		iValue += (iQualifiedOpenBordersCount - 1) * getAdditionalOpenBordersCommerceRateModifier(eIndex);
	}

	setTotalOpenBordersCommerceRateModifier(eIndex, iValue);
}

void CvPlayer::updateTotalOpenBordersCommerceRateModifiers()
{
	for (int iI = 0; iI < NUM_COMMERCE_TYPES; iI++)
	{
		updateTotalOpenBordersCommerceRateModifier((CommerceTypes) iI);
	}
}
// MOD - END - Open Borders Commerce
...
// MOD - START - Tech Transfer Commerce
int CvPlayer::getBaseTechTransferCommerceRateModifier(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiBaseTechTransferCommerceRateModifier[eIndex];
}

void CvPlayer::changeBaseTechTransferCommerceRateModifier(CommerceTypes eIndex, int iChange)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	...
	if (iChange != 0)
	{
		m_aiBaseTechTransferCommerceRateModifier[eIndex] = (m_aiBaseTechTransferCommerceRateModifier[eIndex] + iChange);
		FAssert(getBaseTechTransferCommerceRateModifier(eIndex) >= 0);

		//updateTotalTechTransferCommerceRateModifier(eIndex);
	}
}


int CvPlayer::getAdditionalTechTransferCommerceRateModifier(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiAdditionalTechTransferCommerceRateModifier[eIndex];
}

void CvPlayer::changeAdditionalTechTransferCommerceRateModifier(CommerceTypes eIndex, int iChange)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	...
	if (iChange != 0)
	{
		m_aiAdditionalTechTransferCommerceRateModifier[eIndex] = (m_aiAdditionalTechTransferCommerceRateModifier[eIndex] + iChange);
		FAssert(getAdditionalTechTransferCommerceRateModifier(eIndex) >= 0);
...
/*
int CvPlayer::getTotalTechTransferCommerceRateModifier(CommerceTypes eIndex) const
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");
	return m_aiTotalTechTransferCommerceRateModifier[eIndex];
}

void CvPlayer::setTotalTechTransferCommerceRateModifier(CommerceTypes eIndex, int iValue)
{
	FAssertMsg(eIndex >= 0, "eIndex is expected to be non-negative (invalid Index)");
	FAssertMsg(eIndex < NUM_COMMERCE_TYPES, "eIndex is expected to be within maximum bounds (invalid Index)");

	int iOldValue = getTotalTechTransferCommerceRateModifier(eIndex);

	if (iOldValue != iValue)
	{
		m_aiTotalTechTransferCommerceRateModifier[eIndex] = iValue;
		FAssert(getTotalTechTransferCommerceRateModifier(eIndex) >= 0);
...
int CvPlayer::calculateTotalTechTransferCommerceRateModifier(CommerceTypes eIndex, TechTypes eTech) const
{
	int iTechTransferCount;
	int iValue;
	...
	if (eTech != NO_TECH)
	{
		iTechTransferCount = GET_TEAM(getTeam()).getTechTransferCount(eTech);

		if (iTechTransferCount > 0)
		{
			iValue += getBaseTechTransferCommerceRateModifier(eIndex);
		}

		if (iTechTransferCount > 1)
		{
			iValue += (iTechTransferCount - 1) * getAdditionalTechTransferCommerceRateModifier(eIndex);
		}

		// MOD - START - Vassal Tech Transfer
		int iVassalModifier = GC.getCommerceInfo(eIndex).getVassalTechTransferCommerceRateModifier();
		
		if (iVassalModifier > 0) {
			for (int iLoopTeam = 0; iLoopTeam < MAX_CIV_TEAMS; ++iLoopTeam)
			{
				CvTeam& kLoopTeam = GET_TEAM((TeamTypes)iLoopTeam);
				if (kLoopTeam.isAlive() && kLoopTeam.isVassal(getTeam())) // we are vassal
				{ 
					if (kLoopTeam.isHasTech(eTech))
					{
						iValue += iVassalModifier;
					}
					break;
				}
			}
...
/*
void CvPlayer::updateTotalTechTransferCommerceRateModifier(CommerceTypes eIndex)
{
	TechTypes eCurrentResearch;
	int iValue;

	eCurrentResearch = getCurrentResearch();
	iValue = calculateTotalTechTransferCommerceRateModifier(eIndex, eCurrentResearch);
	setTotalTechTransferCommerceRateModifier(eIndex, iValue);
}

void CvPlayer::updateTotalTechTransferCommerceRateModifiers()
{
	for (int iI = 0; iI < NUM_COMMERCE_TYPES; iI++)
	{
		updateTotalTechTransferCommerceRateModifier((CommerceTypes) iI);
	}
}
*/
// MOD - END - Tech Transfer Commerce
...
int CvPlayer::getAllSpecialistCommerceChange(CommerceTypes eCommerce) const
{
	FASSERT_BOUNDS(0, NUM_COMMERCE_TYPES, eCommerce, "CvPlayer::getAllSpecialistCommerceChange");
	return m_aiAllSpecialistCommerceChanges[eCommerce];
}


void CvPlayer::changeAllSpecialistCommerceChange(CommerceTypes eCommerce, int iChange)
{
	FASSERT_BOUNDS(0, NUM_COMMERCE_TYPES, eCommerce, "CvPlayer::changeAllSpecialistCommerceChange");

	if (iChange != 0)
	{
		m_aiAllSpecialistCommerceChanges[eCommerce] = (m_aiAllSpecialistCommerceChanges[eCommerce] + iChange);
		FAssert(getAllSpecialistCommerceChange(eCommerce) >= 0);
...
int CvPlayer::getSpecialistCommerceChange(SpecialistTypes eSpecialist, CommerceTypes eCommerce) const
{
	FASSERT_BOUNDS(0, GC.getNumSpecialistInfos(), eSpecialist, "CvPlayer::getSpecialistCommerceChange");
	FASSERT_BOUNDS(0, NUM_COMMERCE_TYPES, eCommerce, "CvPlayer::getSpecialistCommerceChange");
	return m_ppaaiSpecialistExtraCommerce[eSpecialist][eCommerce];
}


void CvPlayer::changeSpecialistCommerceChange(SpecialistTypes eSpecialist, CommerceTypes eCommerce, int iChange)
{
	FASSERT_BOUNDS(0, GC.getNumSpecialistInfos(), eSpecialist, "CvPlayer::changeSpecialistCommerceChange");
	FASSERT_BOUNDS(0, NUM_COMMERCE_TYPES, eCommerce, "CvPlayer::changeSpecialistCommerceChange");

	if (iChange != 0)
	{
		m_ppaaiSpecialistExtraCommerce[eSpecialist][eCommerce] = (m_ppaaiSpecialistExtraCommerce[eSpecialist][eCommerce] + iChange);
		//FAssert(getSpecialistCommerceChange(eSpecialist, eCommerce) >= 0);
...
void CvPlayer::updateSpecialistCommerce(CommerceTypes eCommerce)
{
	int iLoop;

	for (CvCity* pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
	{
		pLoopCity->updateSpecialistCommerce(eCommerce);
	}
}
// MOD - END - Advanced Yield and Commerce Effects
...
void CvPlayer::changeBonusExport(BonusTypes eIndex, int iChange)
{
	...
	if (iChange != 0)
	{
		...
		*/
		...
		if (pCapitalCity != NULL)
		{
			pCapitalCity->plot()->changeNumPlotGroupBonuses(eIndex, -iChange);
		}
...
// MOD - START - Unit Roles
int CvPlayer::getUnitRoleCostModifier(UnitRoleTypes eIndex) const
{
	FASSERT_BOUNDS(0, GC.getNumUnitRoleInfos(), eIndex, "CvPlayer::getUnitRoleCostModifier");
	return m_paiUnitRoleCostModifier[eIndex];
}

void CvPlayer::changeUnitRoleCostModifier(UnitRoleTypes eIndex, int iChange)
{
	FASSERT_BOUNDS(0, GC.getNumUnitRoleInfos(), eIndex, "CvPlayer::changeUnitRoleCostModifier");
	m_paiUnitRoleCostModifier[eIndex] = (m_paiUnitRoleCostModifier[eIndex] + iChange);
	FAssert(getUnitRoleCostModifier(eIndex) >= 0);
}


int CvPlayer::getUnitRoleCount(UnitRoleTypes eIndex) const
{
	FASSERT_BOUNDS(0, GC.getNumUnitRoleInfos(), eIndex, "CvPlayer::getUnitRoleCount");
	return m_paiUnitRoleCount[eIndex];
}

void CvPlayer::changeUnitRoleCount(UnitRoleTypes eIndex, int iChange)
{
	FASSERT_BOUNDS(0, GC.getNumUnitRoleInfos(), eIndex, "CvPlayer::changeUnitRoleCount");
	m_paiUnitRoleCount[eIndex] = (m_paiUnitRoleCount[eIndex] + iChange);
	FAssert(getUnitRoleCount(eIndex) >= 0);
}

int CvPlayer::getUnitRoleMaking(UnitRoleTypes eIndex) const
{
	FASSERT_BOUNDS(0, GC.getNumUnitRoleInfos(), eIndex, "CvPlayer::getUnitRoleMaking");
	return m_paiUnitRoleMaking[eIndex];
}


void CvPlayer::changeUnitRoleMaking(UnitRoleTypes eIndex, int iChange)
{
	FASSERT_BOUNDS(0, GC.getNumUnitRoleInfos(), eIndex, "CvPlayer::changeUnitRoleMaking");

	if (iChange != 0)
	{
		m_paiUnitRoleMaking[eIndex] = (m_paiUnitRoleMaking[eIndex] + iChange);
		FAssert(getUnitRoleMaking(eIndex) >= 0);
...
int CvPlayer::getUnitRoleCountPlusMaking(UnitRoleTypes eIndex) const
{
	return (getUnitRoleCount(eIndex) + getUnitRoleMaking(eIndex));
}
// MOD - END - Unit Roles
...
// MOD - START - Player Build Caching
int CvPlayer::getBuilderCount(BuildTypes eBuild) const
{
	FASSERT_BOUNDS(0, GC.getNumBuildInfos(), eBuild, "CvPlayer::getBuilderCount");
	return m_paiBuilderCount[eBuild];
}


void CvPlayer::changeBuilderCount(BuildTypes eBuild, int iChange)
{
	FASSERT_BOUNDS(0, GC.getNumBuildInfos(), eBuild, "CvPlayer::changeBuilderCount");

	bool bHadBuilder = getBuilderCount(eBuild) > 0;

	m_paiBuilderCount[eBuild] = (m_paiBuilderCount[eBuild] + iChange);
	FAssert(getBuilderCount(eBuild) >= 0);

	bool bHasBuilder = getBuilderCount(eBuild) > 0;

	if (bHadBuilder != bHasBuilder)
	{
		updateBuildCache(eBuild);
	}
}
// MOD - END - Player Build Caching
...
// MOD - START - Holy City Migration
bool CvPlayer::canAcquireHolyCity(ReligionTypes eReligion) const
{
	FASSERT_BOUNDS(0, GC.getNumReligionInfos(), eReligion, "CvPlayer::canAcquireHolyCity");
	...
	if (canAcquireHolyCityWithoutStateReligion())
	{
		return true;
	}
...
bool CvPlayer::canMaintainHolyCity(ReligionTypes eReligion) const
{
	FASSERT_BOUNDS(0, GC.getNumReligionInfos(), eReligion, "CvPlayer::canMaintainHolyCity");
	...
	if (canMaintainHolyCityWithoutStateReligion())
	{
		return true;
	}
...
int CvPlayer::getHolyCityInfluence(ReligionTypes eReligion) const
{
	FASSERT_BOUNDS(0, GC.getNumReligionInfos(), eReligion, "CvPlayer::getHolyCityInfluence");
	return m_paiHolyCityInfluence[eReligion];
}


void CvPlayer::setHolyCityInfluence(ReligionTypes eReligion, int iNewValue)
{
	FASSERT_BOUNDS(0, GC.getNumReligionInfos(), eReligion, "CvPlayer::setHolyCityInfluence");
	m_paiHolyCityInfluence[eReligion] = iNewValue;
	FAssert(getHolyCityInfluence(eReligion) >= 0);
}


void CvPlayer::changeHolyCityInfluence(ReligionTypes eReligion, int iChange)
{
	FASSERT_BOUNDS(0, GC.getNumReligionInfos(), eReligion, "CvPlayer::changeHolyCityInfluence");
	setHolyCityInfluence(eReligion, getHolyCityInfluence(eReligion) + iChange);
}


void CvPlayer::updateHolyCityInfluence()
{
	for (int iReligion = 0; iReligion < GC.getNumReligionInfos(); iReligion++)
	{
		updateHolyCityInfluence((ReligionTypes)iReligion);
	}
}

void CvPlayer::updateHolyCityInfluence(ReligionTypes eReligion)
{
	if (!GC.getGameINLINE().isReligionFounded(eReligion))
	{
		return;
	...
	// Start with the previous influence value
	int iOldValue = getHolyCityInfluence(eReligion);
	int iNewValue = iOldValue;

	// Apply decay
	iNewValue *= 10000 - getHolyCityInfluenceDecayRate(eReligion);
	iNewValue /= 10000;

	// Apply growth
	iNewValue += getHolyCityInfluenceGrowthRate(eReligion);

	// Update value
	setHolyCityInfluence(eReligion, iNewValue);
	...
	if (GC.getLogging())
	{
		if (gDLL->getChtLvl() > 0)
		{
			...
			{
				int iGrowth = getHolyCityInfluenceGrowthRate(eReligion);
				int iDecayRate = getHolyCityInfluenceDecayRate(eReligion);
				TCHAR szOut[1024];
				sprintf(szOut, "Turn %d Player %d %s Holy City Influence (Old: %d, New: %d, Change: %d, Decay Rate: %d.%02d, Growth: %d, Has HC: %s, Has HC Candidate: %s)\n", GC.getGameINLINE().getGameTurn(), getID(), CvString(GC.getReligionInfo(eReligion).getDescription()).GetCString(), iOldValue, iNewValue, iNewValue - iOldValue, iDecayRate / 100, iDecayRate % 100, iGrowth, hasHolyCity(eReligion) ? "Y" : "N", hasBestHolyCityCandidate(eReligion) ? "Y" : "N");
				gDLL->messageControlLog(szOut);
			}
		}
	}
...
// Growth rate is applied as a linear growth function
int CvPlayer::getHolyCityInfluenceGrowthRate(ReligionTypes eReligion) const
{
	int iGrowth = 0;

	if ((hasHolyCity(eReligion) && canMaintainHolyCity(eReligion)) || ((GC.getGameINLINE().getHolyCity(eReligion) == NULL) && canAcquireHolyCity(eReligion)))
	{
		iGrowth += getReligionPopulation(eReligion);

		if (hasHolyCity(eReligion))
		{
			// Having the holy city amplifies the value of total population
			iGrowth *= 3;
			iGrowth /= 2;

			// Having the holy city is the equivalent of 50 population
			iGrowth += 50;
		}
		else if (hasBestHolyCityCandidate(eReligion))
		{
			CvCity* pCity = getHolyCityCandidate(eReligion);
			if (pCity != NULL)
			{
				// Having the best candidate is worth the same as 20 population
				iGrowth += 20;

				// It's population is also more valuable
				iGrowth += getHolyCityCandidate(eReligion)->getPopulation() * 5;
			}
		}

		if (getStateReligion() == eReligion)
		{
			// Running the state religion is always a little better than just running free religion
			iGrowth *= 3;
			iGrowth /= 2;
		}
	}
	else if (hasHolyCity(eReligion) && GC.getGameINLINE().getNumHolyCityCandidates(eReligion, getID()) == 0)
	{
		// Simply having possession of a holy city without any rivals yields
		// a base level of influence. Otherwise holy cities would migrate even
		// when they have nowhere to go.
		iGrowth += 25;
	}

	// Game speed adjustements
	iGrowth *= GC.getGameSpeedInfo(GC.getGameINLINE().getGameSpeedType()).getHolyCityInfluenceRate();
	iGrowth /= 100;

	// Growth Dampening (makes it so that 5 population = 1 point of growth)
	iGrowth /= 5;
...
// Decay rate is applied as an expenonential decay function; value is in hundredths of percent
int CvPlayer::getHolyCityInfluenceDecayRate(ReligionTypes eReligion) const
{
	// Base decay rate is 3% per turn
	int iDecayRate = 300; // TODO: Move this to a gobal DEFINE

	// The decay rate is adjusted significantly depending on the circumstances
	if (hasHolyCity(eReligion))
	{
		if (GC.getGameINLINE().getNumHolyCityCandidates(eReligion, getID()) == 0)
		{
			// Holy city without any competition decays at 1/4 rate
			iDecayRate /= 4;
		}
		else if (canMaintainHolyCity(eReligion))
		{
			// Holy city with competition decays at 1/2 rate as long as the player is able to maintain it
			iDecayRate /= 2;
		}
	}

	// Game speed adjustements
	iDecayRate *= GC.getGameSpeedInfo(GC.getGameINLINE().getGameSpeedType()).getHolyCityInfluenceRate();
	iDecayRate /= 100;
...
// Note: This function assumes no growth
int CvPlayer::getHolyCityLossTurnsRemaining(ReligionTypes eReligion) const
{
	float fValue = (float)getHolyCityInfluence(eReligion);
	float fThreshold = (float)GC.getGameINLINE().getHolyCityLossThreshold();
	float fDecayFactor = 1.0f - ((float)getHolyCityInfluenceDecayRate(eReligion) * 0.0001f);

	float fTurns = logf(fThreshold / fValue) / logf(fDecayFactor);

	return (int)ceilf(fTurns);
}


CvCity* CvPlayer::getHolyCityCandidate(ReligionTypes eReligion) const
{
	FASSERT_BOUNDS(0, GC.getNumReligionInfos(), eReligion, "CvPlayer::getHolyCityCandidate");
	return getCity(m_paiHolyCityCandidate[eReligion]);
}


void CvPlayer::setHolyCityCandidate(ReligionTypes eReligion, CvCity* pNewValue)
{
	FASSERT_BOUNDS(0, GC.getNumReligionInfos(), eReligion, "CvPlayer::setHolyCityCandidate");
	FAssert(pNewValue == NULL || pNewValue->getOwnerINLINE() == getID());

	CvCity* pOldValue = getHolyCityCandidate(eReligion);

	if (pOldValue != pNewValue)
	{
		if (pNewValue != NULL)
		{
			m_paiHolyCityCandidate[eReligion] = pNewValue->getID();
		}
		else
		{
			m_paiHolyCityCandidate[eReligion] = FFreeList::INVALID_INDEX;
		}

		CvCity* pBestCandidate = GC.getGameINLINE().getBestHolyCityCandidate(eReligion);
		...
		if (pBestCandidate == NULL)
		{
			if (pNewValue != NULL)
			{
				...
				GC.getGameINLINE().setBestHolyCityCandidate(eReligion, pNewValue);
			}
		}
		else
		{
			if (pBestCandidate == pOldValue)
			{
				// The old value was the best candidate, search for a new one
				GC.getGameINLINE().updateBestHolyCityCandidate(eReligion);
			}
			else if (pNewValue != NULL)
			{
				// Test the new value to see whether it's better than the best candidate
				if (pNewValue->getHolyCityCandidateValue(eReligion) > pBestCandidate->getHolyCityCandidateValue(eReligion))
				{
					GC.getGameINLINE().setBestHolyCityCandidate(eReligion, pNewValue);
				}
			}
...
void CvPlayer::updateHolyCityCandidate()
{
	for (int iReligion = 0; iReligion < GC.getNumReligionInfos(); iReligion++)
	{
		updateHolyCityCandidate((ReligionTypes)iReligion);
	}
}


void CvPlayer::updateHolyCityCandidate(ReligionTypes eReligion, CvCity* pIgnoreCity)
{
	FASSERT_BOUNDS(0, GC.getNumReligionInfos(), eReligion, "CvPlayer::updateHolyCityCandidate");

	CvCity* pBestCity = NULL;
	int iBestCityValue = -1;
	int iLoop;
	for (CvCity* pLoopCity = firstCity(&iLoop); NULL != pLoopCity; pLoopCity = nextCity(&iLoop))
	{
		if ((pLoopCity != pIgnoreCity) && pLoopCity->isHasReligion(eReligion))
		{
			int iValue = pLoopCity->getHolyCityCandidateValue(eReligion);
			const int iMinCandidateValue = 4; // TODO: Move to global DEFINE
			if ((iValue > iMinCandidateValue) && (iValue > iBestCityValue))
			{
	...
	setHolyCityCandidate(eReligion, pBestCity);
}
// MOD - END - Holy City Migration
...
int CvPlayer::getSpecialistYieldChange(SpecialistTypes eSpecialist, YieldTypes eYield) const
{
	FASSERT_BOUNDS(0, GC.getNumSpecialistInfos(), eSpecialist, "CvPlayer::getSpecialistYieldChange");
	FASSERT_BOUNDS(0, NUM_YIELD_TYPES, eYield, "CvPlayer::getSpecialistYieldChange");
	return m_ppaaiSpecialistExtraYield[eSpecialist][eYield];
}


void CvPlayer::changeSpecialistYieldChange(SpecialistTypes eSpecialist, YieldTypes eYield, int iChange)
{
	FASSERT_BOUNDS(0, GC.getNumSpecialistInfos(), eSpecialist, "CvPlayer::changeSpecialistYieldChange");
	FASSERT_BOUNDS(0, NUM_YIELD_TYPES, eYield, "CvPlayer::changeSpecialistYieldChange");

	if (iChange != 0)
	{
		m_ppaaiSpecialistExtraYield[eSpecialist][eYield] = (m_ppaaiSpecialistExtraYield[eSpecialist][eYield] + iChange);
		//FAssert(getSpecialistYieldChange(eSpecialist, eYield) >= 0);
...
void CvPlayer::setBuildingYieldChange(BuildingClassTypes eBuildingClass, YieldTypes eYield, int iChange)
{
	for (std::vector<BuildingYieldChange>::iterator it = m_aBuildingYieldChange.begin(); it != m_aBuildingYieldChange.end(); ++it)
	{
		if ((*it).eBuildingClass == eBuildingClass && (*it).eYield == eYield)
		{
			...
			if (iOldChange != iChange)
			{
				...
				applyBuildingYieldChange(eBuildingClass, eYield, iChange - iOldChange);
			}
	...
	if (0 != iChange)
	{
		...
		applyBuildingYieldChange(eBuildingClass, eYield, iChange);
	}
}
...
int CvPlayer::getBuildingCommerceChange(BuildingClassTypes eBuildingClass, CommerceTypes eCommerce) const
{
...
void CvPlayer::setBuildingCommerceChange(BuildingClassTypes eBuildingClass, CommerceTypes eCommerce, int iChange)
{
...
void CvPlayer::changeBuildingCommerceChange(BuildingClassTypes eBuildingClass, CommerceTypes eCommerce, int iChange)
{
...
// Note: Old findPathLength method deleted
int CvPlayer::getTechPathLength(TechTypes eTech) const
{
	if (isResearchingTech(eTech))
	{
		return 0;
	}

	return GET_TEAM(getTeam()).getTechPathLength(eTech);
}

int CvPlayer::getTechPathCost(TechTypes eTech) const
{
	if (isResearchingTech(eTech))
	{
		return 0;
	...
	return GET_TEAM(getTeam()).getTechPathCost(eTech);
}
	...
	for (i = 0; i < GC.getNUM_OR_TECH_PREREQS(); i++)
	{
		...
		if (ePreReq != NO_TECH)
		{
			...
			if (canEverResearch(ePreReq))
			{
				...
				iNumSteps = getTechPathLength(ePreReq);
				// MOD - END - Tech Path Caching
...
// MOD - START - City Name Preservation
void CvPlayer::setPlotCityName(CvPlot* pPlot, CvWString szCityName)
{
	if (szCityName.empty())
	{
		erasePlotCityName(pPlot);
	}
	else
	{
		XYCoords xy = XYCoords(pPlot->getX_INLINE(), pPlot->getY_INLINE());
		m_plotCityNames[xy] = szCityName;
	}
}

void CvPlayer::erasePlotCityName(CvPlot* pPlot)
{
	XYCoords xy = XYCoords(pPlot->getX_INLINE(), pPlot->getY_INLINE());
	m_plotCityNames.erase(xy);
}

CvWString CvPlayer::getPlotCityName(CvPlot* pPlot) const
{
	XYCoords xy = XYCoords(pPlot->getX_INLINE(), pPlot->getY_INLINE());
	std::map<XYCoords, CvWString>::const_iterator it = m_plotCityNames.find(xy);
	if (it == m_plotCityNames.end())
	{
		return "";
	}
	else
...
void CvPlayer::doGold()
{
	...
	// MOD - START - Negative AI Gold
	// 2018-01-16 (JDS): The AI is permitted to have a strike if it's broke, but verify that its gold rate is 100%
	//FAssert(isHuman() || isBarbarian() || ((getGold() + iGoldChange) >= 0) || isAnarchy());
	FAssert(isHuman() || isBarbarian() || ((getGold() + iGoldChange) >= 0) || (getCommercePercent(COMMERCE_GOLD) == 100) || isAnarchy());
	// MOD - END - Negative AI Gold
...
int CvPlayer::getAdvancedStartBuildingCost(BuildingTypes eBuilding, bool bAdd, CvCity* pCity) const
{
	...
	if (NULL != pCity)
	{
		...
		else
		{
			...
			for (int iRel = 0; iRel < kBuilding.getNumRelatedBuildingClasses(); iRel++)
			{
				BuildingClassTypes eRelatedBuildingClass = (BuildingClassTypes)kBuilding.getRelatedBuildingClasses(iRel);
				BuildingTypes eRelatedBuilding = (BuildingTypes)(kCivilization.getCivilizationBuildings(eRelatedBuildingClass));

				if (eRelatedBuilding != NO_BUILDING)
				{
					if (pCity->getNumBuilding(eRelatedBuilding) > 0)
					{
						// Loop through present Building's requirements
						// MOD - START - Advanced Building Prerequisites
						const CvBuildingInfo& kRelatedBuilding = GC.getBuildingInfo(eRelatedBuilding);
...
int CvPlayer::getAdvancedStartImprovementCost(ImprovementTypes eImprovement, bool bAdd, CvPlot* pPlot) const
{
	...
	// MOD - START - Unique Improvements
	if (!GC.getCivilizationInfo(getCivilizationType()).canProduceImprovement(eImprovement))
	{
		return -1;
	}
	// MOD - END - Unique Improvements
...
int CvPlayer::getAdvancedStartTechCost(TechTypes eTech, bool bAdd) const
{
	...
	else if (!bAdd)
	{
		...
		for (pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
		{
			...
			{
				BuildingTypes eLoopBuilding = (BuildingTypes) iBuildingLoop;
				...
				if (pLoopPlot->isVisible(getTeam(), false))
				{
					...
					if (pUnit != NULL)
					{
						if (!pUnit->isAnimal())
						{
							...
							{	
                                #if defined(__GNUC__)
                                wprintf(szBuffer, gDLL->getText("TXT_KEY_MISC_ENEMY_TROOPS_SPOTTED", pNearestCity->getNameKey()).GetCString());
                                #else
...
void CvPlayer::processCivics(CivicTypes eCivic, int iChange)
{
	...
	// MOD - START - Epidemics
	// Epidemic system by Mexico
	changeGlobalEpidemicModifier(kCivic.getGlobalEpidemicModifier() * iChange);
	// MOD - END - Epidemics
	...
	// MOD - START - Holy City Migration
	changeCanAcquireHolyCityWithoutStateReligionCount((kCivic.isCanAcquireHolyCityWithoutStateReligion()) ? iChange : 0);
	changeCanMaintainHolyCityWithoutStateReligionCount((kCivic.isCanMaintainHolyCityWithoutStateReligion()) ? iChange : 0);
	// MOD - END - Holy City Migration
	...
	// MOD - START - Congestion
	changeInsideCityCongestionThreshold(kCivic.getInsideCityCongestionThresholdChange());
	changeOutsideCityCongestionThreshold(kCivic.getOutsideCityCongestionThresholdChange());
	// MOD - END - Congestion
	...
	for (int iI = 0; iI < NUM_COMMERCE_TYPES; iI++)
	{
		...
		changeAllSpecialistCommerceChange(((CommerceTypes)iI), (kCivic.getAllSpecialistCommerce(iI) * iChange));
		// MOD - END - Advanced Yield and Commerce Effects
	}
	...
	for (int iRel = 0; iRel < kCivic.getNumRelatedBuildingClasses(); iRel++)
	{
		...
		if (eLoopBuilding != NO_BUILDING)
		{
			...
			changeExtraBuildingHappiness(eLoopBuilding, (kCivic.getBuildingHappinessChanges(eLoopBuildingClass) * iChange));
			changeExtraBuildingHealth(eLoopBuilding, (kCivic.getBuildingHealthChanges(eLoopBuildingClass) * iChange));

			// MOD - START - Advanced Building Prerequisites (Civic)
			if (kLoopBuilding.isPrereqCivic(eCivic))
			{
				if (kLoopBuilding.isInactiveWithoutCivicPrereqs() && getBuildingClassCount(eLoopBuildingClass) > 0)
				{
					CvCity* pLoopCity;
					int iLoop;
					for (pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
	...
	for (int iRel = 0; iRel < kCivic.getNumRelatedFeatures(); iRel++)
	{
		FeatureTypes eLoopFeature = (FeatureTypes)kCivic.getRelatedFeatures(iRel);
		changeFeatureHappiness(eLoopFeature, (kCivic.getFeatureHappinessChanges(eLoopFeature) * iChange));
	}
	// MOD - END - Relation Caching
	...
	// MOD - START - Relation Caching
	for (int iRel = 0; iRel < kCivic.getNumRelatedSpecialists(); iRel++)
	{
		SpecialistTypes eLoopSpecialist = (SpecialistTypes)kCivic.getRelatedSpecialists(iRel);
		changeSpecialistValidCount(eLoopSpecialist, (kCivic.isSpecialistValid(eLoopSpecialist) ? iChange : 0));
	}
	// MOD - END - Relation Caching

	// MOD - START - Advanced Yield and Commerce Effects
	for (int iI = 0; iI < kCivic.getNumImprovementYieldChanges(); iI++)
	{
		ImprovementTypes eLoopImprovement = (ImprovementTypes)kCivic.getImprovementYieldChangeImprovement(iI);
		YieldTypes eLoopYield = (YieldTypes)kCivic.getImprovementYieldChangeYield(iI);
		int iValue = kCivic.getImprovementYieldChangeValue(iI);
		changeImprovementYieldChange(eLoopImprovement, eLoopYield, iValue * iChange);
	}

	for (int iI = 0; iI < kCivic.getNumSpecialistYieldChanges(); iI++)
	{
		SpecialistTypes eLoopSpecialist = (SpecialistTypes)kCivic.getSpecialistYieldChangeSpecialist(iI);
		YieldTypes eLoopYield = (YieldTypes)kCivic.getSpecialistYieldChangeYield(iI);
		int iValue = kCivic.getSpecialistYieldChangeValue(iI);
		changeSpecialistYieldChange(eLoopSpecialist, eLoopYield, iValue * iChange);
	}

	for (int iI = 0; iI < kCivic.getNumSpecialistCommerceChanges(); iI++)
	{
		SpecialistTypes eLoopSpecialist = (SpecialistTypes)kCivic.getSpecialistCommerceChangeSpecialist(iI);
		CommerceTypes eLoopCommerce = (CommerceTypes)kCivic.getSpecialistCommerceChangeCommerce(iI);
		int iValue = kCivic.getSpecialistCommerceChangeValue(iI);
		changeSpecialistCommerceChange(eLoopSpecialist, eLoopCommerce, iValue * iChange);
	}
	// MOD - END - Advanced Yield and Commerce Effects
}
...
void CvPlayer::read(FDataStreamBase* pStream)
{
	...
	// MOD - START - Epidemics
	// Epidemic system by Mexico
	pStream->Read(&m_iAcceptableEpidemicPercent);
	pStream->Read(&m_iGlobalEpidemicModifier);
	// MOD - END - Epidemics
	...
	// MOD - START - Unlimited Conscription
	pStream->Read(&m_iUnlimitedConscriptCount);
	// MOD - END - Unlimited Conscription
	// MOD - START - Wartime Conscription
	...
	// MOD - START - Holy City Migration
	pStream->Read(&m_iCanAcquireHolyCityWithoutStateReligionCount);
	pStream->Read(&m_iCanMaintainHolyCityWithoutStateReligionCount);
	// MOD - END - Holy City Migration
	...
	// MOD - START - Handicap Score Modifier
	pStream->Read(&m_iHandicapScoreModifier);
	// MOD - END - Handicap Score Modifier
...
/*************************************************************************************************/
	...
	pStream->Read(&m_iRevModifier);
	pStream->Read(&m_iRevModifierScore);
	pStream->Read(&m_iRevModifierPower);
	pStream->Read(&m_iRevModifierEoH);
	pStream->Read(&m_iRevModifierWE);
	
/*************************************************************************************************/
/** REVOLUTION_MOD                          END                                                  */
/*************************************************************************************************/

	pStream->Read(&m_iSlaveAfrican);
	pStream->Read(&m_iSlaveAsian);
	pStream->Read(&m_iSlaveEuropean);
	pStream->Read(&m_iSlaveIndian);
	pStream->Read(&m_iSlaveMid);
	pStream->Read(&m_iSlaveNewworld);
	pStream->Read(&m_iSlaveSlavic);
	
	// MOD - START - City Messages
	pStream->Read(&m_bCityMessagesDirty);
	// MOD - END - City Messages
	pStream->Read(&m_iChoosingFreeTechCount); // K-Mod
	...
	// MOD - START - Open Borders Commerce
	pStream->Read(NUM_COMMERCE_TYPES, m_aiBaseOpenBordersFreeCityCommerce);
	pStream->Read(NUM_COMMERCE_TYPES, m_aiAdditionalOpenBordersFreeCityCommerce);
	pStream->Read(NUM_COMMERCE_TYPES, m_aiTotalOpenBordersFreeCityCommerce);
	// MOD - END - Open Borders Commerce
	// MOD - START - Tech Transfer Commerce
	/*
	pStream->Read(NUM_COMMERCE_TYPES, m_aiBaseTechTransferFreeCityCommerce);
	pStream->Read(NUM_COMMERCE_TYPES, m_aiAdditionalTechTransferFreeCityCommerce);
	pStream->Read(NUM_COMMERCE_TYPES, m_aiTotalTechTransferFreeCityCommerce);
	*/
	// MOD - END - Tech Transfer Commerce
	...
	// MOD - START - Open Borders Commerce
	pStream->Read(NUM_COMMERCE_TYPES, m_aiBaseOpenBordersCommerceRateModifier);
	pStream->Read(NUM_COMMERCE_TYPES, m_aiAdditionalOpenBordersCommerceRateModifier);
	pStream->Read(NUM_COMMERCE_TYPES, m_aiTotalOpenBordersCommerceRateModifier);
	// MOD - END - Open Borders Commerce
	// MOD - START - Tech Transfer Commerce
	pStream->Read(NUM_COMMERCE_TYPES, m_aiBaseTechTransferCommerceRateModifier);
	pStream->Read(NUM_COMMERCE_TYPES, m_aiAdditionalTechTransferCommerceRateModifier);
	//pStream->Read(NUM_COMMERCE_TYPES, m_aiTotalTechTransferCommerceRateModifier);
	// MOD - END - Tech Transfer Commerce
	...
	pStream->Read(NUM_COMMERCE_TYPES, m_aiAllSpecialistCommerceChanges);
	// MOD - END - Advanced Yield and Commerce Effects
	...
	// MOD - START - Unit Roles
	pStream->Read(GC.getNumUnitRoleInfos(), m_paiUnitRoleCostModifier);
	pStream->Read(GC.getNumUnitRoleInfos(), m_paiUnitRoleCount);
	pStream->Read(GC.getNumUnitRoleInfos(), m_paiUnitRoleMaking);
	// MOD - END - Unit Roles
	pStream->Read(GC.getNumUnitClassInfos(), m_paiUnitClassCount);
	pStream->Read(GC.getNumUnitClassInfos(), m_paiUnitClassMaking);
	// MOD - START - Player Build Caching
	pStream->Read(GC.getNumBuildInfos(), m_paiBuilderCount);
	// MOD - END - Player Build Caching
	...
	// MOD - START - Holy City Migration
	pStream->Read(GC.getNumReligionInfos(), m_paiHolyCityInfluence);
	pStream->Read(GC.getNumReligionInfos(), m_paiHolyCityCandidate);
	// MOD - END - Holy City Migration
	...
	// MOD - START - Religion Affected Bonuses
	pStream->Read(GC.getNumBonusInfos(), m_pabReligionNoBonusHealthiness);
	pStream->Read(GC.getNumBonusInfos(), m_pabReligionNoBonusHappiness);
	// MOD - END - Religion Affected Bonuses
	...
	// MOD - START - Player Build Caching
	pStream->Read(GC.getNumBuildInfos(), m_pabBuildCache);
	// MOD - END - Player Build Caching
	...
	for (iI=0;iI<GC.getNumSpecialistInfos();iI++)
	{
		pStream->Read(NUM_COMMERCE_TYPES, m_ppaaiSpecialistExtraCommerce[iI]);
	}
	// MOD - END - Advanced Yield and Commerce Effects
...

	{
		...
		pStream->Read(&iNumElts);
		m_aBuildingCommerceChange.clear();
		m_aBuildingCommerceChange.reserve(iNumElts);
		for (int i = 0; i < iNumElts; ++i)
		{
			BuildingCommerceChange kChange;
			kChange.read(pStream);
	...
	// MOD - START - City Name Preservation
	{
		...
		for (uint i = 0; i < iSize; i++)
		{
			...
			pStream->Read(&iX);
			pStream->Read(&iY);
			pStream->ReadString(szCityName);
			m_plotCityNames[XYCoords(iX, iY)] = szCityName;
		}
	}
	// MOD - END - City Name Preservation
	...
	// MOD - START - Trait Trade Modifier
	pStream->Read(&m_iTradeRouteIncomeModifier);
	pStream->Read(&m_iForeignTradeRouteIncomeModifier);
	// MOD - END - Trait Trade Modifier
	// MOD - START - Trait Upgrade Modifier
	pStream->Read(&m_iUpgradeDiscount);
	// MOD - END - Trait Upgrade Modifier
	// MOD - START - Congestion
	pStream->Read(&m_iInsideCityCongestionThreshold);
	pStream->Read(&m_iOutsideCityCongestionThreshold);
	// MOD - END - Congestion

	// MOD - START - Better Nukes
	pStream->Read(&m_iNukesUsed);
	// MOD - END - Better Nukes
}
...
void CvPlayer::write(FDataStreamBase* pStream)
{
	...
	// MOD - START - Epidemics
	// Epidemic system by Mexico
	pStream->Write(m_iAcceptableEpidemicPercent);
	pStream->Write(m_iGlobalEpidemicModifier);
	// MOD - END - Epidemics
	...
	// MOD - START - Unlimited Conscription
	pStream->Write(m_iUnlimitedConscriptCount);
	// MOD - END - Unlimited Conscription
	// MOD - START - Wartime Conscription
	...
	// MOD - START - Holy City Migration
	pStream->Write(m_iCanAcquireHolyCityWithoutStateReligionCount);
	pStream->Write(m_iCanMaintainHolyCityWithoutStateReligionCount);
	// MOD - END - Holy City Migration
	...
	// MOD - START - Handicap Score Modifier
	pStream->Write(m_iHandicapScoreModifier);
	// MOD - END - Handicap Score Modifier
...
/*************************************************************************************************/
	...
	pStream->Write(m_iRevModifier);
	pStream->Write(m_iRevModifierScore);
	pStream->Write(m_iRevModifierPower);
	pStream->Write(m_iRevModifierEoH);
	pStream->Write(m_iRevModifierWE);
	
/*************************************************************************************************/
/** REVOLUTION_MOD                          END                                                  */
/*************************************************************************************************/

	pStream->Write(m_iSlaveAfrican);
	pStream->Write(m_iSlaveAsian);
	pStream->Write(m_iSlaveEuropean);
	pStream->Write(m_iSlaveIndian);
	pStream->Write(m_iSlaveMid);
	pStream->Write(m_iSlaveNewworld);
	pStream->Write(m_iSlaveSlavic);
		
	// MOD - START - City Messages
	pStream->Write(m_bCityMessagesDirty);
	// MOD - END - City Messages
	...
	// MOD - START - Open Borders Commerce
	pStream->Write(NUM_COMMERCE_TYPES, m_aiBaseOpenBordersFreeCityCommerce);
	pStream->Write(NUM_COMMERCE_TYPES, m_aiAdditionalOpenBordersFreeCityCommerce);
	pStream->Write(NUM_COMMERCE_TYPES, m_aiTotalOpenBordersFreeCityCommerce);
	// MOD - END - Open Borders Commerce
	// MOD - START - Tech Transfer Commerce
	/*
	pStream->Write(NUM_COMMERCE_TYPES, m_aiBaseTechTransferFreeCityCommerce);
	pStream->Write(NUM_COMMERCE_TYPES, m_aiAdditionalTechTransferFreeCityCommerce);
	pStream->Write(NUM_COMMERCE_TYPES, m_aiTotalTechTransferFreeCityCommerce);
	*/
	// MOD - END - Tech Transfer Commerce
	...
	// MOD - START - Open Borders Commerce
	pStream->Write(NUM_COMMERCE_TYPES, m_aiBaseOpenBordersCommerceRateModifier);
	pStream->Write(NUM_COMMERCE_TYPES, m_aiAdditionalOpenBordersCommerceRateModifier);
	pStream->Write(NUM_COMMERCE_TYPES, m_aiTotalOpenBordersCommerceRateModifier);
	// MOD - END - Open Borders Commerce
	// MOD - START - Tech Transfer Commerce
	pStream->Write(NUM_COMMERCE_TYPES, m_aiBaseTechTransferCommerceRateModifier);
	pStream->Write(NUM_COMMERCE_TYPES, m_aiAdditionalTechTransferCommerceRateModifier);
	//pStream->Write(NUM_COMMERCE_TYPES, m_aiTotalTechTransferCommerceRateModifier);
	// MOD - END - Tech Transfer Commerce
	...
	pStream->Write(NUM_COMMERCE_TYPES, m_aiAllSpecialistCommerceChanges);
	// MOD - END - Advanced Yield and Commerce Effects
	...
	// MOD - START - Unit Roles
	pStream->Write(GC.getNumUnitRoleInfos(), m_paiUnitRoleCostModifier);
	pStream->Write(GC.getNumUnitRoleInfos(), m_paiUnitRoleCount);
	pStream->Write(GC.getNumUnitRoleInfos(), m_paiUnitRoleMaking);
	// MOD - END - Unit Roles
	pStream->Write(GC.getNumUnitClassInfos(), m_paiUnitClassCount);
	pStream->Write(GC.getNumUnitClassInfos(), m_paiUnitClassMaking);
	// MOD - START - Player Build Caching
	pStream->Write(GC.getNumBuildInfos(), m_paiBuilderCount);
	// MOD - END - Player Build Caching
	...
	// MOD - START - Holy City Migration
	pStream->Write(GC.getNumReligionInfos(), m_paiHolyCityInfluence);
	pStream->Write(GC.getNumReligionInfos(), m_paiHolyCityCandidate);
	// MOD - END - Holy City Migration
	...
	// MOD - START - Religion Affected Bonuses
	pStream->Write(GC.getNumBonusInfos(), m_pabReligionNoBonusHealthiness);
	pStream->Write(GC.getNumBonusInfos(), m_pabReligionNoBonusHappiness);
	// MOD - END - Religion Affected Bonuses
	...
	// MOD - START - Player Build Caching
	pStream->Write(GC.getNumBuildInfos(), m_pabBuildCache);
	// MOD - END - Player Build Caching
	...
	for (iI=0;iI<GC.getNumSpecialistInfos();iI++)
	{
		pStream->Write(NUM_COMMERCE_TYPES, m_ppaaiSpecialistExtraCommerce[iI]);
	}
	// MOD - END - Advanced Yield and Commerce Effects
	...
	// MOD - START - City Name Preservation
	{
		uint iSize = m_plotCityNames.size();
		pStream->Write(iSize);

		for (std::map<XYCoords,CvWString>::const_iterator it=m_plotCityNames.begin(); it!=m_plotCityNames.end(); ++it)
		{
			pStream->Write(it->first.iX);
			pStream->Write(it->first.iY);
	...
	// MOD - START - Trait Trade Modifier
	pStream->Write(m_iTradeRouteIncomeModifier);
	pStream->Write(m_iForeignTradeRouteIncomeModifier);
	// MOD - END - Trait Trade Modifier
	// MOD - START - Trait Upgrade Modifier
	pStream->Write(m_iUpgradeDiscount);
	// MOD - END - Trait Upgrade Modifier
	// MOD - START - Congestion
	pStream->Write(m_iInsideCityCongestionThreshold);
	pStream->Write(m_iOutsideCityCongestionThreshold);
	// MOD - END - Congestion

	// MOD - START - Better Nukes
	pStream->Write(m_iNukesUsed);
	// MOD - END - Better Nukes
}
...
void CvPlayer::updateMetricTurnValues()
{
	int iLoop;
	for (CvCity* pLoopCity = firstCity(&iLoop); pLoopCity != NULL; pLoopCity = nextCity(&iLoop))
	{
		pLoopCity->updateMetricTurnValues();
	}
}
...
int CvPlayer::getEventFood(EventTypes eEvent) const
{
	FASSERT_BOUNDS(0, GC.getNumEventInfos(), eEvent, "CvPlayer::getEventFoodPercent");
	...
	iFood *= GC.getEraInfo(getCurrentEra()).getGrowthPercent();
	iFood /= 100;

	// TODO: Scale by handicap?

	return iFood;
}

int CvPlayer::getEventFoodPercent(EventTypes eEvent) const
{
	FASSERT_BOUNDS(0, GC.getNumEventInfos(), eEvent, "CvPlayer::getEventFoodPercent");
...
bool CvPlayer::canDoEvent(EventTypes eEvent, const EventTriggeredData& kTriggeredData) const
{
	...
	{
		// MOD - START - Relation Caching
		for (int iPre = 0; iPre < kEvent.getNumDependentEventTriggers(); iPre++)
		{
			EventTriggerTypes eDependentEventTrigger = (EventTriggerTypes)kEvent.getDependentEventTriggers(iPre);

			CvEventTriggerInfo& kTrigger = GC.getEventTriggerInfo(eDependentEventTrigger);
			if (!kTrigger.isRecurring())
			{
				if (isTriggerFired(eDependentEventTrigger))
				{
					return false;
				}
			}
...
void CvPlayer::applyEvent(EventTypes eEvent, int iEventTriggeredId, bool bUpdateTrigger)
{
	...
	if (0 != kEvent.getTechPercent())
	{
		...
		if (eBestTech != NO_TECH)
		{
			...
			int iBeakers  = kTeam.changeResearchProgressPercent(eBestTech, kEvent.getTechPercent(), getID());

			if (iBeakers > 0)
			{
				// MOD - START - Cached Team Members
				for (int iMember = 0; iMember < kTeam.getNumLivingTeamMembers(); iMember++)
				{
					CvWString szBuffer = gDLL->getText("TXT_KEY_MISC_PROGRESS_TOWARDS_TECH", iBeakers, GC.getTechInfo(eBestTech).getTextKeyWide());
					gDLL->getInterfaceIFace()->addHumanMessage(kTeam.getLivingTeamMember(iMember), false, GC.getEVENT_MESSAGE_TIME(), szBuffer, NULL, MESSAGE_TYPE_MINOR_EVENT, NULL, (ColorTypes)GC.getInfoTypeForString("COLOR_TECH_TEXT"));
				}
...
/************************************************************************************************/
	...
	// MOD - START - Relation Caching
	for (int iRel = 0; iRel < kEvent.getNumRelatedEvents(); iRel++)
	{
		EventTypes eLoopEvent = (EventTypes)kEvent.getRelatedEvents(iRel);

		if (kEvent.getClearEventChance(eLoopEvent) > 0)
		{
			bClear = GC.getGameINLINE().getSorenRandNum(100, "Event Clear") < kEvent.getClearEventChance(eLoopEvent);
			if (bClear)
			{
				if (kEvent.isGlobal())
				{
					...
					{
						GET_PLAYER((PlayerTypes)j).resetEventOccured(eLoopEvent, j != getID());
					}
				}
	...
	if (!kEvent.isCityEffect() && !kEvent.isOtherPlayerCityEffect())
	{
		...
		{
			// MOD - START - Relation Caching
			for (int iRel = 0; iRel < kEvent.getNumRelatedBuildingClasses(); iRel++)
			{
				BuildingClassTypes eLoopBuildingClass = (BuildingClassTypes)kEvent.getRelatedBuildingClasses(iRel);
				for (int iYield = 0; iYield < NUM_YIELD_TYPES; iYield++)
				{
					int iYieldChange = kEvent.getBuildingYieldChange(eLoopBuildingClass, iYield);
					if (iYieldChange != 0)
					{
						int iLoop;
						for (CvCity* pLoopCity = firstCity(&iLoop); NULL != pLoopCity; pLoopCity = nextCity(&iLoop))
						{
							pLoopCity->changeBuildingYieldChange(eLoopBuildingClass, (YieldTypes)iYield, iYieldChange);
						}
					}
				}
			}
		...
		if (kEvent.getNumBuildingCommerceChanges() > 0)
		{
			...
			for (int iRel = 0; iRel < kEvent.getNumRelatedBuildingClasses(); iRel++)
			{
				...
				for (int iCommerce = 0; iCommerce < NUM_COMMERCE_TYPES; iCommerce++)
				{
					int iCommerceChange = kEvent.getBuildingCommerceChange(eLoopBuildingClass, iCommerce);
					if (iCommerceChange != 0)
					{
						int iLoop;
						for (CvCity* pLoopCity = firstCity(&iLoop); NULL != pLoopCity; pLoopCity = nextCity(&iLoop))
						{
							pLoopCity->changeBuildingCommerceChange(eLoopBuildingClass, (CommerceTypes)iCommerce, iCommerceChange);
						}
					}
				}
			}
		...
		if (kEvent.getNumBuildingHappyChanges() > 0)
		{
			...
			for (int iRel = 0; iRel < kEvent.getNumRelatedBuildingClasses(); iRel++)
			{
				...
				if (0 != kEvent.getBuildingHappyChange(eLoopBuildingClass))
				{
					...
					if (eBuilding != NO_BUILDING)
					{
						changeExtraBuildingHappiness(eBuilding, kEvent.getBuildingHappyChange(eLoopBuildingClass));
					}
				}
			}
			// MOD - END - Relation Caching
		...
		if (kEvent.getNumBuildingHealthChanges() > 0)
		{
			...
			for (int iRel = 0; iRel < kEvent.getNumRelatedBuildingClasses(); iRel++)
			{
				...
				if (kEvent.getBuildingHealthChange(eLoopBuildingClass) != 0)
				{
					BuildingTypes eBuilding = (BuildingTypes)GC.getCivilizationInfo(getCivilizationType()).getCivilizationBuildings(eLoopBuildingClass);
					if (eBuilding != NO_BUILDING)
					{
						changeExtraBuildingHealth(eBuilding, kEvent.getBuildingHealthChange(eLoopBuildingClass));
					}
				}
			}
			// MOD - END - Relation Caching
		...
		if (kEvent.getFoodPercent() != 0)
		{
			...
			// MOD - START - Game Speed Event Scaling
			int iFoodPercent = getEventFoodPercent(eEvent);

			for (CvCity* pLoopCity = firstCity(&iLoop); NULL != pLoopCity; pLoopCity = nextCity(&iLoop))
			{
				pLoopCity->changeFood((pLoopCity->getFood() * iFoodPercent) / 100);
			}
			// MOD - END - Game Speed Event Scaling
		}
	...
	// MOD - START - Relation Caching
	for (int iRel = 0; iRel < kEvent.getNumRelatedUnitCombats(); iRel++)
	{
		UnitCombatTypes eLoopUnitCombat = (UnitCombatTypes)kEvent.getRelatedUnitCombats(iRel);
		if (kEvent.getUnitCombatPromotion(eLoopUnitCombat) != NO_PROMOTION)
		{
			...
			for (CvUnit* pLoopUnit = firstUnit(&iLoop); NULL != pLoopUnit; pLoopUnit = nextUnit(&iLoop))
			{
				...
				{
					pLoopUnit->setHasPromotion((PromotionTypes)kEvent.getUnitCombatPromotion(eLoopUnitCombat), true);
				}
			}

			setFreePromotion(eLoopUnitCombat, (PromotionTypes)kEvent.getUnitCombatPromotion(eLoopUnitCombat), true);
		}
	}

	for (int iRel = 0; iRel < kEvent.getNumRelatedUnitClasses(); iRel++)
	{
		UnitClassTypes eLoopUnitClass = (UnitClassTypes)kEvent.getRelatedUnitClasses(iRel);
		if (kEvent.getUnitClassPromotion(eLoopUnitClass) != NO_PROMOTION)
		{
			...
			for (CvUnit* pLoopUnit = firstUnit(&iLoop); NULL != pLoopUnit; pLoopUnit = nextUnit(&iLoop))
			{
				...
				{
					pLoopUnit->setHasPromotion((PromotionTypes)kEvent.getUnitClassPromotion(eLoopUnitClass), true);
				}
			}

			setFreePromotion(eLoopUnitClass, (PromotionTypes)kEvent.getUnitClassPromotion(eLoopUnitClass), true);
		}
	}
	// MOD - END - Relation Caching
	...
	for (int iRel = 0; iRel < kEvent.getNumRelatedEvents(); iRel++)
	{
		...
		if (0 == kEvent.getAdditionalEventTime(eLoopEvent))
		{
			if (kEvent.getAdditionalEventChance(eLoopEvent) > 0)
			{
				if (canDoEvent(eLoopEvent, *pTriggeredData))
				{
					if (GC.getGameINLINE().getSorenRandNum(100, "Additional Event") < kEvent.getAdditionalEventChance(eLoopEvent))
					{
		...
		else
		{
			...
			if (kEvent.getAdditionalEventChance(eLoopEvent) > 0)
			{
				if (GC.getGameINLINE().getSorenRandNum(100, "Additional Event 2") >= kEvent.getAdditionalEventChance(eLoopEvent))
				{
					bSetTimer = false;
				}
			}
			...
			if (bSetTimer)
			{
				...
				kTriggered.m_iTurn = (GC.getGameSpeedInfo(GC.getGameINLINE().getGameSpeedType()).getGrowthPercent() * kEvent.getAdditionalEventTime(eLoopEvent)) / 100 + GC.getGameINLINE().getGameTurn();

				const EventTriggeredData* pExistingTriggered = getEventCountdown(eLoopEvent);
...
int CvPlayer::getEventCost(EventTypes eEvent, PlayerTypes eOtherPlayer, bool bRandom) const
{
	...
	iGold *= std::max(0, getInflationRate() + 100); // K-Mod
	iGold /= 100;
	...
	for (int i = 0; i < GC.getNumCivilizationInfos(); ++i)
	{
		...
		if (bValid)
		{
			...
			*/
			...
			if (!GC.getCivilizationInfo((CivilizationTypes)i).isDerivative())
			{
			    bValid = false;
			}
	...
	if (!bPlayerExists)
	{
		...
		if (getSplitEmpireLeaders(aLeaders))
		{
			...
			for (it = aLeaders.begin(); it != aLeaders.end(); ++it)
			{
				...
				*/
				for (int i = 0; i < kCivilization.getNumDerivativeCivs(); i++)
				{
					CvDerivativeCivData kDerivativeCiv = kCivilization.getDerivativeCiv(i);
					if (kDerivativeCiv.m_eCivilization == it->first)
					{
						if (kDerivativeCiv.m_eMinEra <= getCurrentEra())
						{
		...
		if (pLoopPlot->isRevealed(getTeam(), true))
		{
			...
			if (eCurType != NO_BONUS)
			{
				...
				case SHOW_STRATEGIC_RESOURCES:
					...
					bOfInterest = (kBonusInfo.getBonusCategory() == 1);
				...
				case SHOW_HAPPY_RESOURCES:
					// MOD - START - Bonus Category for Globe View
					bOfInterest = (kBonusInfo.getBonusCategory() == 2) || (kBonusInfo.getBonusCategory() == 4);
					// MOD - END - Bonus Category for Globe View
					//bOfInterest = (kBonusInfo.getHappiness() != 0 ) && (kBonusInfo.getHealth() == 0);
					break;
				case SHOW_HEALTH_RESOURCES:
					// MOD - START - Bonus Category for Globe View
					bOfInterest = (kBonusInfo.getBonusCategory() == 3) || (kBonusInfo.getBonusCategory() == 4);
					// MOD - END - Bonus Category for Globe View
					//bOfInterest = (kBonusInfo.getHappiness() == 0) && (kBonusInfo.getHealth() != 0);
					break;
				}
...
const CvArtInfoUnit* CvPlayer::getUnitArtInfo(UnitTypes eUnit, int iMeshGroup) const
{
	...
	CivilizationTypes eForcedStyle = (CivilizationTypes)GC.getGameINLINE().getForcedStyle();
	
	if (eForcedStyle != NO_CIVILIZATION)
	{
		eCivilization = eForcedStyle;
	}
...
int CvPlayer::getScoreComponent(int iRawScore, int iInitial, int iMax, int iFactor, bool bExponential, bool bFinal, bool bVictory) const
{
	...
	if (bFinal && bVictory)
	{
		...
		if (bExponential && (iInitial != 0))
		{
			...
			iMax = (int)((float)iInitial * pow(fRatio, fTurnRatio));
		}
		else
		{
			iMax = (int)((float)iInitial + fTurnRatio * (float)(iMax - iInitial));
		}
	}
...
// MOD - START - Trait Trade Modifier
int CvPlayer::getTradeRouteIncomeModifier() const
{
	return m_iTradeRouteIncomeModifier;
}

void CvPlayer::changeTradeRouteIncomeModifier(int iChange)
{
	m_iTradeRouteIncomeModifier += iChange;
}

int CvPlayer::getForeignTradeRouteIncomeModifier() const
{
	return m_iForeignTradeRouteIncomeModifier;
}
void CvPlayer::changeForeignTradeRouteIncomeModifier(int iChange)
{
	m_iForeignTradeRouteIncomeModifier += iChange;
}
// MOD - END - Trait Trade Modifier

// MOD - START - Trait Upgrade Modifier
int CvPlayer::getUpgradeDiscount() const
{
	return m_iUpgradeDiscount;
}

void CvPlayer::changeUpgradeDiscount(int iChange)
{
...
// MOD - START - Congestion
int CvPlayer::getInsideCityCongestionThreshold() const
{
	return m_iInsideCityCongestionThreshold;
}

int CvPlayer::getOutsideCityCongestionThreshold() const
{
	return m_iOutsideCityCongestionThreshold;
}

void CvPlayer::changeInsideCityCongestionThreshold(int iChange)
{
	if (iChange != 0)
	{
		m_iInsideCityCongestionThreshold += iChange;

		GET_TEAM(getTeam()).updateInsideCityCongestionThreshold();
	}
}

void CvPlayer::changeOutsideCityCongestionThreshold(int iChange)
{
	if (iChange != 0)
	{
		m_iOutsideCityCongestionThreshold += iChange;

		GET_TEAM(getTeam()).updateOutsideCityCongestionThreshold();
	}
}
// MOD - END - Congestion
...
// MOD - START - Better Nukes
int CvPlayer::getNukesUsed() const
{
	return m_iNukesUsed;
}

void CvPlayer::changeNukesUsed(int iChange)
{
	m_iNukesUsed += iChange;
}
// MOD - END - Better Nukes

// MOD - START - RI Revolution
int CvPlayer::getRevModifier() const
{
	return m_iRevModifier;
}

void CvPlayer::changeRevModifier(int iChange)
{
	if (iChange != 0)
	{
		m_iRevModifier += iChange;
	}
}

void CvPlayer::calculateRevModifier() 
{
	calculateRevModifierScore();
	calculateRevModifierPower();
	calculateRevModifierEndOfHistory();
	calculateRevModifierWarExhaustion();
	int iRevModifier = getRevModifierScore() + getRevModifierPower() + getRevModifierEndOfHistory() + getRevModifierWarExhaustion();
	m_iRevModifier = std::max(iRevModifier,-90);
}

int CvPlayer::getRevModifierScore() const
{
	return m_iRevModifierScore;
}

void CvPlayer::changeRevModifierScore(int iChange)
{
	if (iChange != 0)
	{
		m_iRevModifierScore += iChange;
	}
}

void CvPlayer::calculateRevModifierScore() 
{
	int iScoreModifier;
	int iCompScore;
	int iRefScore = calculateScore(false, false);
	...
	for (int iI = 0; iI < MAX_CIV_PLAYERS; iI++)
	{
		if (iI != getID())
		{
			int iIterScore = GET_PLAYER((PlayerTypes)iI).calculateScore(false, false);
			if (iIterScore > iCompScore)
			{
				iCompScore = iIterScore;
			}
		}	
	}
	if (iRefScore > iCompScore && iCompScore > 0)
	{
		iScoreModifier = (iRefScore * 100 / iCompScore) - 100;
	}
	
	m_iRevModifierScore = iScoreModifier;
}

int CvPlayer::getRevModifierPower() const
{
	return m_iRevModifierPower;
}

void CvPlayer::changeRevModifierPower(int iChange)
{
	if (iChange != 0)
	{
		m_iRevModifierPower += iChange;
	}
}

void CvPlayer::calculateRevModifierPower() 
{
	int iPowerModifier;
	int iCompPower;
	int iRefPower = getPower();
	...
	for (int iI = 0; iI < MAX_CIV_PLAYERS; iI++)
	{
		if (iI != getID())
		{
			int iIterPower = GET_PLAYER((PlayerTypes)iI).getPower();
			if (iIterPower > iCompPower)
			{
				iCompPower = iIterPower;
			}
		}	
	}
	if (iRefPower > iCompPower && iCompPower > 0)
	{
		iPowerModifier = (iRefPower * 100 / iCompPower) - 100;
	}
	
	m_iRevModifierPower = iPowerModifier;
}

int CvPlayer::getRevModifierEndOfHistory() const
{
	return m_iRevModifierEoH;
}

void CvPlayer::changeRevModifierEndOfHistory(int iChange)
{
	if (iChange != 0)
	{
		m_iRevModifierEoH += iChange;
	}
}

void CvPlayer::calculateRevModifierEndOfHistory()
{
	int iInitPlayers = GC.getGameINLINE().getInitialNumPlayers();
	if ((iInitPlayers > 1) && (getCurrentEra() > 2) && (GC.getGameINLINE().countFreeTeamsAlive() <= (iInitPlayers / 2)))
	{
		int iI;
		bool bEnd = false;
		if (m_iRevModifierEoH == 0)
		{
			for (iI = 0; iI < MAX_CIV_PLAYERS; iI++)
				{
				if (GET_PLAYER((PlayerTypes)iI).isAlive())
					if (GET_PLAYER((PlayerTypes)iI).getRevModifierScore() > 50)
					{
						bEnd = true;
					}
				}
		...
		else
		{
			for (iI = 0; iI < MAX_CIV_PLAYERS; iI++)
				{
				if (GET_PLAYER((PlayerTypes)iI).isAlive())
					if (GET_PLAYER((PlayerTypes)iI).getRevModifierScore() > 25)
					{
						bEnd = true;
					}
				}
		...
		if (bEnd == true)
		{
			m_iRevModifierEoH = -50 * (1 + iInitPlayers - GC.getGameINLINE().countFreeTeamsAlive());
		}
		else
		{
			m_iRevModifierEoH = 0;
...
int CvPlayer::getRevModifierWarExhaustion() const
{
	return m_iRevModifierWE;
}

void CvPlayer::changeRevModifierWarExhaustion(int iChange)
{
	if (iChange != 0)
	{
		m_iRevModifierWE += iChange;
	}
}

void CvPlayer::calculateRevModifierWarExhaustion()
{
	int iWarWearinessPercentAnger = getWarWearinessPercentAnger();
	m_iRevModifierWE = (iWarWearinessPercentAnger / 10);
}

// MOD - END - RI Revolution

int CvPlayer::getSlaveAfrican() const
{
	return m_iSlaveAfrican;
}

void CvPlayer::incrementSlaveAfrican()
{
		m_iSlaveAfrican++;
}

int CvPlayer::getSlaveAsian() const
{
	return m_iSlaveAsian;
}

void CvPlayer::incrementSlaveAsian()
{
		m_iSlaveAsian++;
}

int CvPlayer::getSlaveEuropean() const
{
	return m_iSlaveEuropean;
}

void CvPlayer::incrementSlaveEuropean()
{
		m_iSlaveEuropean++;
}

int CvPlayer::getSlaveIndian() const
{
	return m_iSlaveIndian;
}

void CvPlayer::incrementSlaveIndian()
{
		m_iSlaveIndian++;
}

int CvPlayer::getSlaveMid() const
{
	return m_iSlaveMid;
}

void CvPlayer::incrementSlaveMid()
{
		m_iSlaveMid++;
}

int CvPlayer::getSlaveNewworld() const
{
	return m_iSlaveNewworld;
}

void CvPlayer::incrementSlaveNewworld()
{
		m_iSlaveNewworld++;
}

int CvPlayer::getSlaveSlavic() const
{
	return m_iSlaveSlavic;
}

void CvPlayer::incrementSlaveSlavic()
{
		m_iSlaveSlavic++;
}
