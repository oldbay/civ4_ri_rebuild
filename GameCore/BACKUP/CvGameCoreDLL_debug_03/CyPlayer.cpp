...
CyCity* CyPlayer::initCity(int x, int y) 
{
	...
	*/
	return m_pPlayer ? new CyCity(m_pPlayer->initCity(x, y, true, true, NO_PLAYER)) : NULL;
...
int CyPlayer::countRemoveNonStateReligionUnits(CyArea* pArea, int /*ReligionTypes*/ eReligion)
{
	return m_pPlayer ? m_pPlayer->countRemoveNonStateReligionUnits(pArea->getArea(), (ReligionTypes) eReligion) : -1;
}
// MOD - END - Inquisition
...
int CyPlayer::getInflationRate() // K-Mod
{
...
int CyPlayer::getCurrentResearchTechTransferCount()
{
	return m_pPlayer ? m_pPlayer->getCurrentResearchTechTransferCount() : false;
}

bool CyPlayer::isCurrentResearchTechTransfer()
{
	return m_pPlayer ? m_pPlayer->isCurrentResearchTechTransfer() : false;
}
...
int CyPlayer::getAcceptableEpidemicPercent() const
{
	return m_pPlayer ? m_pPlayer->getAcceptableEpidemicPercent() : 0;
}

void CyPlayer::setAcceptableEpidemicPercent(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->setGlobalEpidemicModifier(iNewValue);
}

void CyPlayer::changeAcceptableEpidemicPercent(int iChange)
{
	if (m_pPlayer)
		m_pPlayer->changeAcceptableEpidemicPercent(iChange);
}

int CyPlayer::getGlobalEpidemicModifier() const
{
	return m_pPlayer ? m_pPlayer->getGlobalEpidemicModifier() : 0;
}

void CyPlayer::setGlobalEpidemicModifier(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->setGlobalEpidemicModifier(iNewValue);
}

void CyPlayer::changeGlobalEpidemicModifier(int iChange)
{
	if (m_pPlayer)
		m_pPlayer->changeGlobalEpidemicModifier(iChange);
}
// MOD - END - Epidemics
...
bool CyPlayer::isUnlimitedConscript()
{
	return m_pPlayer ? m_pPlayer->isUnlimitedConscript() : false;
}
// MOD - END - Unlimited Conscription

// MOD - START - Wartime Conscription
int CyPlayer::getWarConscript()
{
	return m_pPlayer ? m_pPlayer->getWarConscript() : -1;
}
...
int CyPlayer::getHandicapScoreModifier()
{
	return m_pPlayer ? m_pPlayer->getHandicapScoreModifier() : -1;
}

void CyPlayer::setHandicapScoreModifier(int iModifier)
{
	if (m_pPlayer)
		m_pPlayer->setHandicapScoreModifier(iModifier);
}
...
int CyPlayer::getAllSpecialistCommerceChange(CommerceTypes eIndex)
{
	return m_pPlayer ? m_pPlayer->getAllSpecialistCommerceChange(eIndex) : NO_COMMERCE;
}
...
int CyPlayer::getUnitRoleCostModifier(int /*UnitRoleTypes*/ eIndex)
{
	return m_pPlayer ? m_pPlayer->getUnitRoleCostModifier((UnitRoleTypes)eIndex) : 0;
}

int CyPlayer::getUnitRoleCount(int /*UnitRoleTypes*/ eIndex)
{
	return m_pPlayer ? m_pPlayer->getUnitRoleCount((UnitRoleTypes)eIndex) : NO_UNITCLASS;
}

int CyPlayer::getUnitRoleMaking(int /*UnitRoleTypes*/ eIndex)
{
	return m_pPlayer ? m_pPlayer->getUnitRoleMaking((UnitRoleTypes)eIndex) : -1;
}

int CyPlayer::getUnitRoleCountPlusMaking(int /*UnitRoleTypes*/ eIndex)
{
	return m_pPlayer ? m_pPlayer->getUnitRoleCountPlusMaking((UnitRoleTypes)eIndex) : -1;
}
// MOD - END - Unit Roles
...
bool CyPlayer::canAcquireHolyCity(int /*ReligionTypes*/ eIndex)
{
	return m_pPlayer ? m_pPlayer->canAcquireHolyCity((ReligionTypes)eIndex) : -1;
}

bool CyPlayer::canMaintainHolyCity(int /*ReligionTypes*/ eIndex)
{
	return m_pPlayer ? m_pPlayer->canMaintainHolyCity((ReligionTypes)eIndex) : -1;
}
...
int CyPlayer::getSpecialistYieldChange(int /*SpecialistTypes*/ eIndex1, int /*YieldTypes*/ eIndex2)
{
	return m_pPlayer ? m_pPlayer->getSpecialistYieldChange((SpecialistTypes) eIndex1, (YieldTypes) eIndex2) : -1;
}
// MOD - END - Advanced Yield and Commerce Effects

// MOD - START - Advanced Yield and Commerce Effects
int CyPlayer::getBuildingYieldChange(int /*BuildingClassTypes*/ eBuildingClass, int /*YieldTypes*/ eYield) const
{
	return m_pPlayer ? m_pPlayer->getBuildingYieldChange((BuildingClassTypes) eBuildingClass, (YieldTypes) eYield) : -1;
}

int CyPlayer::getBuildingCommerceChange(int /*BuildingClassTypes*/ eBuildingClass, int /*CommerceTypes*/ eCommerce) const
{
	return m_pPlayer ? m_pPlayer->getBuildingCommerceChange((BuildingClassTypes) eBuildingClass, (CommerceTypes) eCommerce) : -1;
}
// MOD - END - Advanced Yield and Commerce Effects

// MOD - START - Tech Path Caching
/*
int CyPlayer::findPathLength(int eTech, bool bCost)
{
	return m_pPlayer ? m_pPlayer->findPathLength((TechTypes)eTech, bCost) : -1;
}
*/

int CyPlayer::getTechPathLength(int /*TechTypes*/ eTech)
{
	return m_pPlayer ? m_pPlayer->getTechPathLength((TechTypes)eTech) : -1;
}

int CyPlayer::getTechPathCost(int /*TechTypes*/ eTech)
{
	return m_pPlayer ? m_pPlayer->getTechPathCost((TechTypes)eTech) : -1;
}
...
int CyPlayer::getRevModifier() const
{
	return m_pPlayer ? (int) m_pPlayer->getRevModifier() : 0;
}

void CyPlayer::changeRevModifier(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->changeRevModifier(iNewValue);
}

void CyPlayer::calculateRevModifier()
{
	if (m_pPlayer)
		m_pPlayer->calculateRevModifier();
}

int CyPlayer::getRevModifierScore() const
{
	return m_pPlayer ? (int) m_pPlayer->getRevModifierScore() : 0;
}

void CyPlayer::changeRevModifierScore(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->changeRevModifierScore(iNewValue);
}

void CyPlayer::calculateRevModifierScore()
{
	if (m_pPlayer)
		m_pPlayer->calculateRevModifierScore();
}

int CyPlayer::getRevModifierPower() const
{
	return m_pPlayer ? (int) m_pPlayer->getRevModifierPower() : 0;
}

void CyPlayer::changeRevModifierPower(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->changeRevModifierPower(iNewValue);
}

void CyPlayer::calculateRevModifierPower()
{
	if (m_pPlayer)
		m_pPlayer->calculateRevModifierPower();
}

int CyPlayer::getRevModifierEndOfHistory() const
{
	return m_pPlayer ? (int) m_pPlayer->getRevModifierEndOfHistory() : 0;
}

void CyPlayer::changeRevModifierEndOfHistory(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->changeRevModifierEndOfHistory(iNewValue);
}

void CyPlayer::calculateRevModifierEndOfHistory()
{
	if (m_pPlayer)
		m_pPlayer->calculateRevModifierEndOfHistory();
}

int CyPlayer::getRevModifierWarExhaustion() const
{
	return m_pPlayer ? (int) m_pPlayer->getRevModifierWarExhaustion() : 0;
}

void CyPlayer::changeRevModifierWarExhaustion(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->changeRevModifierWarExhaustion(iNewValue);
}

void CyPlayer::calculateRevModifierWarExhaustion()
{
	if (m_pPlayer)
		m_pPlayer->calculateRevModifierWarExhaustion();
}
// MOD - END - RI Revolution

int CyPlayer::getSlaveAfrican() const
{
	return m_pPlayer ? (int) m_pPlayer->getSlaveAfrican() : 0;
}

void CyPlayer::incrementSlaveAfrican()
{
	if (m_pPlayer)
		m_pPlayer->incrementSlaveAfrican();
}

int CyPlayer::getSlaveAsian() const
{
	return m_pPlayer ? (int) m_pPlayer->getSlaveAsian() : 0;
}

void CyPlayer::incrementSlaveAsian()
{
	if (m_pPlayer)
		m_pPlayer->incrementSlaveAsian();
}

int CyPlayer::getSlaveEuropean() const
{
	return m_pPlayer ? (int) m_pPlayer->getSlaveEuropean() : 0;
}

void CyPlayer::incrementSlaveEuropean()
{
	if (m_pPlayer)
		m_pPlayer->incrementSlaveEuropean();
}

int CyPlayer::getSlaveIndian() const
{
	return m_pPlayer ? (int) m_pPlayer->getSlaveIndian() : 0;
}

void CyPlayer::incrementSlaveIndian()
{
	if (m_pPlayer)
		m_pPlayer->incrementSlaveIndian();
}

int CyPlayer::getSlaveMid() const
{
	return m_pPlayer ? (int) m_pPlayer->getSlaveMid() : 0;
}

void CyPlayer::incrementSlaveMid()
{
	if (m_pPlayer)
		m_pPlayer->incrementSlaveMid();
}

int CyPlayer::getSlaveNewworld() const
{
	return m_pPlayer ? (int) m_pPlayer->getSlaveNewworld() : 0;
}

void CyPlayer::incrementSlaveNewworld()
{
	if (m_pPlayer)
		m_pPlayer->incrementSlaveNewworld();
}

int CyPlayer::getSlaveSlavic() const
{
	return m_pPlayer ? (int) m_pPlayer->getSlaveSlavic() : 0;
}

void CyPlayer::incrementSlaveSlavic()
{
	if (m_pPlayer)
		m_pPlayer->incrementSlaveSlavic();
}
