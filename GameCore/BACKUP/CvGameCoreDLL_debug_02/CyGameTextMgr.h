...
public:
	...
	// MOD - START - Aid
	std::wstring getAidHelp(int iAid, bool bCivilopediaText);
	// MOD - END - Aid
	// MOD - START - Detriments
	std::wstring getDetrimentHelp(int iDetriment, bool bCivilopediaText);
	// MOD - END - Detriments
	...
	std::wstring getImprovementHelp(int iImprovement, bool bCivilopediaEffects, bool bCivilopediaImprovements);
	...
	std::wstring getWorldSizeHelp(int iWorldSize, bool bCivilopediaText);
	std::wstring getHandicapHelp(int iHandicap, bool bCivilopediaText);
	std::wstring getConceptHelp(int iConcept, bool bCivilopediaText);
	std::wstring getHotKeyClassHelp(int iHotKeyClass, bool bCivilopediaText);
	// MOD - END - Improved Civilopedia
	// MOD - START - Era Effects
	std::wstring getEraHelp(int iEra, bool bSplash, bool bCivilopediaText);
	// MOD - END - Era Effects
	...
	// MOD - START - Improved Civilopedia
	std::wstring parseTraits(int /*LeaderHeadTypes*/ iTrait, int /*CivilizationTypes*/ iCivilization, bool bDawnOfMan, bool bCivilopediaText);
	// MOD - END - Improved Civilopedia
