...
public:
	...
	CvUnitRoleInfo* getUnitRoleInfo(int i) const;
	// MOD - END - Unit Roles
	...
	CvDomainInfo* getDomainInfo(int i) const;
	// MOD - END - Congestion
	...
	// MOD - START - Aid
	CvAidInfo* getAidInfo(int i) const;
	// MOD - END - Aid
	// MOD - START - Detriments
	CvDetrimentInfo* getDetrimentInfo(int i) const;
	// MOD - END - Detriments
	// MOD - START - Congestion
	CvCongestionInfo* getCongestionInfo(int i) const;
	// MOD - END - Congestion
	...
	CvHotKeyClassInfo* getHotKeyClassInfo(int i) const;
	...
	CvGameEventInfo* getGameEventInfo(int i) const;
	// MOD - END - Core Game Events
	// MOD - START - Population Metrics
	CvInfoBase* getContributionInfo(int i) const;
	CvSocialStabilityInfo* getSocialStabilityInfo(int i) const;
	CvMetricClassInfo* getMetricClassInfo(int i) const;
	CvMetricInfo* getMetricInfo(int i) const;
	CvMetricFactorInfo* getMetricFactorInfo(int i) const;
	...
	bool findAssetFile(const TCHAR* szAssetPath) const { return GC.findAssetFile(szAssetPath); }
	// MOD - END - Asset Files

	// MOD - START - Graphical Paging
	void setGraphicOptionGraphicalPaging(bool bEnabled);
	bool getGraphicOption(int i) const { return GC.getGraphicOption((GraphicOptionTypes)i); }
	...
	// MOD - START - Improvement Classes
	int getNumImprovementClassInfos() const { return GC.getNumImprovementClassInfos(); }
	// MOD - END - Improvement Classes
	...
	// MOD - START - Unit Roles
	int getNumUnitRoleInfos() const { return GC.getNumUnitRoleInfos(); }
	// MOD - END - Unit Roles
	...
	// MOD - START - Aid
	int getNumAidInfos() const { return GC.getNumAidInfos(); }
	// MOD - END - Aid
	// MOD - START - Detriments
	int getNumDetrimentInfos() const { return GC.getNumDetrimentInfos(); }
	// MOD - END - Detriments
	// MOD - START - Congestion
	int getNumCongestionInfos() const { return GC.getNumCongestionInfos(); }
	// MOD - END - Congestion
	...
	// MOD - START - Core Game Events
	int getNumGameEventInfos() const { return GC.getNumGameEventInfos(); }
	// MOD - END - Core Game Events
	// MOD - START - Population Metrics
	int getNumContributionInfos() const { return GC.getNumContributionInfos(); }
	int getNumSocialStabilityInfos() const { return GC.getNumSocialStabilityInfos(); }
	int getNumMetricClassInfos() const { return GC.getNumMetricClassInfos(); }
	int getNumMetricInfos() const { return GC.getNumMetricInfos(); }
	int getNumMetricFactorInfos() const { return GC.getNumMetricFactorInfos(); }
	// MOD - END - Population Metrics
	...
	// MOD - START - Improved Civilopedia
	int getNumHotKeyClassInfos() const { return GC.getNumHotKeyClassInfos(); }
	// MOD - END - Improved Civilopedia
