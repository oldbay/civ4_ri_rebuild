...
public:
	...
	int getResolutionX() const; // Exposed to Python
	int getResolutionY() const; // Exposed to Python
	void setResolution(int iX, int iY); // Exposed to Python
...
*/
	...
	int getNumHolyCityCandidates(ReligionTypes eReligion, PlayerTypes eIgnorePlayer = NO_PLAYER) const;

	void updateBestHolyCityCandidate(ReligionTypes eReligion);
	CvCity* getBestHolyCityCandidate(ReligionTypes eReligion) const;
	void setBestHolyCityCandidate(ReligionTypes eReligion, CvCity* pNewValue);

	int getHolyCityLossThreshold() const;
	int getHolyCityAcquisitionThreshold() const;
	...
	virtual int AI_combatValue(UnitTypes eUnit) const = 0; // K-Mod!
...
/********************************************************************************/
	...
	int getInitialNumPlayers() const;																	// Exposed to Python
	void setInitialNumPlayers(int iNewValue);
	int getAheadOfTimeEra() const;
	void setAheadOfTimeEra( const int newAheadOfTimeEra );
	int getForcedStyle() const;
	void setForcedStyle(int iNewValue);

	// MOD - START - Better Nukes
	int getNuclearWinterLevel() const;
	void changeNuclearWinterLevel(int iNewValue);
	int getNuclearWinterUnhealthiness() const;
	int getNuclearWinterFoodYieldEffect(int iNuclearWinterEffect) const;
...
protected:
	...
	// MOD - START - Holy City Migration
	IDInfo* m_paBestHolyCityCandidate;
	// MOD - END - Holy City Migration
	...
	// MOD - START - Better Nukes
	void doNuclearWinter();
	// END - START - Better Nukes
	...
	bool canCreateBarbarianCombatUnits() const;
	bool canCreateAnimals() const;
	void createBarbarianCombatUnits(CvArea* pArea, const std::vector<UnitTypes>& aBarbarianCombatUnits);
	void createAnimals(CvArea* pArea, const std::vector<UnitTypes>& aAnimals);
	void getBarbarianCombatUnits(std::vector<UnitTypes>& aBarbarianCombatUnits) const;
	void getAnimals(std::vector<UnitTypes>& aAnimals) const;
	// MOD - END - Efficiency
