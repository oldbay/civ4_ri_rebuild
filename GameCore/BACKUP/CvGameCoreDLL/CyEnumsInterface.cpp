...
/************************************************************************************************/
	...
	python::enum_<InterfaceDirtyBits>("InterfaceDirtyBits")
		...
		.value("Revolutions_DIRTY_BIT", Revolutions_DIRTY_BIT)
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_EPIDEMIC_PROBABILITY", WIDGET_HELP_EPIDEMIC_PROBABILITY)
		.value("WIDGET_HELP_EPIDEMIC_PROBABILITY_GLOBAL_MODIFIER", WIDGET_HELP_EPIDEMIC_PROBABILITY_GLOBAL_MODIFIER)
		// MOD - END - Epidemics
		.value("WIDGET_HELP_AHEAD", WIDGET_HELP_AHEAD)
		// MOD - START - Advanced Yield and Commerce Effects
		.value("WIDGET_HELP_IRRIGATED_YIELD_CHANGE", WIDGET_HELP_IRRIGATED_YIELD_CHANGE)
		// MOD - END - Advanced Yield and Commerce Effects
		// MOD - START - Congestion
		.value("WIDGET_CONGESTION_CONTEXT", WIDGET_CONGESTION_CONTEXT)
		.value("WIDGET_CONGESTION_PREVIOUS_LEVEL", WIDGET_CONGESTION_PREVIOUS_LEVEL)
		.value("WIDGET_CONGESTION_CURRENT_LEVEL", WIDGET_CONGESTION_CURRENT_LEVEL)
		.value("WIDGET_CONGESTION_NEXT_LEVEL", WIDGET_CONGESTION_NEXT_LEVEL)
		.value("WIDGET_CONGESTION_BAR", WIDGET_CONGESTION_BAR)
		.value("WIDGET_CONGESTION_INSIDE_CITY_THRESHOLD_CHANGE", WIDGET_CONGESTION_INSIDE_CITY_THRESHOLD_CHANGE)
		.value("WIDGET_CONGESTION_OUTSIDE_CITY_THRESHOLD_CHANGE", WIDGET_CONGESTION_OUTSIDE_CITY_THRESHOLD_CHANGE)
		// MOD - END - Congestion
		// MOD - START - Population Metrics
		.value("WIDGET_HELP_CITY_STABILITY", WIDGET_HELP_CITY_STABILITY)
		// MOD - END - Population Metrics
		// MOD - START - Population Advisor
		.value("WIDGET_POPULATION_ADVISOR", WIDGET_POPULATION_ADVISOR)
		// MOD - END - Population Advisor
		// MOD - START - Improved Civilopedia
		.value("WIDGET_PEDIA_CLEAR_SEARCH_FILTER", WIDGET_PEDIA_CLEAR_SEARCH_FILTER)
		.value("WIDGET_PEDIA_TOGGLE_PLAYABLE_FILTER", WIDGET_PEDIA_TOGGLE_PLAYABLE_FILTER)
		.value("WIDGET_PEDIA_SECTION", WIDGET_PEDIA_SECTION)
		.value("WIDGET_PEDIA_VIEW", WIDGET_PEDIA_VIEW)
		.value("WIDGET_PEDIA_JUMP_TO_UNIT_COMPARISON", WIDGET_PEDIA_JUMP_TO_UNIT_COMPARISON)
		.value("WIDGET_PEDIA_JUMP_TO_UNIT_UPGRADE_CHART", WIDGET_PEDIA_JUMP_TO_UNIT_UPGRADE_CHART)
		.value("WIDGET_PEDIA_JUMP_TO_PROMOTION_TREE", WIDGET_PEDIA_JUMP_TO_PROMOTION_TREE)
		.value("WIDGET_PEDIA_JUMP_TO_BUILDING_COMPARISON", WIDGET_PEDIA_JUMP_TO_BUILDING_COMPARISON)
		.value("WIDGET_PEDIA_JUMP_TO_BUILDING_CLASS", WIDGET_PEDIA_JUMP_TO_BUILDING_CLASS)
		.value("WIDGET_PEDIA_JUMP_TO_BUILDING_UPGRADE_CHART", WIDGET_PEDIA_JUMP_TO_BUILDING_UPGRADE_CHART)
		.value("WIDGET_PEDIA_JUMP_TO_TRAIT", WIDGET_PEDIA_JUMP_TO_TRAIT)
		.value("WIDGET_PEDIA_JUMP_TO_ERA", WIDGET_PEDIA_JUMP_TO_ERA)
		.value("WIDGET_PEDIA_JUMP_TO_WORLD", WIDGET_PEDIA_JUMP_TO_WORLD)
		.value("WIDGET_PEDIA_JUMP_TO_ROUTE", WIDGET_PEDIA_JUMP_TO_ROUTE)
		.value("WIDGET_PEDIA_JUMP_TO_HANDICAP", WIDGET_PEDIA_JUMP_TO_HANDICAP)
		.value("WIDGET_PEDIA_JUMP_TO_INTRODUCTION", WIDGET_PEDIA_JUMP_TO_INTRODUCTION)
		.value("WIDGET_PEDIA_JUMP_TO_CONCEPT", WIDGET_PEDIA_JUMP_TO_CONCEPT)
		.value("WIDGET_PEDIA_JUMP_TO_HINTS", WIDGET_PEDIA_JUMP_TO_HINTS)
		.value("WIDGET_PEDIA_JUMP_TO_HOTKEY_CLASS", WIDGET_PEDIA_JUMP_TO_HOTKEY_CLASS)
		// MOD - END - Improved Civilopedia
		// MOD - START - Aid
		.value("WIDGET_PEDIA_JUMP_TO_AID", WIDGET_PEDIA_JUMP_TO_AID)
		// MOD - END - Aid
		// MOD - START - Detriments
		.value("WIDGET_PEDIA_JUMP_TO_DETRIMENT", WIDGET_PEDIA_JUMP_TO_DETRIMENT)
		// MOD - END - Detriments
		// K-Mod widgets
...
*/
	...
	python::enum_<WorldSizeTypes>("WorldSizeTypes")
		...
		.value("WORLDSIZE_SPECIAL", WORLDSIZE_SPECIAL)
		...
		.value("WORLDSIZE_GIANT", WORLDSIZE_GIANT)
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_ALLIANCES", GAMEOPTION_ALLIANCES)		
		...
		.value("GAMEOPTION_NO_TECH_TRANSFER", GAMEOPTION_NO_TECH_TRANSFER)
		// MOD - END - Tech Transfer
		// MOD - START - Per City Research Cost
		.value("GAMEOPTION_NO_PER_CITY_RESEARCH_COST", GAMEOPTION_NO_PER_CITY_RESEARCH_COST)
		// MOD - END - Per City Research Cost
		// MOD - START - Optional Unit Cost Scaling
		.value("GAMEOPTION_NO_UNIT_COST_SCALING", GAMEOPTION_NO_UNIT_COST_SCALING)
		// MOD - END - Optional Unit Cost Scaling
		.value("GAMEOPTION_NO_REVOLUTIONS", GAMEOPTION_NO_REVOLUTIONS)
		.value("GAMEOPTION_NO_BARBARIAN_CIV", GAMEOPTION_NO_BARBARIAN_CIV)
		// MOD - START - Holy City Migration
		.value("GAMEOPTION_HOLY_CITY_MIGRATION", GAMEOPTION_HOLY_CITY_MIGRATION)
		// MOD - END - Holy City Migration
		.value("GAMEOPTION_NO_RELIGION_SHOCK", GAMEOPTION_NO_RELIGION_SHOCK)
		.value("GAMEOPTION_NO_REBELLIONS", GAMEOPTION_NO_REBELLIONS)
		.value("GAMEOPTION_NO_CITY_NAMING", GAMEOPTION_NO_CITY_NAMING)
		.value("GAMEOPTION_NO_DYNAMIC_CIV_NAMES", GAMEOPTION_NO_DYNAMIC_CIV_NAMES)
		.value("GAMEOPTION_NO_DYNAMIC_CIV_FLAGS", GAMEOPTION_NO_DYNAMIC_CIV_FLAGS)
		// MOD - START - Protect Valuable Units / Lead From Behind
		.value("GAMEOPTION_PROTECT_VALUABLE_UNITS", GAMEOPTION_PROTECT_VALUABLE_UNITS)
		// MOD - END - Protect Valuable Units / Lead From Behind
		// MOD - START - AI Plays To Win
		.value("GAMEOPTION_AI_PLAYS_TO_WIN", GAMEOPTION_AI_PLAYS_TO_WIN)
		// MOD - END - AI Plays To Win
		.value("GAMEOPTION_NO_AHEAD", GAMEOPTION_NO_AHEAD)
		.value("GAMEOPTION_IDW", GAMEOPTION_IDW)
	...
	python::enum_<PlayerOptionTypes>("PlayerOptionTypes")
		...
		.value("PLAYEROPTION_ADVANCED_AUTOMATIONS", PLAYEROPTION_ADVANCED_AUTOMATIONS)
	...
	python::enum_<GraphicOptionTypes>("GraphicOptionTypes")
		...
		.value("GRAPHICOPTION_GRAPHICAL_PAGING", GRAPHICOPTION_GRAPHICAL_PAGING)
		// MOD - END - Graphical Paging
		.value("NUM_GRAPHICOPTION_TYPES", NUM_GRAPHICOPTION_TYPES)
		// MOD - START - Graphical Paging
		.value("NUM_GRAPHICOPTION_UNBOUNDED_TYPES", NUM_GRAPHICOPTION_UNBOUNDED_TYPES)
		// MOD - END - Graphical Paging
		;
	...
	python::enum_<ImprovementClassTypes>("ImprovementClassTypes")
		.value("NO_IMPROVEMENTCLASS", NO_IMPROVEMENTCLASS)
		;
	...
	python::enum_<FontSymbols>("FontSymbols")
		...
		.value("CANCEL_CHAR", CANCEL_CHAR)
		// MOD - END - Advanced Civilopedia
		.value("SEPARATISM_CHAR", SEPARATISM_CHAR)
		.value("SEPARATISM_POS_CHAR", SEPARATISM_POS_CHAR)
		.value("SEPARATISM_NEG_CHAR", SEPARATISM_NEG_CHAR)
		.value("SEPARATISM_GREEN_CHAR", SEPARATISM_GREEN_CHAR)
		.value("SEPARATISM_YELLOW_CHAR", SEPARATISM_YELLOW_CHAR)
		.value("SEPARATISM_ORANGE_CHAR", SEPARATISM_ORANGE_CHAR)
	...
	python::enum_<DenialTypes>("DenialTypes")
		...
		.value("DENIAL_FAVORITE_RELIGION", DENIAL_FAVORITE_RELIGION)
	...
	python::enum_<UnitAITypes>("UnitAITypes")
		...
		.value("UNITAI_FORTIFICATION", UNITAI_FORTIFICATION)
		...
		.value("UNITAI_INQUISITOR", UNITAI_INQUISITOR)
		.value("UNITAI_INQUISITOR_SEA", UNITAI_INQUISITOR_SEA)
		// MOD - END - Inquisition
...
/************************************************************************************************/
	...
	python::enum_<MissionTypes>("MissionTypes")
		...
		// MOD - START - Inquisition
		.value("MISSION_REMOVE_RELIGION", MISSION_REMOVE_RELIGION)
		// MOD - END - Inquisition
		// MOD - START - Advanced Automations
/************************************************************************************************/
...
/************************************************************************************************/
	...
	python::enum_<MissionAITypes>("MissionAITypes")
		...
		// MOD - START - Inquisition
		.value("MISSIONAI_REMOVE_RELIGION", MISSIONAI_REMOVE_RELIGION)
		// MOD - END - Inquisition
		;
	...
	// MOD - START - Aid
	python::enum_<AidTypes>("AidTypes")
		.value("NO_AID", NO_AID)
		;
	// MOD - END - Aid

	// MOD - START - Detriments
	python::enum_<DetrimentTypes>("DetrimentTypes")
		.value("NO_DETRIMENT", NO_DETRIMENT)
		;
	// MOD - END - Detriments

	// MOD - START - Congestion
	python::enum_<CongestionTypes>("CongestionTypes")
		.value("NO_CONGESTION", NO_CONGESTION)
		;
	// MOD - END - Congestion
	...
	python::enum_<MemoryTypes>("MemoryTypes")
		...
		// MOD - START - Inquisition
		.value("MEMORY_REMOVED_RELIGION_FROM_CITY", MEMORY_REMOVED_RELIGION_FROM_CITY)
		.value("MEMORY_REMOVED_STATE_RELIGION", MEMORY_REMOVED_STATE_RELIGION)
		// MOD - END - Inquisition
	...
	// MOD - START - Improved Civilopedia
	python::enum_<CivilopediaSectionTypes>("CivilopediaSectionTypes")
		.value("NO_CIVILOPEDIA_SECTION", NO_CIVILOPEDIA_SECTION)

		.value("CIVILOPEDIA_SECTION_TECHNOLOGIES", CIVILOPEDIA_SECTION_TECHNOLOGIES)
		.value("CIVILOPEDIA_SECTION_UNITS", CIVILOPEDIA_SECTION_UNITS)
		.value("CIVILOPEDIA_SECTION_MILITARY", CIVILOPEDIA_SECTION_MILITARY)
		.value("CIVILOPEDIA_SECTION_BUILDINGS", CIVILOPEDIA_SECTION_BUILDINGS)
		.value("CIVILOPEDIA_SECTION_SOCIETY", CIVILOPEDIA_SECTION_SOCIETY)
		.value("CIVILOPEDIA_SECTION_WORLD", CIVILOPEDIA_SECTION_WORLD)
		.value("CIVILOPEDIA_SECTION_HELP", CIVILOPEDIA_SECTION_HELP)

		.value("NUM_CIVILOPEDIA_SECTION_TYPES", NUM_CIVILOPEDIA_SECTION_TYPES)
		;

	python::enum_<CivilopediaViewTypes>("CivilopediaViewTypes")
		.value("NO_CIVILOPEDIA_VIEW", NO_CIVILOPEDIA_VIEW)

		.value("CIVILOPEDIA_VIEW_TECHNOLOGIES", CIVILOPEDIA_VIEW_TECHNOLOGIES)
		.value("CIVILOPEDIA_VIEW_TECHNOLOGIES_GRAPH", CIVILOPEDIA_VIEW_TECHNOLOGIES_GRAPH)
		.value("CIVILOPEDIA_VIEW_TECHNOLOGIES_ALL", CIVILOPEDIA_VIEW_TECHNOLOGIES_ALL)
		.value("CIVILOPEDIA_VIEW_TECHNOLOGIES_ERA", CIVILOPEDIA_VIEW_TECHNOLOGIES_ERA)
		.value("CIVILOPEDIA_VIEW_UNITS", CIVILOPEDIA_VIEW_UNITS)
		.value("CIVILOPEDIA_VIEW_UNITS_ALL", CIVILOPEDIA_VIEW_UNITS_ALL)
		.value("CIVILOPEDIA_VIEW_UNITS_COMPARISON", CIVILOPEDIA_VIEW_UNITS_COMPARISON)
		.value("CIVILOPEDIA_VIEW_UNITS_CATEGORIES", CIVILOPEDIA_VIEW_UNITS_CATEGORIES)
		.value("CIVILOPEDIA_VIEW_UNITS_UPGRADE_CHART", CIVILOPEDIA_VIEW_UNITS_UPGRADE_CHART)
		.value("CIVILOPEDIA_VIEW_MILITARY", CIVILOPEDIA_VIEW_MILITARY)
		.value("CIVILOPEDIA_VIEW_MILITARY_CONVENTIONAL_PROMOTIONS", CIVILOPEDIA_VIEW_MILITARY_CONVENTIONAL_PROMOTIONS)
		.value("CIVILOPEDIA_VIEW_MILITARY_SPECIAL_PROMOTIONS", CIVILOPEDIA_VIEW_MILITARY_SPECIAL_PROMOTIONS)
		.value("CIVILOPEDIA_VIEW_MILITARY_PROMOTION_TREE", CIVILOPEDIA_VIEW_MILITARY_PROMOTION_TREE)
		.value("CIVILOPEDIA_VIEW_MILITARY_DOCTRINES", CIVILOPEDIA_VIEW_MILITARY_DOCTRINES)
		.value("CIVILOPEDIA_VIEW_MILITARY_TRADITIONS", CIVILOPEDIA_VIEW_MILITARY_TRADITIONS)
		.value("CIVILOPEDIA_VIEW_MILITARY_AID", CIVILOPEDIA_VIEW_MILITARY_AID)
		.value("CIVILOPEDIA_VIEW_MILITARY_DETRIMENTS", CIVILOPEDIA_VIEW_MILITARY_DETRIMENTS)
		.value("CIVILOPEDIA_VIEW_BUILDINGS", CIVILOPEDIA_VIEW_BUILDINGS)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_ALL", CIVILOPEDIA_VIEW_BUILDINGS_ALL)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_CIVILIZATION", CIVILOPEDIA_VIEW_BUILDINGS_CIVILIZATION)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_COMPARISON", CIVILOPEDIA_VIEW_BUILDINGS_COMPARISON)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_CLASSES", CIVILOPEDIA_VIEW_BUILDINGS_CLASSES)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_GREAT_WONDERS", CIVILOPEDIA_VIEW_BUILDINGS_GREAT_WONDERS)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_GREAT_WORKS", CIVILOPEDIA_VIEW_BUILDINGS_GREAT_WORKS)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_NATIONAL_WONDERS", CIVILOPEDIA_VIEW_BUILDINGS_NATIONAL_WONDERS)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_PROJECTS", CIVILOPEDIA_VIEW_BUILDINGS_PROJECTS)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_RELIGIOUS", CIVILOPEDIA_VIEW_BUILDINGS_RELIGIOUS)
		.value("CIVILOPEDIA_VIEW_BUILDINGS_UPGRADE_CHART", CIVILOPEDIA_VIEW_BUILDINGS_UPGRADE_CHART)
		.value("CIVILOPEDIA_VIEW_SOCIETY", CIVILOPEDIA_VIEW_SOCIETY)
		.value("CIVILOPEDIA_VIEW_SOCIETY_CIVILIZATIONS", CIVILOPEDIA_VIEW_SOCIETY_CIVILIZATIONS)
		.value("CIVILOPEDIA_VIEW_SOCIETY_LEADERS", CIVILOPEDIA_VIEW_SOCIETY_LEADERS)
		.value("CIVILOPEDIA_VIEW_SOCIETY_TRAITS", CIVILOPEDIA_VIEW_SOCIETY_TRAITS)
		.value("CIVILOPEDIA_VIEW_SOCIETY_CIVICS", CIVILOPEDIA_VIEW_SOCIETY_CIVICS)
		.value("CIVILOPEDIA_VIEW_SOCIETY_RELIGIONS", CIVILOPEDIA_VIEW_SOCIETY_RELIGIONS)
		.value("CIVILOPEDIA_VIEW_SOCIETY_SPECIALISTS", CIVILOPEDIA_VIEW_SOCIETY_SPECIALISTS)
		.value("CIVILOPEDIA_VIEW_SOCIETY_ERAS", CIVILOPEDIA_VIEW_SOCIETY_ERAS)
		.value("CIVILOPEDIA_VIEW_WORLD", CIVILOPEDIA_VIEW_WORLD)
		.value("CIVILOPEDIA_VIEW_WORLD_BASE_TERRAIN", CIVILOPEDIA_VIEW_WORLD_BASE_TERRAIN)
		.value("CIVILOPEDIA_VIEW_WORLD_TERRAIN_FEATURES", CIVILOPEDIA_VIEW_WORLD_TERRAIN_FEATURES)
		.value("CIVILOPEDIA_VIEW_WORLD_RESOURCES", CIVILOPEDIA_VIEW_WORLD_RESOURCES)
		.value("CIVILOPEDIA_VIEW_WORLD_IMPROVEMENTS", CIVILOPEDIA_VIEW_WORLD_IMPROVEMENTS)
		.value("CIVILOPEDIA_VIEW_WORLD_MAP_SIZES", CIVILOPEDIA_VIEW_WORLD_MAP_SIZES)
		.value("CIVILOPEDIA_VIEW_WORLD_ROUTES", CIVILOPEDIA_VIEW_WORLD_ROUTES)
		.value("CIVILOPEDIA_VIEW_WORLD_DIFFICULTY_LEVELS", CIVILOPEDIA_VIEW_WORLD_DIFFICULTY_LEVELS)
		.value("CIVILOPEDIA_VIEW_HELP", CIVILOPEDIA_VIEW_HELP)
		.value("CIVILOPEDIA_VIEW_HELP_INTRODUCTION", CIVILOPEDIA_VIEW_HELP_INTRODUCTION)
		.value("CIVILOPEDIA_VIEW_HELP_CONCEPTS", CIVILOPEDIA_VIEW_HELP_CONCEPTS)
		.value("CIVILOPEDIA_VIEW_HELP_HINTS", CIVILOPEDIA_VIEW_HELP_HINTS)
		.value("CIVILOPEDIA_VIEW_HELP_HOTKEY_CLASSES", CIVILOPEDIA_VIEW_HELP_HOTKEY_CLASSES)

		.value("NUM_CIVILOPEDIA_VIEW_TYPES", NUM_CIVILOPEDIA_VIEW_TYPES)
		;

	python::enum_<CivilopediaPageTypes>("CivilopediaPageTypes")
		.value("NO_CIVILOPEDIA_PAGE", NO_CIVILOPEDIA_PAGE)

		.value("CIVILOPEDIA_PAGE_TECHNOLOGY_GRAPH", CIVILOPEDIA_PAGE_TECHNOLOGY_GRAPH)
		.value("CIVILOPEDIA_PAGE_TECHNOLOGY", CIVILOPEDIA_PAGE_TECHNOLOGY)
		.value("CIVILOPEDIA_PAGE_UNIT", CIVILOPEDIA_PAGE_UNIT)
		.value("CIVILOPEDIA_PAGE_UNIT_COMPARISON", CIVILOPEDIA_PAGE_UNIT_COMPARISON)
		.value("CIVILOPEDIA_PAGE_UNIT_CLASS", CIVILOPEDIA_PAGE_UNIT_CLASS)
		.value("CIVILOPEDIA_PAGE_UNIT_COMBAT", CIVILOPEDIA_PAGE_UNIT_COMBAT)
		.value("CIVILOPEDIA_PAGE_UNIT_UPGRADE_CHART", CIVILOPEDIA_PAGE_UNIT_UPGRADE_CHART)
		.value("CIVILOPEDIA_PAGE_PROMOTION", CIVILOPEDIA_PAGE_PROMOTION)
		.value("CIVILOPEDIA_PAGE_PROMOTION_TREE", CIVILOPEDIA_PAGE_PROMOTION_TREE)
		.value("CIVILOPEDIA_PAGE_AID", CIVILOPEDIA_PAGE_AID)
		.value("CIVILOPEDIA_PAGE_DETRIMENT", CIVILOPEDIA_PAGE_DETRIMENT)
		.value("CIVILOPEDIA_PAGE_BUILDING", CIVILOPEDIA_PAGE_BUILDING)
		.value("CIVILOPEDIA_PAGE_BUILDING_COMPARISON", CIVILOPEDIA_PAGE_BUILDING_COMPARISON)
		.value("CIVILOPEDIA_PAGE_BUILDING_CLASS", CIVILOPEDIA_PAGE_BUILDING_CLASS)
		.value("CIVILOPEDIA_PAGE_BUILDING_UPGRADE_CHART", CIVILOPEDIA_PAGE_BUILDING_UPGRADE_CHART)
		.value("CIVILOPEDIA_PAGE_WONDER", CIVILOPEDIA_PAGE_WONDER)
		.value("CIVILOPEDIA_PAGE_PROJECT", CIVILOPEDIA_PAGE_PROJECT)
		.value("CIVILOPEDIA_PAGE_CIVILIZATION", CIVILOPEDIA_PAGE_CIVILIZATION)
		...
		.value("CIVILOPEDIA_PAGE_ERA", CIVILOPEDIA_PAGE_ERA)
		...
		.value("CIVILOPEDIA_PAGE_WORLD", CIVILOPEDIA_PAGE_WORLD)
		.value("CIVILOPEDIA_PAGE_ROUTE", CIVILOPEDIA_PAGE_ROUTE)
		.value("CIVILOPEDIA_PAGE_HANDICAP", CIVILOPEDIA_PAGE_HANDICAP)
		.value("CIVILOPEDIA_PAGE_INTRODUCTION", CIVILOPEDIA_PAGE_INTRODUCTION)
		.value("CIVILOPEDIA_PAGE_CONCEPT", CIVILOPEDIA_PAGE_CONCEPT)
		.value("CIVILOPEDIA_PAGE_HINTS", CIVILOPEDIA_PAGE_HINTS)
		.value("CIVILOPEDIA_PAGE_HOTKEY_CLASS", CIVILOPEDIA_PAGE_HOTKEY_CLASS)

		.value("NUM_CIVILOPEDIA_PAGE_TYPES", NUM_CIVILOPEDIA_PAGE_TYPES)
		;

	python::enum_<CivilopediaModeTypes>("CivilopediaModeTypes")
		.value("NO_CIVILOPEDIA_MODE", NO_CIVILOPEDIA_MODE)

		.value("CIVILOPEDIA_MODE_ALL", CIVILOPEDIA_MODE_ALL)
		.value("CIVILOPEDIA_MODE_GROUPED", CIVILOPEDIA_MODE_GROUPED)
		.value("CIVILOPEDIA_MODE_CIVILIZATION", CIVILOPEDIA_MODE_CIVILIZATION)
		.value("CIVILOPEDIA_MODE_PLAYABLE", CIVILOPEDIA_MODE_PLAYABLE)
		.value("CIVILOPEDIA_MODE_NONPLAYABLE", CIVILOPEDIA_MODE_NONPLAYABLE)
		.value("CIVILOPEDIA_MODE_ACTIVE_GAME", CIVILOPEDIA_MODE_ACTIVE_GAME)
		.value("CIVILOPEDIA_MODE_ACTIVE_PLAYER", CIVILOPEDIA_MODE_ACTIVE_PLAYER)

		.value("NUM_CIVILOPEDIA_MODE_TYPES", NUM_CIVILOPEDIA_MODE_TYPES)
		;

	python::enum_<CivilopediaSortTypes>("CivilopediaSortTypes")
		.value("NO_CIVILOPEDIA_SORT", NO_CIVILOPEDIA_SORT)

		.value("CIVILOPEDIA_SORT_LEXICAL", CIVILOPEDIA_SORT_LEXICAL)
		.value("CIVILOPEDIA_SORT_LOGICAL", CIVILOPEDIA_SORT_LOGICAL)

		.value("NUM_CIVILOPEDIA_SORT_TYPES", NUM_CIVILOPEDIA_SORT_TYPES)
		;
	// MOD - END - Improved Civilopedia
