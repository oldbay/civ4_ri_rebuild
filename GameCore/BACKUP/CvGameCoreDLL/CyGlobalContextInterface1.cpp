...
void CyGlobalContextPythonInterface1(python::class_<CyGlobalContext>& x)
{
	...
	x
		...
		.def("getImprovementClassInfo", &CyGlobalContext::getImprovementClassInfo, python::return_value_policy<python::reference_existing_object>(), "(ImprovementClassID) - CvInfo for ImprovementClassID")
