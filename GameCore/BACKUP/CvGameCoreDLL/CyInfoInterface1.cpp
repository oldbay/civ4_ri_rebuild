...
void CyInfoPythonInterface1()
{
	...
	python::class_<CvHotKeyClassInfo, python::bases<CvInfoBase> >("CvHotKeyClassInfo")
		.def("getNumActions", &CvHotKeyClassInfo::getNumActions, "int ()")
		.def("isCatchUnassigned", &CvHotKeyClassInfo::isCatchUnassigned, "bool ()")
		.def("getActions", &CvHotKeyClassInfo::getActions, "int  (int i)")
		;
	...
	python::class_<CvSpecialistInfo, python::bases<CvInfoBase> >("CvSpecialistInfo")
		...
		.def("getNumRelatedBuildingClasses", &CvSpecialistInfo::getNumRelatedBuildingClasses, "int ()")
		...
		// MOD - START - Relation Caching
		.def("getRelatedBuildingClasses", &CvTechInfo::getRelatedBuildingClasses, "int (int i)")
		// MOD - END - Relation Caching
	...
	python::class_<CvTechInfo, python::bases<CvInfoBase> >("CvTechInfo")
		...
		.def("getAheadOfTime", &CvTechInfo::getAheadOfTime, "int ()")
		.def("setAheadOfTime", &CvTechInfo::setAheadOfTime, "void (int newAheadOfTime)" )
		...
		.def("getGlobalEpidemicModifier", &CvTechInfo::getGlobalEpidemicModifier, "int ()")
		// MOD - END - Epidemics
		...
		.def("getInsideCityCongestionThresholdChange", &CvTechInfo::getInsideCityCongestionThresholdChange, "int ()")
		.def("getOutsideCityCongestionThresholdChange", &CvTechInfo::getOutsideCityCongestionThresholdChange, "int ()")
		// MOD - END - Congestion
		...
		// MOD - START - Relation Caching
		.def("getNumRelatedBonuses", &CvTechInfo::getNumRelatedBonuses, "int ()")
		.def("getNumRelatedBuilds", &CvTechInfo::getNumRelatedBuilds, "int ()")
		.def("getNumRelatedImprovements", &CvTechInfo::getNumRelatedImprovements, "int ()")
		.def("getNumRelatedUnitClasses", &CvTechInfo::getNumRelatedUnitClasses, "int ()")
		.def("getNumRelatedBuildingClasses", &CvTechInfo::getNumRelatedBuildingClasses, "int ()")
		// MOD - END - Relation Caching
		...
		// MOD - START - Relation Caching
		.def("getRelatedBonuses", &CvTechInfo::getRelatedBonuses, "int (int i)")
		.def("getRelatedBuilds", &CvTechInfo::getRelatedBuilds, "int (int i)")
		.def("getRelatedImprovements", &CvTechInfo::getRelatedImprovements, "int (int i)")
		.def("getRelatedUnitClasses", &CvTechInfo::getRelatedUnitClasses, "int (int i)")
		.def("getRelatedBuildingClasses", &CvTechInfo::getRelatedBuildingClasses, "int (int i)")
		// MOD - END - Relation Caching
		...
		.def("getAllSpecialistCommerce", &CvTechInfo::getAllSpecialistCommerce, "int (int i)") // K-Mod
	...
	python::class_<CvPromotionInfo, python::bases<CvInfoBase> >("CvPromotionInfo")
		...
		.def("getExtraBarbarianMaxXPValue", &CvPromotionInfo::getExtraBarbarianMaxXPValue, "int ()")
		// MOD - END - Advanced Experience Limits
		// MOD - START - Extra Barbarian Combat Modifier
		.def("getExtraBarbarianCombatModifier", &CvPromotionInfo::getExtraBarbarianCombatModifier, "int ()")
		// MOD - END - Extra Barbarian Combat Modifier
		.def("getKamikazePercent", &CvPromotionInfo::getKamikazePercent, "int ()")
		// MOD - START - Relation Caching
		.def("getNumRelatedDomains", &CvPromotionInfo::getNumRelatedDomains, "int ()")
		.def("getNumRelatedTerrains", &CvPromotionInfo::getNumRelatedTerrains, "int ()")
		.def("getNumRelatedFeatures", &CvPromotionInfo::getNumRelatedFeatures, "int ()")
		.def("getNumRelatedUnitCombats", &CvPromotionInfo::getNumRelatedUnitCombats, "int ()")
		.def("getNumRelatedPromotions", &CvPromotionInfo::getNumRelatedPromotions, "int ()")
		// MOD - END - Relation Caching
		...
		.def("isSpecial", &CvPromotionInfo::isSpecial, "bool ()")
		.def("isSpecialRequired", &CvPromotionInfo::isSpecialRequired, "bool ()")
		// MOD - END - Special Promotions

		// MOD - START - Temporary Promotions
		.def("isTemporary", &CvPromotionInfo::isTemporary, "bool ()")
		...
		// MOD - START - Relation Caching
		.def("getRelatedDomains", &CvPromotionInfo::getRelatedDomains, "int (int i)")
		.def("getRelatedTerrains", &CvPromotionInfo::getRelatedTerrains, "int (int i)")
		.def("getRelatedFeatures", &CvPromotionInfo::getRelatedFeatures, "int (int i)")
		.def("getRelatedUnitCombats", &CvPromotionInfo::getRelatedUnitCombats, "int (int i)")
		.def("getRelatedPromotions", &CvPromotionInfo::getRelatedPromotions, "int (int i)")
		// MOD - END - Relation Caching
		...
		.def("getFeatureDamageImmunity", &CvPromotionInfo::getFeatureDamageImmunity, "bool (int i)")
		// MOD - END - Feature Damage Immunity
		.def("getUnitCombat", &CvPromotionInfo::getUnitCombat, "bool (int i)")
		;

	// MOD - START - Aid and Detriments
	python::class_<CvAidAndDetrimentInfoBase, python::bases<CvInfoBase> >("CvAidAndDetrimentInfoBase")
		.def("isCoastalOnly", &CvAidAndDetrimentInfoBase::isCoastalOnly, "bool ()")
		.def("getRange", &CvAidAndDetrimentInfoBase::getRange, "int ()")
		;
	// MOD - END - Aid and Detriments

	// MOD - START - Aid
	python::class_<CvAidInfo, python::bases<CvAidAndDetrimentInfoBase> >("CvAidInfo")
		.def("getAidStyleType", &CvAidInfo::getAidStyleType, "int ()")

		.def("getNumSupersededAidTypes", &CvAidInfo::getNumSupersededAidTypes, "int ()")
		.def("getNumSupersededByAidTypes", &CvAidInfo::getNumSupersededByAidTypes, "int ()")
		.def("getNumPromotions", &CvAidInfo::getNumPromotions, "int ()")

		.def("getSupersededAidTypes", &CvAidInfo::getSupersededAidTypes, "int (int i)")
		.def("getSupersededByAidTypes", &CvAidInfo::getSupersededByAidTypes, "int (int i)")
		.def("getPromotions", &CvAidInfo::getPromotions, "int (int i)")
		;
	// MOD - END - Aid

	// MOD - START - Detriments
	python::class_<CvDetrimentInfo, python::bases<CvAidAndDetrimentInfoBase> >("CvDetrimentInfo")
		.def("getDetrimentStyleType", &CvDetrimentInfo::getDetrimentStyleType, "int ()")

		.def("getNumSupersededDetrimentTypes", &CvDetrimentInfo::getNumSupersededDetrimentTypes, "int ()")
		.def("getNumSupersededByDetrimentTypes", &CvDetrimentInfo::getNumSupersededByDetrimentTypes, "int ()")
		.def("getNumPromotions", &CvDetrimentInfo::getNumPromotions, "int ()")

		.def("getSupersededDetrimentTypes", &CvDetrimentInfo::getSupersededDetrimentTypes, "int (int i)")
		.def("getSupersededByDetrimentTypes", &CvDetrimentInfo::getSupersededByDetrimentTypes, "int (int i)")
		.def("getPromotions", &CvDetrimentInfo::getPromotions, "int (int i)")
		;
	// MOD - END - Detriments

	// MOD - START - Congestion
	python::class_<CvCongestionInfo, python::bases<CvInfoBase> >("CvCongestionInfo")
		.def("getNumDomains", &CvCongestionInfo::getNumDomains, "int ()")
		.def("getDomains", &CvCongestionInfo::getDomains, "int (int i)")

		.def("getMinUnits", &CvCongestionInfo::getMinUnits, "int ()")
		.def("getMaxUnits", &CvCongestionInfo::getMaxUnits, "int ()")

		.def("isDomain", &CvCongestionInfo::isDomain, "bool (int i)")
		.def("isAppliedInsideCities", &CvCongestionInfo::isAppliedInsideCities, "bool ()")
		.def("isAppliedOutsideCities", &CvCongestionInfo::isAppliedOutsideCities, "bool ()")
		.def("isApplicable", &CvCongestionInfo::isApplicable, "bool (int eDomain, bool bInsideCity)")

		.def("getPromotionType", &CvCongestionInfo::getPromotionType, "int ()")
		.def("getColorType", &CvCongestionInfo::getColorType, "int ()")
		;
	// MOD - END - Congestion
	...
	python::class_<CvActionInfo>("CvActionInfo")
		...
		// MOD - START - Improved Civilopedia
		.def("getNumHotKeyClasses", &CvActionInfo::getNumHotKeyClasses, "int ()")
		.def("getHotKeyClasses", &CvActionInfo::getHotKeyClasses, "int (int i)")
		// MOD - END - Improved Civilopedia
		...
		// MOD - START - Improved Civilopedia
		.def("getHotKeyDescription", &CvActionInfo::getHotKeyDescription, "string ()")
		// MOD - END - Improved Civilopedia
	...
	python::class_<CvUnitInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvUnitInfo")
		...
		// MOD - START - Unit AI
		.def("getMaxTechEra", &CvUnitInfo::getMaxTechEra, "int ()")
		// MOD - END - Unit AI
		...
		.def("getUnitPromoType", &CvUnitInfo::getUnitPromoType, "int ()")		
		...
		*/
		.def("getPrimaryPrereqTech", &CvUnitInfo::getPrimaryPrereqTech, "int ()")
		...
		// MOD - START - Advanced Unit Prerequisites
		.def("getNumPrereqAndBuildingClasses", &CvUnitInfo::getNumPrereqAndBuildingClasses, "int ()")
		.def("getNumPrereqOrBuildingClasses", &CvUnitInfo::getNumPrereqOrBuildingClasses, "int ()")
		.def("getNumPrereqAndTechs", &CvUnitInfo::getNumPrereqAndTechs, "int ()")
		.def("getNumPrereqAndBonuses", &CvUnitInfo::getNumPrereqAndBonuses, "int ()")
		.def("getNumPrereqOrBonuses", &CvUnitInfo::getNumPrereqOrBonuses, "int ()")
		// MOD - END - Advanced Unit Prerequisites
		// MOD - START - Relation Caching
		.def("getNumRelatedReligions", &CvUnitInfo::getNumRelatedReligions, "int ()")
		.def("getNumRelatedCivics", &CvUnitInfo::getNumRelatedCivics, "int ()")
		.def("getNumRelatedDomains", &CvUnitInfo::getNumRelatedDomains, "int ()")
		.def("getNumRelatedTerrains", &CvUnitInfo::getNumRelatedTerrains, "int ()")
		.def("getNumRelatedFeatures", &CvUnitInfo::getNumRelatedFeatures, "int ()")
		.def("getNumRelatedBonuses", &CvUnitInfo::getNumRelatedBonuses, "int ()")
		.def("getNumRelatedBuilds", &CvUnitInfo::getNumRelatedBuilds, "int ()")
		.def("getNumRelatedUnitCombats", &CvUnitInfo::getNumRelatedUnitCombats, "int ()")
		.def("getNumRelatedUnitClasses", &CvUnitInfo::getNumRelatedUnitClasses, "int ()")
		.def("getNumRelatedPromotions", &CvUnitInfo::getNumRelatedPromotions, "int ()")
		.def("getNumRelatedBuildingClasses", &CvUnitInfo::getNumRelatedBuildingClasses, "int ()")
		// MOD - END - Relation Caching
		.def("getCommandType", &CvUnitInfo::getCommandType, "int ()")

		// MOD - START - civ unique unit
		.def("isUniqueUnit", &CvUnitInfo::isUniqueUnit, "bool ()")
		// MOD - END - civ unique unit
...
/************************************************************************************************/
		...
		.def("isStrategic", &CvUnitInfo::isStrategic, "bool ()")		
		// MOD - START - Inquisition
		.def("isRemoveNonStateReligion", &CvUnitInfo::isRemoveNonStateReligion, "bool ()")
		// MOD - END - Inquisition
		...
		// Arrays
		// MOD - START - Advanced Unit Prerequisites
		.def("getPrereqAndBuildingClasses", &CvUnitInfo::getPrereqAndBuildingClasses, "int (int i)")
		.def("getPrereqOrBuildingClasses", &CvUnitInfo::getPrereqOrBuildingClasses, "int (int i)")
		.def("getPrereqAndTechs", &CvUnitInfo::getPrereqAndTechs, "int (int i)")
		.def("getPrereqAndBonuses", &CvUnitInfo::getPrereqAndBonuses, "int (int i)")
		.def("getPrereqOrBonuses", &CvUnitInfo::getPrereqOrBonuses, "int (int i)")
		// MOD - END - Advanced Unit Prerequisites
		// MOD - START - Relation Caching
		.def("getRelatedReligions", &CvUnitInfo::getRelatedReligions, "int (int i)")
		.def("getRelatedCivics", &CvUnitInfo::getRelatedCivics, "int (int i)")
		.def("getRelatedDomains", &CvUnitInfo::getRelatedDomains, "int (int i)")
		.def("getRelatedTerrains", &CvUnitInfo::getRelatedTerrains, "int (int i)")
		.def("getRelatedFeatures", &CvUnitInfo::getRelatedFeatures, "int (int i)")
		.def("getRelatedBonuses", &CvUnitInfo::getRelatedBonuses, "int (int i)")
		.def("getRelatedBuilds", &CvUnitInfo::getRelatedBuilds, "int (int i)")
		.def("getRelatedUnitCombats", &CvUnitInfo::getRelatedUnitCombats, "int (int i)")
		.def("getRelatedUnitClasses", &CvUnitInfo::getRelatedUnitClasses, "int (int i)")
		.def("getRelatedPromotions", &CvUnitInfo::getRelatedPromotions, "int (int i)")
		.def("getRelatedBuildingClasses", &CvUnitInfo::getRelatedBuildingClasses, "int (int i)")
		// MOD - END - Relation Caching
		...
		// MOD - START - Feature Damage Immunity
		.def("getFeatureDamageImmunity", &CvUnitInfo::getFeatureDamageImmunity, "bool (int i)")
		// MOD - END - Feature Damage Immunity
		...
		// MOD - START - Unit Upgrade Cache (poyuzhe)
		//.def("isUpgradeUnitClassTypes", &CvUnitInfo::isUpgradeUnitClassTypes, "bool (int i)")
		...
		.def("getStyledButton", &CvUnitInfo::getStyledButton, "string (int i)")
		// MOD - START - Unit Global Tech
		.def("getGlobalTech", &CvUnitInfo::getGlobalTech, "int ()")
	...
	python::class_<CvCivicInfo, python::bases<CvInfoBase> >("CvCivicInfo")
		...
		// MOD - START - Epidemics
		// Epidemic system by Mexico
		.def("getGlobalEpidemicModifier", &CvCivicInfo::getGlobalEpidemicModifier, "int ()")
		// MOD - END - Epidemics
		.def("getFreeExperience", &CvCivicInfo::getFreeExperience, "int ()")
		// MOD - START - Wonder production cost modifier
		.def("getWonderCostModifier", &CvCivicInfo::getWonderCostModifier, "int ()")
		...
		// MOD - START - Congestion
		.def("getInsideCityCongestionThresholdChange", &CvCivicInfo::getInsideCityCongestionThresholdChange, "int ()")
		.def("getOutsideCityCongestionThresholdChange", &CvCivicInfo::getOutsideCityCongestionThresholdChange, "int ()")
		// MOD - END - Congestion
		// MOD - START - Advanced Yield and Commerce Effects
		.def("getNumImprovementYieldChanges", &CvCivicInfo::getNumImprovementYieldChanges, "int ()")
		.def("getNumSpecialistYieldChanges", &CvCivicInfo::getNumSpecialistYieldChanges, "int ()")
		.def("getNumSpecialistCommerceChanges", &CvCivicInfo::getNumSpecialistCommerceChanges, "int ()")
		// MOD - END - Advanced Yield and Commerce Effects
		// MOD - START - Relation Caching
		.def("getNumRelatedFeatures", &CvCivicInfo::getNumRelatedFeatures, "int ()")
		.def("getNumRelatedImprovements", &CvCivicInfo::getNumRelatedImprovements, "int ()")
		.def("getNumRelatedSpecialists", &CvCivicInfo::getNumRelatedSpecialists, "int ()")
		.def("getNumRelatedUnitClasses", &CvCivicInfo::getNumRelatedUnitClasses, "int ()")
		.def("getNumRelatedBuildingClasses", &CvCivicInfo::getNumRelatedBuildingClasses, "int ()")
		// MOD - END - Relation Caching
		...
		.def("isCanAcquireHolyCityWithoutStateReligion", &CvCivicInfo::isCanAcquireHolyCityWithoutStateReligion, "bool ()")
		.def("isCanMaintainHolyCityWithoutStateReligion", &CvCivicInfo::isCanMaintainHolyCityWithoutStateReligion, "bool ()")
		...
		.def("getAllSpecialistCommerce", &CvCivicInfo::getAllSpecialistCommerce, "int (int i)")
		// MOD - END - Advanced Yield and Commerce Effects
		...
		// MOD - START - Advanced Yield and Commerce Effects
		.def("getImprovementYieldChangeImprovement", &CvCivicInfo::getImprovementYieldChangeImprovement, "int (int i)")
		.def("getImprovementYieldChangeYield", &CvCivicInfo::getImprovementYieldChangeYield, "int (int i)")
		.def("getImprovementYieldChangeValue", &CvCivicInfo::getImprovementYieldChangeValue, "int (int i)")
		.def("getSpecialistYieldChangeSpecialist", &CvCivicInfo::getSpecialistYieldChangeSpecialist, "int (int i)")
		.def("getSpecialistYieldChangeYield", &CvCivicInfo::getSpecialistYieldChangeYield, "int (int i)")
		.def("getSpecialistYieldChangeValue", &CvCivicInfo::getSpecialistYieldChangeValue, "int (int i)")
		.def("getSpecialistCommerceChangeSpecialist", &CvCivicInfo::getSpecialistCommerceChangeSpecialist, "int (int i)")
		.def("getSpecialistCommerceChangeCommerce", &CvCivicInfo::getSpecialistCommerceChangeCommerce, "int (int i)")
		.def("getSpecialistCommerceChangeValue", &CvCivicInfo::getSpecialistCommerceChangeValue, "int (int i)")
		// MOD - END - Advanced Yield and Commerce Effects
		// MOD - START - Relation Caching
		.def("getRelatedFeatures", &CvCivicInfo::getRelatedFeatures, "int (int i)") // Exposed to Python
		.def("getRelatedImprovements", &CvCivicInfo::getRelatedImprovements, "int (int i)") // Exposed to Python
		.def("getRelatedSpecialists", &CvCivicInfo::getRelatedSpecialists, "int (int i)") // Exposed to Python
		.def("getRelatedUnitClasses", &CvCivicInfo::getRelatedUnitClasses, "int (int i)") // Exposed to Python
		.def("getRelatedBuildingClasses", &CvCivicInfo::getRelatedBuildingClasses, "int (int i)") // Exposed to Python
		// MOD - END - Relation Caching
		...
		// MOD - START - Advanced Yield and Commerce Effects
		.def("getSpecialistYieldChanges", &CvCivicInfo::getSpecialistYieldChanges, "int (int i, int j)")
		.def("getSpecialistCommerceChanges", &CvCivicInfo::getSpecialistCommerceChanges, "int (int i, int j)")
		// MOD - END - Advanced Yield and Commerce Effects
		;

	// MOD - START - Unit Roles
	python::class_<CvUnitRoleInfo, python::bases<CvInfoBase> >("CvUnitRoleInfo")
		//.def("getInstanceCostModifier", &CvUnitRoleInfo::getInstanceCostModifier, "int ()")
		;
	// MOD - END - Unit Roles
	...
	python::class_<CvUnitClassInfo, python::bases<CvInfoBase> >("CvUnitClassInfo")
		...
		// MOD - START - Unit Roles
		.def("getRoleCostModifier", &CvUnitClassInfo::getRoleCostModifier, "int ()")
		// MOD - END - Unit Roles
		.def("getDefaultUnitIndex", &CvUnitClassInfo::getDefaultUnitIndex, "int ()")
		// MOD - START - Relation Caching
		.def("getRepresentativeUnit", &CvUnitClassInfo::getRepresentativeUnit, "int ()")
		// MOD - START - Aid
		.def("getNumAidTypes", &CvUnitClassInfo::getNumAidTypes, "int ()")
		// MOD - END - Aid
		// MOD - START - Detriments
		.def("getNumDetrimentTypes", &CvUnitClassInfo::getNumDetrimentTypes, "int ()")
		// MOD - END - Detriments
		// MOD - START - Relation Caching
		.def("getNumUnitTypes", &CvUnitClassInfo::getNumUnitTypes, "int ()")
		// MOD - END - Relation Caching
		// MOD - START - Unit Roles
		.def("getRoles", &CvUnitClassInfo::getRoles, "int (int i)")
		// MOD - END - Unit Roles
		// MOD - START - Aid
		.def("getAidTypes", &CvUnitClassInfo::getAidTypes, "int (int i)")
		// MOD - END - Aid
		// MOD - START - Detriments
		.def("getDetrimentTypes", &CvUnitClassInfo::getDetrimentTypes, "int (int i)")
		// MOD - END - Detriments
		// MOD - START - Relation Caching
		.def("getUnitTypes", &CvUnitClassInfo::getUnitTypes, "int (int i)")
		// MOD - END - Relation Caching
		;
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvBuildingInfo")
		...
		.def("getMaxTechEra", &CvBuildingInfo::getMaxTechEra, "int ()")
		// MOD - END - Building AI
		// MOD - START - Building Replacement
		.def("getObsoleteBuildingClass", &CvBuildingInfo::getObsoleteBuildingClass, "int ()")
		...
		.def("getDiscontinueTech", &CvBuildingInfo::getDiscontinueTech, "int ()")
		// MOD - END - Building Discontinuation
		/*
		.def("getPrereqAndTech", &CvBuildingInfo::getPrereqAndTech, "int ()")
		*/
		.def("getPrimaryPrereqTech", &CvBuildingInfo::getPrimaryPrereqTech, "int ()")
		...
		.def("getNumPrereqAndBonuses", &CvBuildingInfo::getNumPrereqAndBonuses, "int ()")
		.def("getNumPrereqOrBonuses", &CvBuildingInfo::getNumPrereqOrBonuses, "int ()")
		.def("getNumPrereqGlobalBuildingClasses", &CvBuildingInfo::getNumPrereqGlobalBuildingClasses, "int ()")
		...
		.def("getNumConsumedBonuses", &CvBuildingInfo::getNumConsumedBonuses, "int ()")
		.def("getNumProducedBonuses", &CvBuildingInfo::getNumProducedBonuses, "int ()")
		...
		*/
		...
		.def("isGlobalUnlimitedConscript", &CvBuildingInfo::isGlobalUnlimitedConscript, "bool ()")
		// MOD - END - Unlimited Conscription
		// MOD - START - Bonus Converters
		.def("isBonusConverter", &CvBuildingInfo::isBonusConverter, "bool ()")
		// MOD - END - Bonus Converters
		// MOD - START - Wartime Conscription
		.def("getWarConscript", &CvBuildingInfo::getWarConscript, "int ()")
		.def("getGlobalWarConscript", &CvBuildingInfo::getGlobalWarConscript, "int ()")
		// MOD - END - Wartime Conscription
		.def("getHealRateChange", &CvBuildingInfo::getHealRateChange, "int ()")
		// MOD - START - Revolutions (separatism)
		.def("getSeparatism", &CvBuildingInfo::getSeparatism, "int ()")
		.def("getGlobalSeparatism", &CvBuildingInfo::getGlobalSeparatism, "int ()")
		...
		// MOD - START - Epidemics
		// Epidemic system by Mexico
		.def("getEpidemicModifier", &CvBuildingInfo::getEpidemicModifier, "int ()")
		.def("getGlobalEpidemicModifier", &CvBuildingInfo::getGlobalEpidemicModifier, "int ()")
		// MOD - END - Epidemics
		...
		// MOD - START - Relation Caching
		.def("getNumBuilderUnitClasses", &CvBuildingInfo::getNumBuilderUnitClasses, "int ()")
		.def("getNumBuilderUnits", &CvBuildingInfo::getNumBuilderUnits, "int ()")
		.def("getNumRelatedReligions", &CvBuildingInfo::getNumRelatedReligions, "int ()")
		.def("getNumRelatedCivics", &CvBuildingInfo::getNumRelatedCivics, "int ()")
		.def("getNumRelatedBonuses", &CvBuildingInfo::getNumRelatedBonuses, "int ()")
		.def("getNumRelatedImprovements", &CvBuildingInfo::getNumRelatedImprovements, "int ()")
		.def("getNumRelatedSpecialists", &CvBuildingInfo::getNumRelatedSpecialists, "int ()")
		.def("getNumRelatedUnitCombats", &CvBuildingInfo::getNumRelatedUnitCombats, "int ()")
		.def("getNumRelatedUnitClasses", &CvBuildingInfo::getNumRelatedUnitClasses, "int ()")
		.def("getNumRelatedBuildingClasses", &CvBuildingInfo::getNumRelatedBuildingClasses, "int ()")
		// MOD - END - Relation Caching

		// MOD - START - Congestion
		.def("getInsideCityCongestionThresholdChange", &CvBuildingInfo::getInsideCityCongestionThresholdChange, "int ()")
		.def("getOutsideCityCongestionThresholdChange", &CvBuildingInfo::getOutsideCityCongestionThresholdChange, "int ()")
		// MOD - END - Congestion
		
		// MOD - START - civ unique building
		.def("isUniqueBuilding", &CvBuildingInfo::isUniqueBuilding, "bool ()")
		// MOD - END - civ unique building
		// MOD - START - Great Works
		.def("isGreatWork", &CvBuildingInfo::isGreatWork, "bool ()")
		// MOD - END - Great Works
		// MOD - START - Military Disciplines
		.def("isMilitaryDiscipline", &CvBuildingInfo::isMilitaryDiscipline, "bool ()")
		.def("isMilitaryDoctrine", &CvBuildingInfo::isMilitaryDoctrine, "bool ()")
		.def("isMilitaryTradition", &CvBuildingInfo::isMilitaryTradition, "bool ()")
		...
		*/
		.def("isPrereqNoReligion", &CvBuildingInfo::isPrereqNoReligion, "bool ()")
		...
		.def("isInactiveWithoutPower", &CvBuildingInfo::isInactiveWithoutPower, "bool ()")
		// MOD - END - Advanced Building Prerequisites (Power)
		// MOD - START - Advanced Building Prerequisites (Religion)
		.def("isInactiveWithoutPrereqStateReligion", &CvBuildingInfo::isInactiveWithoutPrereqStateReligion, "bool ()")
		// MOD - END - Advanced Building Prerequisites (Religion)
		...
		.def("getPrereqAndCivics", &CvBuildingInfo::getPrereqAndCivics, "int (int i)")
		.def("getPrereqOrBonuses", &CvBuildingInfo::getPrereqOrBonuses, "int (int i)")
		.def("getPrereqGlobalBuildingClasses", &CvBuildingInfo::getPrereqGlobalBuildingClasses, "int (int i)")
		.def("getPrereqGlobalBuildingCounts", &CvBuildingInfo::getPrereqGlobalBuildingCounts, "int (int i)")
		.def("getPrereqAndBuildingClasses", &CvBuildingInfo::getPrereqAndBuildingClasses, "int (int i)")
		// MOD - END - Advanced Building Prerequisites
		...
		.def("getDomainHealRateChanges", &CvBuildingInfo::getDomainHealRateChanges, "int (int i)")
		.def("getUnitClassHealRateChanges", &CvBuildingInfo::getUnitClassHealRateChanges, "int (int i)")
		.def("getUnitCombatHealRateChanges", &CvBuildingInfo::getUnitCombatHealRateChanges, "int (int i)")
		...
		// MOD - START - Bonus Converters
		.def("getConsumedBonusType", &CvBuildingInfo::getConsumedBonusType, "int (int i)")
		.def("getConsumedBonusAmount", &CvBuildingInfo::getConsumedBonusAmount, "int (int i)")
		.def("getConsumedBonusIndex", &CvBuildingInfo::getConsumedBonusIndex, "int (int i)")
		.def("getProducedBonusType", &CvBuildingInfo::getProducedBonusType, "int (int i)")
		.def("getProducedBonusAmount", &CvBuildingInfo::getProducedBonusAmount, "int (int i)")
		.def("getProducedBonusIndex", &CvBuildingInfo::getProducedBonusIndex, "int (int i)")
		// MOD - END - Bonus Converters
		// MOD - START - Relation Caching
		.def("getBuilderUnitClasses", &CvBuildingInfo::getBuilderUnitClasses, "int (int i)")
		.def("getBuilderUnits", &CvBuildingInfo::getBuilderUnits, "int (int i)")
		.def("getRelatedReligions", &CvBuildingInfo::getRelatedReligions, "int (int i)")
		.def("getRelatedCivics", &CvBuildingInfo::getRelatedCivics, "int (int i)")
		.def("getRelatedBonuses", &CvBuildingInfo::getRelatedBonuses, "int (int i)")
		.def("getRelatedImprovements", &CvBuildingInfo::getRelatedImprovements, "int (int i)")
		.def("getRelatedSpecialists", &CvBuildingInfo::getRelatedSpecialists, "int (int i)")
		.def("getRelatedUnitCombats", &CvBuildingInfo::getRelatedUnitCombats, "int (int i)")
		.def("getRelatedUnitClasses", &CvBuildingInfo::getRelatedUnitClasses, "int (int i)")
		.def("getRelatedBuildingClasses", &CvBuildingInfo::getRelatedBuildingClasses, "int (int i)")
		// MOD - END - Relation Caching
		...
		// MOD - START - Bonus Converters
		.def("isConsumerOfBonus", &CvBuildingInfo::isConsumerOfBonus, "bool (int i)")
		.def("isProducerOfBonus", &CvBuildingInfo::isProducerOfBonus, "bool (int i)")
		// MOD - END - Bonus Converters
		// MOD - START - Advanced Building Prerequisites (Civic)
		...
		.def("getUnitCombatDefenseModifier", &CvBuildingInfo::getUnitCombatDefenseModifier, "int (int i)")
		.def("getUnitClassDefenseModifier", &CvBuildingInfo::getUnitClassDefenseModifier, "int (int i)")
