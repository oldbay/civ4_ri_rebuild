...
/************************************************************************************************/
	...
	void setFlagDecal(std::wstring szFlagDecal, bool bUpdate);
...
/*************************************************************************************************/
	...
	bool isWhiteFlag();
	void setWhiteFlag(bool bNewValue);
	...
	int countRemoveNonStateReligionUnits(CyArea* pArea, int /*ReligionTypes*/ eReligion);
	// MOD - END - Inquisition
	...
	int getCurrentResearchTechTransferCount();
	bool isCurrentResearchTechTransfer();
	...
	// MOD - START - Epidemics
	int getAcceptableEpidemicPercent() const;
	void setAcceptableEpidemicPercent(int iNewValue);
	void changeAcceptableEpidemicPercent(int iNewValue);
	...
	int getHandicapScoreModifier();
	void setHandicapScoreModifier(int iModifier);
	...
	int getAllSpecialistCommerceChange(CommerceTypes eIndex);
	...
	int getUnitRoleCostModifier(int /*UnitRoleTypes*/ eIndex);
	int getUnitRoleCount(int /*UnitRoleTypes*/ eIndex);
	bool isUnitRoleMaxedOut(int /*UnitRoleTypes*/ eIndex, int iExtra);
	int getUnitRoleMaking(int /*UnitRoleTypes*/ eIndex);
	int getUnitRoleCountPlusMaking(int /*UnitRoleTypes*/ eIndex);
	// MOD - END - Unit Roles
	...
	bool canAcquireHolyCity(int /*ReligionTypes*/ eIndex);
	bool canMaintainHolyCity(int /*ReligionTypes*/ eIndex);
	...
	int getSpecialistYieldChange(int /*SpecialistTypes*/ eIndex1, int /*YieldTypes*/ eIndex2);
	// MOD - END - Advanced Yield and Commerce Effects
	...
	int getTechPathLength(int /*TechTypes*/ eTech);
	int getTechPathCost(int /*TechTypes*/ eTech);
