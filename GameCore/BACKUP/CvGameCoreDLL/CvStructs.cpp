...
void BuildingClassCount::read(FDataStreamBase* pStream)
{
	pStream->Read((int*)&eBuildingClass);
	pStream->Read(&iCount);
}

void BuildingClassCount::write(FDataStreamBase* pStream)
{
...
/*
void BonusYieldChange::read(FDataStreamBase* pStream)
{
...
void BonusYieldChange::write(FDataStreamBase* pStream)
{
...
void BonusYieldModifier::read(FDataStreamBase* pStream)
{
	pStream->Read((int*)&eBonus);
	pStream->Read((int*)&eYield);
...
void BonusYieldModifier::write(FDataStreamBase* pStream)
{
	pStream->Write(eBonus);
	pStream->Write(eYield);
	pStream->Write(iModifier);
}

void SpecialistYieldChange::read(FDataStreamBase* pStream)
{
	pStream->Read((int*)&eSpecialist);
	pStream->Read((int*)&eYield);
	pStream->Read(&iChange);
}

void SpecialistYieldChange::write(FDataStreamBase* pStream)
{
	pStream->Write(eSpecialist);
	pStream->Write(eYield);
	pStream->Write(iChange);
}

void SpecialistCommerceChange::read(FDataStreamBase* pStream)
{
	pStream->Read((int*)&eSpecialist);
...
void SpecialistCommerceChange::write(FDataStreamBase* pStream)
{
	pStream->Write(eSpecialist);
...
void ImprovementYieldChange::read(FDataStreamBase* pStream)
{
...
void ImprovementYieldChange::write(FDataStreamBase* pStream)
{
	pStream->Write(eImprovement);
	pStream->Write(eYield);
	pStream->Write(iChange);
}
...
void CvBonusAmount::read(FDataStreamBase* pStream)
{
	pStream->Read((int*)&m_eBonus);
	pStream->Read(&m_iAmount);
}

void CvBonusAmount::write(FDataStreamBase* pStream) const
{
	pStream->Write(m_eBonus);
	pStream->Write(m_iAmount);
}


void CvBonusAmountChange::read(FDataStreamBase* pStream)
{
	pStream->Read((int*)&m_eBonus);
	pStream->Read(&m_iChange);
}

void CvBonusAmountChange::write(FDataStreamBase* pStream) const
{
	pStream->Write(m_eBonus);
...
void CvDerivativeCivData::read(FDataStreamBase* pStream)
{
	pStream->Read((int*)&m_eCivilization);
	pStream->Read((int*)&m_eMinEra);
	pStream->Read(&m_iWeight);
}

void CvDerivativeCivData::write(FDataStreamBase* pStream) const
{
	pStream->Write(m_eCivilization);
	pStream->Write(m_eMinEra);
	pStream->Write(m_iWeight);
}
