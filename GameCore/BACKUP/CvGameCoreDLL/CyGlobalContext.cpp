...
CvImprovementClassInfo* CyGlobalContext::getImprovementClassInfo(int /*ImprovementClassTypes*/ i) const
{
...
CvUnitRoleInfo* CyGlobalContext::getUnitRoleInfo(int i) const
{
	return (i >= 0 && i<GC.getNumUnitRoleInfos()) ? &GC.getUnitRoleInfo((UnitRoleTypes)i) : NULL;
}
// MOD - END - Unit Roles
...
CvDomainInfo* CyGlobalContext::getDomainInfo(int i) const
// MOD - END - Congestion
{
...
// MOD - START - Aid
CvAidInfo* CyGlobalContext::getAidInfo(int i) const
{
	return (i>=0 && i<GC.getNumAidInfos()) ? &GC.getAidInfo((AidTypes) i) : NULL;
}
// MOD - END - Aid

// MOD - START - Detriments
CvDetrimentInfo* CyGlobalContext::getDetrimentInfo(int i) const
{
	return (i>=0 && i<GC.getNumDetrimentInfos()) ? &GC.getDetrimentInfo((DetrimentTypes) i) : NULL;
}
// MOD - END - Detriments

// MOD - START - Congestion
CvCongestionInfo* CyGlobalContext::getCongestionInfo(int i) const
{
	return (i>=0 && i<GC.getNumCongestionInfos()) ? &GC.getCongestionInfo((CongestionTypes) i) : NULL;
}
// MOD - END - Congestion
...
CvHotKeyClassInfo* CyGlobalContext::getHotKeyClassInfo(int i) const
{
	return ((i >= 0 && i < GC.getNumHotKeyClassInfos()) ? &GC.getHotKeyClassInfo((HotKeyClassTypes)i) : NULL);
}
...
CvGameEventInfo* CyGlobalContext::getGameEventInfo(int i) const
{
	return (i>=0 && i<GC.getNumGameEventInfos()) ? &GC.getGameEventInfo((GameEventTypes)i) : NULL;
}
// MOD - END - Core Game Events


// MOD - START - Population Metrics
CvInfoBase* CyGlobalContext::getContributionInfo(int i) const
{
	return (i>=0 && i<GC.getNumContributionInfos()) ? &GC.getContributionInfo((ContributionTypes)i) : NULL;
}


CvSocialStabilityInfo* CyGlobalContext::getSocialStabilityInfo(int i) const
{
	return (i>=0 && i<GC.getNumSocialStabilityInfos()) ? &GC.getSocialStabilityInfo((SocialStabilityTypes)i) : NULL;
}


CvMetricClassInfo* CyGlobalContext::getMetricClassInfo(int i) const
{
	return (i>=0 && i<GC.getNumMetricClassInfos()) ? &GC.getMetricClassInfo((MetricClassTypes)i) : NULL;
}


CvMetricInfo* CyGlobalContext::getMetricInfo(int i) const
{
	return (i>=0 && i<GC.getNumMetricInfos()) ? &GC.getMetricInfo((MetricTypes)i) : NULL;
}


CvMetricFactorInfo* CyGlobalContext::getMetricFactorInfo(int i) const
{
	return (i>=0 && i<GC.getNumMetricFactorInfos()) ? &GC.getMetricFactorInfo((MetricFactorTypes)i) : NULL;
}
...
void CyGlobalContext::setGraphicOptionGraphicalPaging(bool bEnabled)
{
	GC.setGraphicOptionGraphicalPaging(bEnabled);
}
