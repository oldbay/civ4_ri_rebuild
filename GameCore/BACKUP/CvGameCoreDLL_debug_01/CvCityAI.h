...
public:
	...
	int AI_getPotentialSpecialistEstimate(SpecialistTypes eSpecialist) const;
	...
	UnitTypes AI_bestUnitAI(UnitAITypes eUnitAI, bool bAsync = false, AdvisorTypes eIgnoreAdvisor = NO_ADVISOR, bool bIgnoreUnitFoodConsumption = false);
	...
	int AI_buildingValue(BuildingTypes eBuilding, int iFocusFlags = 0, int iThreshold = 0, bool bConstCache = false, bool bAllowRecursion = true, CivicTypes eCivic = NO_CIVIC) const;
	// MOD - END - Advanced Yield and Commerce Effects
...
/********************************************************************************/
	...
	int AI_neededFortifications() const;
	...
	int AI_getEmphasizeAvoidUnhappyCount() const;
	bool AI_isEmphasizeAvoidUnhappy() const;

	int AI_getEmphasizeAvoidUnhealthCount() const;
	bool AI_isEmphasizeAvoidUnhealth() const;

	int AI_getEmphasizeAvoidEpidemicsCount() const;
	bool AI_isEmphasizeAvoidEpidemics() const;
	...
	int AI_getSeaWorkersHave();
	int AI_getSeaWorkersNeeded();
	void AI_changeSeaWorkersHave(int iChange);
...
protected:
	...
	// MOD - START - City Growth Limits
	int m_iEmphasizeAvoidUnhappyCount;
	int m_iEmphasizeAvoidUnhealthCount;
	int m_iEmphasizeAvoidEpidemicsCount;
	// MOD - END - City Growth Limits
	...
	int m_iWorkersHave;
	// MOD - START - Sea Improvements
	int m_iSeaWorkersNeeded;
	int m_iSeaWorkersHave;
	// MOD - END - Sea Improvements
