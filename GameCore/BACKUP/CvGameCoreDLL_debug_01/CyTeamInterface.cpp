...
void CyTeamPythonInterface()
{
	...
	python::class_<CyTeam>("CyTeam")
		...
		.def("getUnitRoleMaking", &CyTeam::getUnitRoleMaking, "int (int (UnitRoleTypes) eUnitRole)")
		.def("getUnitRoleCountPlusMaking", &CyTeam::getUnitRoleCountPlusMaking, "int (int (UnitRoleTypes) eUnitRole)")
		// MOD - END - Unit Roles
		...
		.def("getTechTransferCount", &CyTeam::getTechTransferCount, "int (TechID)")
		.def("isTechTransfer", &CyTeam::isTechTransfer, "bool (TechID)")
		...
		.def("getInsideCityCongestionThreshold", &CyTeam::getInsideCityCongestionThreshold, "int ()")
		.def("getOutsideCityCongestionThreshold", &CyTeam::getOutsideCityCongestionThreshold, "int ()")
		// MOD - END - Congestion
		// MOD - START - Cached Team Members
		.def("getNumLivingTeamMembers", &CyTeam::getNumLivingTeamMembers, "int ()")
		.def("getLivingTeamMember", &CyTeam::getLivingTeamMember, "int (int iMember)")
