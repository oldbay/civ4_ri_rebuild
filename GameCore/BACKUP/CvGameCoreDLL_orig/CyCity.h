...
public:
	...
	int getBonusEpidemicModifier(int /*BonusTypes*/ iBonus);
	// MOD - END - Epidemics
	...
	long getGreatPeopleRate();
	long getTrueGreatPeopleRate();	
	...
	void changeActualBaseYieldRate(int /*YieldTypes*/ eIndex, int iNewValue);
	...
	int getDomainHealRate(int /*DomainTypes*/ eIndex);
	int getUnitClassHealRate(int /*UnitClassTypes*/ eIndex);
	int getUnitCombatHealRate(int /*UnitCombatTypes*/ eIndex);
	...
	int getEpidemicProbabilityPercent();
	int getEpidemicProbability();
	// MOD - END - Epidemics

	// MOD - START - City Growth Limits
	bool isGrowthAllowed() const;
	...
	int getMetricValue(int /*MetricTypes*/ eMetric) const; // Exposed to Python
	void setMetricValue(int /*MetricTypes*/ eMetric, int iValue); // Exposed to Python
	void changeMetricValue(int /*MetricTypes*/ eMetric, int iChange); // Exposed to Python

	int getMetricTurnValue(int /*MetricTypes*/ eMetric, int iTurn) const; // Exposed to Python
	int getMetricMinValue(int /*MetricTypes*/ eMetric) const; // Exposed to Python
	int getMetricMaxValue(int /*MetricTypes*/ eMetric) const; // Exposed to Python
