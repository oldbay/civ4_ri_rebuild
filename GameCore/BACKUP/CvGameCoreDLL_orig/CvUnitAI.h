...
// Dale - FE: Fighters START
	bool AI_fighterEngage();
// Dale - FE: Fighters END
	// MOD - START - Ranged Strike AI
	CvPlot* AI_rangeStrikeTargetPlot(int iSearchRange) const;
	bool AI_rangeAttack(int iFlags = 0, bool bAppend = false, bool bManual = false, MissionAITypes eMissionAI = NO_MISSIONAI, CvPlot* pMissionAIPlot = NULL, CvUnit* pMissionAIUnit = NULL);
	bool AI_rangeAttackCity();
	bool AI_rangeAttackOrSkip(int iFlags = 0, bool bAppend = false, bool bManual = false, MissionAITypes eMissionAI = NO_MISSIONAI, CvPlot* pMissionAIPlot = NULL, CvUnit* pMissionAIUnit = NULL);
	bool AI_rangeAttackOrFortify(int iFlags = 0, bool bAppend = false, bool bManual = false, MissionAITypes eMissionAI = NO_MISSIONAI, CvPlot* pMissionAIPlot = NULL, CvUnit* pMissionAIUnit = NULL);
	...
	// MOD - START - Inquisition
	bool AI_specialSeaTransportInquisitor();
	// MOD - END - Inquisition
