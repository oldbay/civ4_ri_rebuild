...
void CyGameCoreUtilsPythonInterface()
{
	...
	python::def("packByteID", cyPackByteID1, "int (int iData1)");
	python::def("packByteID", cyPackByteID2, "int (int iData1, int iData2)");
	python::def("packByteID", cyPackByteID3, "int (int iData1, int iData2, int iData3)");
	python::def("packByteID", cyPackByteID4, "int (int iData1, int iData2, int iData3, int iData4)");

	python::def("packWordID", cyPackWordID1, "int (int iData1)");
	python::def("packWordID", cyPackWordID2, "int (int iData1, int iData2)");

	python::def("getPackedByteID", cyGetPackedByteID1, "int (int iPackedData)");
	python::def("getPackedByteID", cyGetPackedByteID2, "int (int iPackedData)");
	python::def("getPackedByteID", cyGetPackedByteID3, "int (int iPackedData)");
	python::def("getPackedByteID", cyGetPackedByteID4, "int (int iPackedData)");

	python::def("getPackedWordID", cyGetPackedWordID1, "int (int iPackedData)");
	python::def("getPackedWordID", cyGetPackedWordID2, "int (int iPackedData)");
	// MOD - END - Widget Data Packing

	// MOD - START - Improved Civilopedia
	python::def("doPediaLink", cyDoPediaLink, "void (string)");
