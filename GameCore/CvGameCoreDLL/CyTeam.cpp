...
int CyTeam::getUnitRoleMaking(int /*UnitRoleTypes*/ eUnitRole)
{
	return m_pTeam ? m_pTeam->getUnitRoleMaking((UnitRoleTypes)eUnitRole) : -1;
}

int CyTeam::getUnitRoleCountPlusMaking(int /*UnitRoleTypes*/ eUnitRole)
{
	return m_pTeam ? m_pTeam->getUnitRoleCountPlusMaking((UnitRoleTypes)eUnitRole) : -1;
}
// MOD - END - Unit Roles
...
// MOD - START - Unit Roles
int CyTeam::getUnitRoleCount(int /*UnitRoleTypes*/ eIndex)
{
	return m_pTeam ? m_pTeam->getUnitRoleCount((UnitRoleTypes)eIndex) : -1;
}
// MOD - END - Unit Roles
...
int CyTeam::getTechTransferCount(int /*TechTypes*/ eIndex)
{
	return m_pTeam ? m_pTeam->getTechTransferCount((TechTypes)eIndex) : -1;
}

bool CyTeam::isTechTransfer(int /*TechTypes*/ eIndex)
{
	return m_pTeam ? m_pTeam->isTechTransfer((TechTypes)eIndex) : false;
}
...
int CyTeam::getImprovementIrrigatedYieldChange(int /*ImprovementTypes*/ eImprovement, int /*YieldTypes*/ eYield)
{
	return m_pTeam ? m_pTeam->getImprovementIrrigatedYieldChange((ImprovementTypes)eImprovement, (YieldTypes)eYield) : -1;
}

void CyTeam::changeImprovementIrrigatedYieldChange(int /*ImprovementTypes*/ eImprovement, int /*YieldTypes*/ eYield, int iChange)
{
	if (m_pTeam)
		m_pTeam->changeImprovementIrrigatedYieldChange((ImprovementTypes)eImprovement, (YieldTypes)eYield, iChange);
}
...
int CyTeam::getInsideCityCongestionThreshold() const
{
	return m_pTeam ? m_pTeam->getInsideCityCongestionThreshold() : -1;
}

int CyTeam::getOutsideCityCongestionThreshold() const
{
	return m_pTeam ? m_pTeam->getOutsideCityCongestionThreshold() : -1;
}
// MOD - END - Congestion

// MOD - START - Cached Team Members
int CyTeam::getNumLivingTeamMembers() const
{
	return m_pTeam ? m_pTeam->getNumLivingTeamMembers() : -1;
}

int CyTeam::getLivingTeamMember(int iMember) const
{
	return m_pTeam ? m_pTeam->getLivingTeamMember(iMember) : -1;
}
