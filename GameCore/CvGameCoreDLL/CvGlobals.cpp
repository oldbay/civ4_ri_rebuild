...
m_iNumBuildingClassesRequiringPower(0),
m_iNumBuildingClassesInactiveWithoutPower(0),
// MOD - END - Advanced Building Prerequisites (Power)
// MOD - START - Advanced Building Prerequisites (Religion)
m_iNumBuildingClassesInactiveWithoutPrereqStateReligion(0),
// MOD - END - Advanced Building Prerequisites (Religion)
// MOD - START - Advanced Building Prerequisites (Power)
m_piBuildingClassesRequiringPower(NULL),
m_piBuildingClassesInactiveWithoutPower(NULL),
// MOD - END - Advanced Building Prerequisites (Power)
// MOD - START - Advanced Building Prerequisites (Religion)
m_piBuildingClassesInactiveWithoutPrereqStateReligion(NULL),
// MOD - END - Advanced Building Prerequisites (Religion)
...
// MOD - START - Improved Civilopedia
int CvGlobals::getNumHotKeyClassInfos() const
{
	return (int)m_paHotKeyClassInfos.size();
}

std::vector<CvHotKeyClassInfo*>& CvGlobals::getHotKeyClassInfo()
{
	return m_paHotKeyClassInfos;
}

CvHotKeyClassInfo& CvGlobals::getHotKeyClassInfo(HotKeyClassTypes eHotKeyClass)
{
	FASSERT_BOUNDS(0, getNumHotKeyClassInfos(), eHotKeyClass, "CvGlobals::getHotKeyClassInfo");
	return *(m_paHotKeyClassInfos[eHotKeyClass]);
}
// MOD - END - Improved Civilopedia
...
CvDomainInfo& CvGlobals::getDomainInfo(DomainTypes e)
// MOD - END - Congestion
{
	FAssert(e > -1);
...
int CvGlobals::getNumGraphicOptionInfos() const
{
	return (int)m_paGraphicOptionInfos.size();
}
...
CvGraphicOptionInfo& CvGlobals::getGraphicOptionInfo(GraphicOptionTypes eGraphicOptionNum)
{
	...
	FASSERT_BOUNDS(0, getNumGraphicOptionInfos(), eGraphicOptionNum, "CvGlobals::getGraphicOptionInfo");
	// MOD - END - Graphical Paging
...
std::vector<CvImprovementClassInfo*>& CvGlobals::getImprovementClassInfo()
{
	return m_paImprovementClassInfo;
}

CvImprovementClassInfo& CvGlobals::getImprovementClassInfo(ImprovementClassTypes eImprovementClassNum)
{
	FAssert(eImprovementClassNum > -1);
	FAssert(eImprovementClassNum < GC.getNumImprovementClassInfos());
	return *(m_paImprovementClassInfo[eImprovementClassNum]);
}
...
// MOD - START - Attribute Caching
// MOD - START - Advanced Building Prerequisites (Power)
BuildingClassTypes CvGlobals::getBuildingClassesRequiringPower(int iMem) const
{
	FASSERT_BOUNDS(0, getNumBuildingClassesRequiringPower(), iMem, "CvGlobals::getBuildingClassesRequiringPower");
	return m_piBuildingClassesRequiringPower[iMem];
}

BuildingClassTypes CvGlobals::getBuildingClassesInactiveWithoutPower(int iMem) const
{
	FASSERT_BOUNDS(0, getNumBuildingClassesInactiveWithoutPower(), iMem, "CvGlobals::getBuildingClassesInactiveWithoutPower");
	return m_piBuildingClassesInactiveWithoutPower[iMem];
}
// MOD - END - Advanced Building Prerequisites (Power)

BuildingClassTypes CvGlobals::getBuildingClassesInactiveWithoutStateRelgion(int iMem) const
{
	FASSERT_BOUNDS(0, getNumBuildingClassesInactiveWithoutPrereqStateReligion(), iMem, "CvGlobals::getBuildingClassesInactiveWithoutStateRelgion");
	return m_piBuildingClassesInactiveWithoutPrereqStateReligion[iMem];
}
// MOD - END - Attribute Caching
...
int CvGlobals::getNumUnitRoleInfos()
{
	return (int)m_paUnitRoleInfo.size();
}

std::vector<CvUnitRoleInfo*>& CvGlobals::getUnitRoleInfo()	// For Moose - XML Load Util, CvInfos
{
	return m_paUnitRoleInfo;
}

CvUnitRoleInfo& CvGlobals::getUnitRoleInfo(UnitRoleTypes eUnitRoleNum)
{
	FAssert(eUnitRoleNum > -1);
	FAssert(eUnitRoleNum < GC.getNumUnitRoleInfos());
	return *(m_paUnitRoleInfo[eUnitRoleNum]);
}
// MOD - END - Unit Roles
...
// MOD - START - Aid
std::vector<CvInfoBase*>& CvGlobals::getAidStyleInfo()		// For Moose - XML Load Util, CvInfos
{
	return m_paAidStyleInfo;
}

CvInfoBase& CvGlobals::getAidStyleInfo(AidStyleTypes eAidStyleType)
{
	FASSERT_BOUNDS(0, NUM_AIDSTYLE_TYPES, eAidStyleType, "CvGlobals::getAidStyleInfo");
	return *(m_paAidStyleInfo[eAidStyleType]);
}

int CvGlobals::getNumAidInfos() const
{
	return (int)m_paAidInfo.size();
}

std::vector<CvAidInfo*>& CvGlobals::getAidInfo()	// For Moose - XML Load Util, CvInfos
{
	return m_paAidInfo;
}

CvAidInfo& CvGlobals::getAidInfo(AidTypes eAidType)
{
	FASSERT_BOUNDS(0, GC.getNumAidInfos(), eAidType, "CvGlobals::getAidInfo");
	return *(m_paAidInfo[eAidType]);
}
// MOD - END - Aid

// MOD - START - Detriments
std::vector<CvInfoBase*>& CvGlobals::getDetrimentStyleInfo()	// For Moose - XML Load Util, CvInfos
{
	return m_paDetrimentStyleInfo;
}

CvInfoBase& CvGlobals::getDetrimentStyleInfo(DetrimentStyleTypes eDetrimentStyleType)
{
	FASSERT_BOUNDS(0, NUM_DETRIMENTSTYLE_TYPES, eDetrimentStyleType, "CvGlobals::getDetrimentStyleInfo");
	return *(m_paDetrimentStyleInfo[eDetrimentStyleType]);
}

int CvGlobals::getNumDetrimentInfos() const
{
	return (int)m_paDetrimentInfo.size();
}

std::vector<CvDetrimentInfo*>& CvGlobals::getDetrimentInfo()	// For Moose - XML Load Util, CvInfos
{
	return m_paDetrimentInfo;
}

CvDetrimentInfo& CvGlobals::getDetrimentInfo(DetrimentTypes eDetrimentType)
{
	FASSERT_BOUNDS(0, GC.getNumDetrimentInfos(), eDetrimentType, "CvGlobals::getDetrimentInfo");
	return *(m_paDetrimentInfo[eDetrimentType]);
}
// MOD - END - Detriments

// MOD - START - Congestion
int CvGlobals::getNumCongestionInfos() const
{
	return (int)m_paCongestionInfo.size();
}

std::vector<CvCongestionInfo*>& CvGlobals::getCongestionInfo()
{
	return m_paCongestionInfo;
}

CvCongestionInfo& CvGlobals::getCongestionInfo(CongestionTypes eCongestionType)
{
	FASSERT_BOUNDS(0, GC.getNumCongestionInfos(), eCongestionType, "CvGlobals::getCongestionInfo");
	return *(m_paCongestionInfo[eCongestionType]);
}
// MOD - END - Congestion
...
int CvGlobals::getNumGameEventInfos() const
{
	return (int)m_paGameEventInfos.size();
}

std::vector<CvGameEventInfo*>& CvGlobals::getGameEventInfo()
{
	return m_paGameEventInfos;
}

CvGameEventInfo& CvGlobals::getGameEventInfo(GameEventTypes eGameEvent)
{
	FASSERT_BOUNDS(0, getNumGameEventInfos(), eGameEvent, "CvGlobals::getGameEventInfo");
	return *(m_paGameEventInfos[eGameEvent]);
}
// MOD - END - Core Game Events

// MOD - START - Population Metrics
int CvGlobals::getNumContributionInfos() const
{
	return (int)m_paContributionInfo.size();
}

std::vector<CvInfoBase*>& CvGlobals::getContributionInfo()
{
	return m_paContributionInfo;
}

CvInfoBase& CvGlobals::getContributionInfo(ContributionTypes eContribution)
{
	FASSERT_BOUNDS(0, getNumContributionInfos(), eContribution, "CvGlobals::getContributionInfo");
	return *(m_paContributionInfo[eContribution]);
}

int CvGlobals::getNumSocialStabilityInfos() const
{
	return (int)m_paSocialStabilityInfo.size();
}

std::vector<CvSocialStabilityInfo*>& CvGlobals::getSocialStabilityInfo()
{
	return m_paSocialStabilityInfo;
}

CvSocialStabilityInfo& CvGlobals::getSocialStabilityInfo(SocialStabilityTypes eSocialStability)
{
	FASSERT_BOUNDS(0, getNumSocialStabilityInfos(), eSocialStability, "CvGlobals::getSocialStabilityInfo");
	return *(m_paSocialStabilityInfo[eSocialStability]);
}

int CvGlobals::getNumMetricClassInfos() const
{
	return (int)m_paMetricClassInfo.size();
}

std::vector<CvMetricClassInfo*>& CvGlobals::getMetricClassInfo()
{
	return m_paMetricClassInfo;
}

CvMetricClassInfo& CvGlobals::getMetricClassInfo(MetricClassTypes eMetricClass)
{
	FASSERT_BOUNDS(0, getNumMetricClassInfos(), eMetricClass, "CvGlobals::getMetricClassInfo");
	return *(m_paMetricClassInfo[eMetricClass]);
}

int CvGlobals::getNumMetricInfos() const
{
	return (int)m_paMetricInfo.size();
}

std::vector<CvMetricInfo*>& CvGlobals::getMetricInfo()
{
	return m_paMetricInfo;
}

CvMetricInfo& CvGlobals::getMetricInfo(MetricTypes eMetric)
{
	FASSERT_BOUNDS(0, getNumMetricInfos(), eMetric, "CvGlobals::getMetricInfo");
	return *(m_paMetricInfo[eMetric]);
}

int CvGlobals::getNumMetricFactorInfos() const
{
	return (int)m_paMetricFactorInfo.size();
}

std::vector<CvMetricFactorInfo*>& CvGlobals::getMetricFactorInfo()
{
	return m_paMetricFactorInfo;
}

CvMetricFactorInfo& CvGlobals::getMetricFactorInfo(MetricFactorTypes eMetricFactor)
{
	FASSERT_BOUNDS(0, getNumMetricFactorInfos(), eMetricFactor, "CvGlobals::CvMetricFactorInfo");
	return *(m_paMetricFactorInfo[eMetricFactor]);
}
...
bool CvGlobals::findAssetFile(const TCHAR* szAssetPath)
{
	// Replace / with \ because enumerateFiles is very particular
	CvString szCorrectedAssetPath = CvString(szAssetPath);
	szCorrectedAssetPath.Replace('/', '\\');

	// Look up the files
	std::vector<CvString> aszFiles;
	//gDLL->logMsg("josh.log", CvString::format("[Josh] findAssetFile: Checking for presence of: %s\n", szAssetPath).c_str());
	gDLL->enumerateFiles(aszFiles, szCorrectedAssetPath);
	//gDLL->logMsg("josh.log", CvString::format("[Josh] findAssetFile: Number of assets found: %d\n", aszFiles.size()).c_str());

/*
	for(std::vector<CvString>::iterator it = aszFiles.begin(); it != aszFiles.end(); ++it)
	{
		gDLL->logMsg("josh.log", *it);
	}
*/
...
// MOD - START - Graphical Paging
void CvGlobals::setGraphicOptionGraphicalPaging(bool bEnabled)
{
	m_bGraphicalDetailPagingEnabled = bEnabled;
}

bool CvGlobals::getGraphicOption(GraphicOptionTypes eGraphicOption) const
{
	FASSERT_BOUNDS(0, NUM_GRAPHICOPTION_UNBOUNDED_TYPES, eGraphicOption, "CvGlobals::getGraphicOption");

	if (eGraphicOption == GRAPHICOPTION_GRAPHICAL_PAGING)
	{
		return m_bGraphicalDetailPagingEnabled;
	}

	return gDLL->getGraphicOption(eGraphicOption);
}
// MOD - END - Graphical Paging
...
{
	return std::max(getGameINLINE().getResolutionX(), getGameINLINE().getResolutionY())/150;
}
// MOD - END - Graphical Paging (45deg)
...
// MOD - START - Attribute Caching
void CvGlobals::cacheAttributes()
{
	// MOD - START - Advanced Building Prerequisites (Power)
	std::set<BuildingClassTypes> aPoweredBuildingClasses;
	for (int iBuilding = 0; iBuilding < GC.getNumBuildingInfos(); iBuilding++)
	{
		if (getBuildingInfo((BuildingTypes)iBuilding).isPrereqPower())
		{
			aPoweredBuildingClasses.insert((BuildingClassTypes)GC.getBuildingInfo((BuildingTypes)iBuilding).getBuildingClassType());
		}
	}

	m_iNumBuildingClassesRequiringPower = (int)aPoweredBuildingClasses.size();
	SAFE_DELETE_ARRAY(m_piBuildingClassesRequiringPower);
	if (m_iNumBuildingClassesRequiringPower > 0)
	{
		m_piBuildingClassesRequiringPower = new BuildingClassTypes[m_iNumBuildingClassesRequiringPower];
		int iMem = 0;
		for (std::set<BuildingClassTypes>::const_iterator it=aPoweredBuildingClasses.begin(); it!=aPoweredBuildingClasses.end(); ++it)
		{
			m_piBuildingClassesRequiringPower[iMem++] = *it;
		}
	}
	aPoweredBuildingClasses.clear();

	std::set<BuildingClassTypes> aInactiveWithoutPowerBuildingClasses;
	for (int iBuilding = 0; iBuilding < GC.getNumBuildingInfos(); iBuilding++)
	{
		if (getBuildingInfo((BuildingTypes)iBuilding).isInactiveWithoutPower())
		{
			aInactiveWithoutPowerBuildingClasses.insert((BuildingClassTypes)GC.getBuildingInfo((BuildingTypes)iBuilding).getBuildingClassType());
		}
	}

	m_iNumBuildingClassesInactiveWithoutPower = (int)aInactiveWithoutPowerBuildingClasses.size();
	SAFE_DELETE_ARRAY(m_piBuildingClassesInactiveWithoutPower);
	if (m_iNumBuildingClassesInactiveWithoutPower > 0)
	{
		m_piBuildingClassesInactiveWithoutPower = new BuildingClassTypes[m_iNumBuildingClassesInactiveWithoutPower];
		int iMem = 0;
		for (std::set<BuildingClassTypes>::const_iterator it=aInactiveWithoutPowerBuildingClasses.begin(); it!=aInactiveWithoutPowerBuildingClasses.end(); ++it)
		{
			m_piBuildingClassesInactiveWithoutPower[iMem++] = *it;
		}
	}
	aInactiveWithoutPowerBuildingClasses.clear();
	// MOD - END - Advanced Building Prerequisites (Power)

	// MOD - START - Advanced Building Prerequisites (Religion)
	std::set<BuildingClassTypes> aReligiousBuildingClasses;
	for (int iBuilding = 0; iBuilding < GC.getNumBuildingInfos(); iBuilding++)
	{
		if (getBuildingInfo((BuildingTypes)iBuilding).isInactiveWithoutPrereqStateReligion())
		{
			aReligiousBuildingClasses.insert((BuildingClassTypes)GC.getBuildingInfo((BuildingTypes)iBuilding).getBuildingClassType());
		}
	}

	m_iNumBuildingClassesInactiveWithoutPrereqStateReligion = (int)aReligiousBuildingClasses.size();
	SAFE_DELETE_ARRAY(m_piBuildingClassesInactiveWithoutPrereqStateReligion);
	if (m_iNumBuildingClassesInactiveWithoutPrereqStateReligion > 0)
	{
		m_piBuildingClassesInactiveWithoutPrereqStateReligion = new BuildingClassTypes[m_iNumBuildingClassesInactiveWithoutPrereqStateReligion];
		int iMem = 0;
		for (std::set<BuildingClassTypes>::const_iterator it=aReligiousBuildingClasses.begin(); it!=aReligiousBuildingClasses.end(); ++it)
		{
			m_piBuildingClassesInactiveWithoutPrereqStateReligion[iMem++] = *it;
		}
	}
	aReligiousBuildingClasses.clear();
	// MOD - END - Advanced Building Prerequisites (Religion)

	// MOD - START - Population Metrics
	// TODO: Cache metric factors by game event
	// NOTE: We don't need to do that if we create a CvGameEventInfo and cache them within that structure.
	// MOD - END - Population Metrics
}
// MOD - START - Attribute Caching
...
void CvGlobals::deleteInfoArrays()
{
	...
	// MOD - START - Improved Civilopedia
	deleteInfoArray(m_paHotKeyClassInfos);
	// MOD - END - Improved Civilopedia
	...
	// MOD - START - Improvement Classes
	deleteInfoArray(m_paImprovementClassInfo);
	// MOD - END - Improvement Classes
	...
	// MOD - START - Unit Roles
	deleteInfoArray(m_paUnitRoleInfo);
	// MOD - END - Unit Roles
	...
	// MOD - START - Aid
	deleteInfoArray(m_paAidStyleInfo);
	deleteInfoArray(m_paAidInfo);
	// MOD - END - Aid
	// MOD - START - Detriments
	deleteInfoArray(m_paDetrimentStyleInfo);
	deleteInfoArray(m_paDetrimentInfo);
	// MOD - END - Detriments
	// MOD - START - Congestion
	deleteInfoArray(m_paCongestionInfo);
	// MOD - END - Congestion
	...
	// MOD - START - Core Game Events
	deleteInfoArray(m_paGameEventInfos);
	// MOD - END - Core Game Events
	// MOD - START - Population Metrics
	deleteInfoArray(m_paContributionInfo);
	deleteInfoArray(m_paMetricClassInfo);
	deleteInfoArray(m_paMetricInfo);
	deleteInfoArray(m_paMetricFactorInfo);
	// MOD - END - Population Metrics
...
// MOD - START - Ranged Strike AI
int CvGlobals::getSKIP_RANGE_ATTACK_MIN_BEST_ATTACK_ODDS()
{
	return m_iSKIP_RANGE_ATTACK_MIN_BEST_ATTACK_ODDS;
}

int CvGlobals::getSKIP_RANGE_ATTACK_MIN_STACK_RATIO()
{
