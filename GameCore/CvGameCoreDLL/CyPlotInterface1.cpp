...
// MOD - START - Feature Latitude Restrictions
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(CyPlot_canHaveFeature_overloads, CyPlot::canHaveFeature, 1, 2)
// MOD - END - Feature Latitude Restrictions

// MOD - START - Congestion
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(CyPlot_isCity_overloads, CyPlot::isCity, 0, 2)
// MOD - END - Congestion
...
void CyPlotPythonInterface1(python::class_<CyPlot>& x)
{
	...
	x
		...
		.def("isCity", &CyPlot::isCity, CyPlot_isCity_overloads(boost::python::args("bool bCheckImprovement", "int /*TeamTypes*/ eForTeam"), "bool"))
		// MOD - END - Congestion
		...
		.def("canHaveFeature", &CyPlot::canHaveFeature, CyPlot_canHaveFeature_overloads(boost::python::args("int /*FeatureTypes*/ eFeature", "bool bIgnoreLatitude"), "bool"))
		// MOD - END - Feature Latitude Restrictions
		...
		// MOD - START - Congestion
		.def("getCombatUnitDomainCount", &CyPlot::getCombatUnitDomainCount, "int (int (TeamTypes eTeam), int (DomainTypes) eDomain)")
		// MOD - END - Congestion
		...
		// MOD - START - Aid
		// TODO: Write Python Interface
		//.def("getNumCombatUnits", &CyPlot::getNumCombatUnits, "int (int /*TeamTypes*/ eTeam)")
		//.def("getCombatTypeStrength",&CyPlot::getCombatTypeStrength, "int (int /*TeamTypes*/ eTeam, int /*UnitCombatTypes*/ eCombat)")
		// MOD - END - Aid
	;
}
