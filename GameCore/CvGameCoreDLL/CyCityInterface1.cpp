...
void CyCityPythonInterface1(python::class_<CyCity>& x)
{
	...
	x
		...
		.def("getBonusEpidemicModifier", &CyCity::getBonusEpidemicModifier, "int (BonusID) - total epidemic modifier from BonusID")
		// MOD - END - Epidemics
		...
		.def("getTrueGreatPeopleRate", &CyCity::getTrueGreatPeopleRate, "int () - total Great Person rate times 100")		
		...
		.def("getWarConscript", &CyCity::getWarConscript)
		...
		.def("changeActualBaseYieldRate", &CyCity::changeActualBaseYieldRate, "int (int /*YieldTypes*/, int iChange) - changes the base rate for YieldType")
		...
		.def("getDomainHealRate", &CyCity::getDomainHealRate, "int (int i)")
		.def("getUnitClassHealRate", &CyCity::getUnitClassHealRate, "int (int i)")
		.def("getUnitCombatHealRate", &CyCity::getUnitCombatHealRate, "int (int i)")
		...
		// MOD - START - Epidemics
		// Epidemic system by Mexico
		.def("getEpidemicTurns", &CyCity::getEpidemicTurns, "int () - how long is city affected by epidemic / how long will be immune (if < 0) ")
		.def("isEpidemic", &CyCity::isEpidemic, "bool () - is city affected by epidemic?")
		.def("isImmune", &CyCity::isImmune, "bool () - is city immune to epidemics?")
		.def("setEpidemicTurns", &CyCity::setEpidemicTurns, "void (int) - set new value how long is city affected by epidemic / how long will be immune (if < 0) ")
		.def("changeEpidemicTurns", &CyCity::changeEpidemicTurns, "void (int) - change value how long is city affected by epidemic / how long will be immune (if < 0) ")

		.def("getEpidemicProbabilityPercent", &CyCity::getEpidemicProbabilityPercent, "int () - return relative value (in %) of epidemic probability")
        .def("getEpidemicProbability", &CyCity::getEpidemicProbability, "int () - return absolute value of epidemic probability (depend on base)")
		// MOD - END - Epidemics

		// MOD - START - City Growth Limits
		.def("isGrowthAllowed", &CyCity::isGrowthAllowed, "bool () - is the city permitted to grow?")
		...
		//.def("AI_avoidGrowth", &CyCity::AI_avoidGrowth, "bool ()") // K-Mod
		...
		.def("getMetricValue", &CyCity::getMetricValue, "int (int /*MetricTypes*/ eMetric)")
		.def("setMetricValue", &CyCity::setMetricValue, "int (int /*MetricTypes*/ eMetric, int iValue)")
		.def("changeMetricValue", &CyCity::changeMetricValue, "int (int /*MetricTypes*/ eMetric, int iChange)")
		
		.def("getMetricTurnValue", &CyCity::getMetricTurnValue, "int (int /*MetricTypes*/ eMetric, int iTurn)")
		.def("getMetricMinValue", &CyCity::getMetricMinValue, "int (int /*MetricTypes*/ eMetric)")
		.def("getMetricMaxValue", &CyCity::getMetricMaxValue, "int (int /*MetricTypes*/ eMetric)")
		...
		.def("getCitySeparatism", &CyCity::getCitySeparatism, "int () - total city separatism")
		.def("changeCitySeparatism", &CyCity::changeCitySeparatism, "void (int iNewValue) - sets the city separatism to iNewValue")
		.def("getCitySeparatismTemp", &CyCity::getCitySeparatismTemp, "int () - city separatism from temporary effects")
		.def("changeCitySeparatismTemp", &CyCity::changeCitySeparatismTemp, "void (int iNewValue) - sets the city temporary separatism to iNewValue")
		.def("getCitySeparatismUnit", &CyCity::getCitySeparatismUnit, "int () - total city separatism")
		.def("changeCitySeparatismUnit", &CyCity::changeCitySeparatismUnit, "void (int iNewValue) - sets the city separatism to iNewValue")
		;
