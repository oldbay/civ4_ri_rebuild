...
/*
bool CyPlot::canHaveFeature(int eFeature)
{
	return m_pPlot ? m_pPlot->canHaveFeature((FeatureTypes)eFeature) : false;
}
*/

bool CyPlot::canHaveFeature(int /*FeatureTypes*/ eFeature, bool bIgnoreLatitude)
{
	return m_pPlot ? m_pPlot->canHaveFeature((FeatureTypes)eFeature, bIgnoreLatitude) : false;
}
...
// MOD - START - Congestion
int CyPlot::getCombatUnitDomainCount(int /*TeamTypes*/ eTeam, int /*DomainTypes*/ eDomain) const
{
	return m_pPlot ? m_pPlot->getCombatUnitDomainCount((TeamTypes)eTeam, (DomainTypes)eDomain) : -1;
}
// MOD - END - Congestion
...
/*
int CyPlot::getNumCombatUnits(int eTeam)
{
	return m_pPlot ? m_pPlot->getNumCombatUnits((TeamTypes) eTeam) : 0;
}

int CyPlot::getCombatTypeStrength(int eTeam, int eCombat)
{
	return m_pPlot ? m_pPlot->getCombatTypeStrength((TeamTypes) eTeam, (UnitCombatTypes) eCombat) : 0;
}
*/
// MOD - END - Aid
