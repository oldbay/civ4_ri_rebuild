...
void CyInfoPythonInterface3()
{
	...
	python::class_<CvLeaderHeadInfo, python::bases<CvInfoBase> >("CvLeaderHeadInfo")
		...
		.def("getDifferentIdeologyAttitudeChange", &CvLeaderHeadInfo::getDifferentReligionAttitudeChange, "int ()")
		.def("getDifferentIdeologyAttitudeDivisor", &CvLeaderHeadInfo::getDifferentReligionAttitudeDivisor, "int ()")
		.def("getDifferentIdeologyAttitudeChangeLimit", &CvLeaderHeadInfo::getDifferentReligionAttitudeChangeLimit, "int ()")		
		...
		.def("isAIPlayable", &CvLeaderHeadInfo::isAIPlayable, "bool ()")
		.def("isPlayable", &CvLeaderHeadInfo::isPlayable, "bool ()")
	...
	python::class_<CvProjectInfo, python::bases<CvInfoBase> >("CvProjectInfo")
		...
		.def("getGlobalEpidemicModifier", &CvProjectInfo::getGlobalEpidemicModifier, "int ()")
		// MOD - END - Epidemics
	...
	python::class_<CvReligionInfo, python::bases<CvInfoBase> >("CvReligionInfo")
		...
		.def("getNumRelatedUnitClasses", &CvReligionInfo::getNumRelatedUnitClasses, "int ()")
		.def("getNumRelatedBuildingClasses", &CvReligionInfo::getNumRelatedBuildingClasses, "int ()")
		...
		// MOD - START - Relation Caching
		.def("getRelatedUnitClasses", &CvReligionInfo::getRelatedUnitClasses, "int (int i)")
		.def("getRelatedBuildingClasses", &CvReligionInfo::getRelatedBuildingClasses, "int (int i)")
		// MOD - END - Relation Caching
		;
	...
	python::class_<CvTraitInfo, python::bases<CvInfoBase> >("CvTraitInfo")
		...
		// MOD - START - Epidemics
		// Epidemic system by Mexico
		.def("getGlobalEpidemicModifier", &CvTraitInfo::getGlobalEpidemicModifier, "int ()")
		// MOD - END - Epidemics
		...
		.def("getInsideCityCongestionThresholdChange", &CvTraitInfo::getInsideCityCongestionThresholdChange, "int ()")
		.def("getOutsideCityCongestionThresholdChange", &CvTraitInfo::getOutsideCityCongestionThresholdChange, "int ()")
		// MOD - END - Congestion
	...
	python::class_<CvWorldInfo, python::bases<CvInfoBase> >("CvWorldInfo")
		...
		// MOD - START - Improved Civilopedia
		.def("getGridWidthInPlots", &CvWorldInfo::getGridWidthInPlots, "int ()")
		.def("getGridHeightInPlots", &CvWorldInfo::getGridHeightInPlots, "int ()")
		// MOD - END - Improved Civilopedia
		...
		.def("getPerCityResearchCostModifier", &CvWorldInfo::getPerCityResearchCostModifier, "int ()")
	...
	// MOD - START - Congestion
	python::class_<CvDomainInfo, python::bases<CvInfoBase> >("CvDomainInfo")
		.def("getNumCongestionTypes", &CvDomainInfo::getNumCongestionTypes, "int (bool bInsideCity)")
		.def("getCongestionTypes", &CvDomainInfo::getCongestionTypes, "int (bool bInsideCity, int i)")
		;
	// MOD - END - Congestion
	...
	python::class_<CvEmphasizeInfo, python::bases<CvInfoBase> >("CvEmphasizeInfo")
		...
		.def("isAvoidUnhappy", &CvEmphasizeInfo::isAvoidUnhappy, "bool ()")
		.def("isAvoidUnhealth", &CvEmphasizeInfo::isAvoidUnhealth, "bool ()")
		.def("isAvoidEpidemics", &CvEmphasizeInfo::isAvoidEpidemics, "bool ()")
	...
	python::class_<CvEraInfo, python::bases<CvInfoBase> >("CvEraInfo")
		...
		.def("getDiscoverHappiness", &CvEraInfo::getDiscoverHappiness, "int () -")
		.def("getDiscoverHealth", &CvEraInfo::getDiscoverHealth, "int () -")
		// MOD - END - Era Effects
