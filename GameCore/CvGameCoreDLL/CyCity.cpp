...
int CyCity::getBonusEpidemicModifier(int /*BonusTypes*/ iBonus)
{
	return m_pCity ? m_pCity->getBonusEpidemicModifier((BonusTypes) iBonus) : -1;
}
// MOD - END - Epidemics
...
long CyCity::getGreatPeopleRate()
{
	return m_pCity ? m_pCity->getGreatPeopleRate() / 100 : -1;
}

long CyCity::getTrueGreatPeopleRate()
{
...
int CyCity::getWarConscript()
{
	return m_pCity ? m_pCity->getWarConscript() : -1;
}
...
void CyCity::changeActualBaseYieldRate(int /*YieldTypes*/ eIndex, int iNewValue)
{
	if (m_pCity)
		m_pCity->changeActualBaseYieldRate((YieldTypes)eIndex, iNewValue);
}
...
int CyCity::getDomainHealRate(int /*DomainTypes*/ eIndex)
{
	return m_pCity ? m_pCity->getDomainHealRate((DomainTypes)eIndex) : -1;
}

int CyCity::getUnitClassHealRate(int /*UnitClassTypes*/ eIndex)
{
	return m_pCity ? m_pCity->getUnitClassHealRate((UnitClassTypes)eIndex) : -1;
}

int CyCity::getUnitCombatHealRate(int /*UnitCombatTypes*/ eIndex)
{
	return m_pCity ? m_pCity->getUnitCombatHealRate((UnitCombatTypes)eIndex) : -1;
}
...
// MOD - START - Epidemics
// Epidemic system by Mexico
int CyCity::getEpidemicTurns() const
{
    return m_pCity ? m_pCity->getEpidemicTurns() : 0;
}

bool CyCity::isEpidemic() const
{
    return m_pCity ? m_pCity->isEpidemic() : false;
}
...
void CyCity::setEpidemicTurns(int iNewValue)
{
    if (m_pCity)
		 m_pCity->setEpidemicTurns(iNewValue);
}

void CyCity::changeEpidemicTurns(int iChange)
{
    if (m_pCity)
		 m_pCity->changeEpidemicTurns(iChange);
}

int CyCity::getEpidemicProbabilityPercent()
{
    return m_pCity ? m_pCity->getEpidemicProbabilityPercent() : 0;
}

int CyCity::getEpidemicProbability()
{
    return m_pCity ? m_pCity->getEpidemicProbability() : 0;
}
// MOD - END - Epidemics

// MOD - START - City Growth Limits
bool CyCity::isGrowthAllowed() const
{
    return m_pCity ? m_pCity->isGrowthAllowed() : false;
}
...
{
	if (m_pCity)
		m_pCity->pushOrder(eOrder, iData1, iData2, bSave, bPop, bAppend ? -1 : 0, bForce); // K-Mod
}
...
int CyCity::getMetricValue(int /*MetricTypes*/ eMetric) const
{
	return m_pCity ? m_pCity->getMetricValue((MetricTypes)eMetric) : 0;
}

void CyCity::setMetricValue(int /*MetricTypes*/ eMetric, int iValue)
{
	if (m_pCity)
	{
		m_pCity->setMetricValue((MetricTypes)eMetric, iValue);
	}
}

void CyCity::changeMetricValue(int /*MetricTypes*/ eMetric, int iChange)
{
	if (m_pCity)
	{
		m_pCity->changeMetricValue((MetricTypes)eMetric, iChange);
	}
}

int CyCity::getMetricTurnValue(int /*MetricTypes*/ eMetric, int iTurn) const
{
	return m_pCity ? m_pCity->getMetricTurnValue((MetricTypes)eMetric, iTurn) : 0;
}

int CyCity::getMetricMinValue(int /*MetricTypes*/ eMetric) const
{
	return m_pCity ? m_pCity->getMetricMinValue((MetricTypes)eMetric) : 0;
}

int CyCity::getMetricMaxValue(int /*MetricTypes*/ eMetric) const
{
	return m_pCity ? m_pCity->getMetricMaxValue((MetricTypes)eMetric) : 0;
}
...
int CyCity::getCitySeparatism()
{
    return m_pCity ? m_pCity->getCitySeparatism() : 0;
}

void CyCity::changeCitySeparatism(int iChange)
{
    if (m_pCity)
	{
		 m_pCity->changeCitySeparatism(iChange);
	}
}

int CyCity::getCitySeparatismTemp()
{
    return m_pCity ? m_pCity->getCitySeparatismTemp() : 0;
}

void CyCity::changeCitySeparatismTemp(int iChange)
{
    if (m_pCity)
	{
		 m_pCity->changeCitySeparatismTemp(iChange);
	}
}

int CyCity::getCitySeparatismUnit()
{
    return m_pCity ? m_pCity->getCitySeparatismUnit() : 0;
}

void CyCity::changeCitySeparatismUnit(int iChange)
{
    if (m_pCity)
	{
		 m_pCity->changeCitySeparatismUnit(iChange);
	}
}
