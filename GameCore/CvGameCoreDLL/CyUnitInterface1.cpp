...
// MOD - START - Advanced Experience Limits
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(CyUnit_maxXPValue_overloads, CyUnit::maxXPValue, 0, 1)
// MOD - END - Advanced Experience Limits
...
void CyUnitPythonInterface1(python::class_<CyUnit>& x)
{
	...
	x
		...
		.def("canRemoveReligion", &CyUnit::canRemoveReligion, "bool (CyPlot* pPlot, bool bTestVisible)")
		.def("removeReligion", &CyUnit::removeReligion, "bool ()")
		// MOD - END - Inquisition
		...
		.def("getUnitPromoType", &CyUnit::getUnitPromoType, "int ()")		
		...
		.def("maxXPValue", &CyUnit::maxXPValue, CyUnit_maxXPValue_overloads(boost::python::args("CyUnit* pAttacker"), "int"))
		// MOD - END - Advanced Experience Limits
		...
		// MOD - START - Advanced Experience Limits
		.def("getExtraBarbarianMaxXPValue", &CyUnit::getExtraBarbarianMaxXPValue, "int ()")
		// MOD - END - Advanced Experience Limits
		// MOD - START - Extra Barbarian Combat Modifier
		.def("getExtraBarbarianCombatModifier", &CyUnit::getExtraBarbarianCombatModifier, "int ()")
		...
		.def("isImmuneToDamageFromFeature", &CyUnit::isImmuneToDamageFromFeature, "bool (FeatureType)")
		...
		// MOD - START - Slavery
		// slave rebels tag for ignoring border obstacle (great wall)
		.def("isIgnoreObstacle", &CyUnit::isIgnoreObstacle, "bool isIgnoreObstacle () - unit can ignore border obstacle (great wall) - used in slavery rebellion component")
		.def("setIgnoreObstacle", &CyUnit::setIgnoreObstacle, "void setIgnoreObstacle (bool bNewValue) - set/unset if unit can ignore border obstacle (great wall) - used in slavery rebellion component")
		// chance to consume unit after improvement build by Mexico
		.def("getBuildKillChance", &CyUnit::getBuildKillChance, "int () - chance that unit is \"consumed\" (destroyed) after improvement is built")
		// MOD - END - Slavery
